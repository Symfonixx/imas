...
@section('toolbar')
    ...
    @endphp
    <x-admin.breadcrumb :pageTitle="__('Add Team Member')" :breadcrumbItems="$breadcrumbItems"/>
@endsection

<x-admin-layout>
    <form method="POST" action="{{ route('admin.corporate_teams.store') }}" enctype="multipart/form-data">
        @csrf
