...
class UpdateSlideCategoryRequest extends FormRequest
{
    ...
    {
        $slideCategory = $this->route('slide_category');
        $slideCategoryId = $slideCategory instanceof SlideCategory
            ? $slideCategory->id
            : $slideCategory;
        ...
        return [
            ...
            'slug' => [
                ...
                'max:191',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('slide_categories', 'slug')->ignore($slideCategoryId),
            ],
