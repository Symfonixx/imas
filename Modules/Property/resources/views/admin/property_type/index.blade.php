...
@section('toolbar')
    ...
    @endphp
    <x-admin.breadcrumb :pageTitle="__('Property types')" :breadcrumbItems="$breadcrumbItems"/>
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <a class="btn btn-sm fw-bold btn-primary" href="{{ route('admin.property_types.create') }}">
...
<x-admin-layout>
    <x-admin.table :model="$model" :search="__('Search in property types')" :form-url="route('admin.property_types.deleteMulti')">
        <thead>
            ...
            <tr>
                ...
                <td>
                    <span class="symbol symbol-40px">
                        <i class="{{ $row->icon }} fs-2 text-primary"></i>
                    </span>
                </td>
