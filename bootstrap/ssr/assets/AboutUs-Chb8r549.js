...
import { o as localizedRoute, t as _sfc_main$2 } from "./App-D9ZDchZP.js";
...
import { t as _sfc_main$4 } from "./FeaturedPropertiesSidebar-BvXhqFk0.js";
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: unref(documentTitle) }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(metaDescription)) _push(`<meta head-key="description" name="description"${ssrRenderAttr("content", unref(metaDescription))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(metaKeywords)) _push(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", unref(metaKeywords))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(canonicalUrl)) _push(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", unref(canonicalUrl))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogTitle)) _push(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", unref(ogTitle))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogDescription)) _push(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", unref(ogDescription))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogImage)) _push(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", unref(ogImage))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="og:type" property="og:type" content="website" data-v-94c6d344${_scopeId}>`);
						if (unref(ogUrl)) _push(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", unref(ogUrl))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", unref(twitterCard))} data-v-94c6d344${_scopeId}>`);
						if (unref(ogTitle)) _push(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", unref(ogTitle))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogDescription)) _push(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", unref(ogDescription))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogImage)) _push(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", unref(ogImage))} data-v-94c6d344${_scopeId}>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(_sfc_main$2, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="inner-pages imas-about-page" data-v-94c6d344${_scopeId}>`);
						...
						_push(`<main class="${ssrRenderClass([{ "imas-about-page__page--with-sidebar": hasSidebar.value }, "imas-about-page__page imas-blog-v2__page container"])}" data-v-94c6d344${_scopeId}><section class="imas-about-page__main" data-v-94c6d344${_scopeId}>`);
						if (contentHtml.value) _push(`<article class="imas-blog-show imas-cms-page-show" data-v-94c6d344${_scopeId}><div class="imas-blog-show__content" data-v-94c6d344${_scopeId}><div class="imas-blog-show-body imas-cms-page-show__body text-base text-start" data-v-94c6d344${_scopeId}>${contentHtml.value ?? ""}</div></div></article>`);
						else _push(`<!---->`);
						if (!contentHtml.value) _push(`<p class="imas-about-page__empty text-muted text-base" data-v-94c6d344${_scopeId}>${ssrInterpolate(trans("about_us.no_content"))}</p>`);
						else _push(`<!---->`);
						_push(`</section>`);
...
var AboutUs_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-94c6d344"]]);
//#endregion
