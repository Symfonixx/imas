...
import { l as localizedRoute, _ as _sfc_main$3 } from "./App-DYVlVBS1.js";
...
import { _ as _sfc_main$2 } from "./FeaturedPropertiesSidebar-JQX0EZj7.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (metaDescription.value) {
              _push2(`<meta head-key="description" name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaKeywords.value) {
              _push2(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (canonicalUrl.value) {
              _push2(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", canonicalUrl.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogTitle.value) {
              _push2(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", ogTitle.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogDescription.value) {
              _push2(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", ogDescription.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogImage.value) {
              _push2(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", ogImage.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta head-key="og:type" property="og:type" content="website" data-v-1fce4a6b${_scopeId}>`);
            if (ogUrl.value) {
              _push2(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", ogUrl.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", twitterCard.value)} data-v-1fce4a6b${_scopeId}>`);
            if (ogTitle.value) {
              _push2(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", ogTitle.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogDescription.value) {
              _push2(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", ogDescription.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogImage.value) {
              _push2(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", ogImage.value)} data-v-1fce4a6b${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$3, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="inner-pages imas-about-page" data-v-1fce4a6b${_scopeId}>`);
            ...
            }, "imas-about-page__page imas-blog-v2__page container"])}" data-v-1fce4a6b${_scopeId}><section class="imas-about-page__main" data-v-1fce4a6b${_scopeId}>`);
            if (contentHtml.value) {
              _push2(`<article class="imas-blog-show imas-cms-page-show" data-v-1fce4a6b${_scopeId}><div class="imas-blog-show__content" data-v-1fce4a6b${_scopeId}><div class="imas-blog-show-body imas-cms-page-show__body text-base text-start" data-v-1fce4a6b${_scopeId}>${contentHtml.value ?? ""}</div></div></article>`);
            } else {
              _push2(`<!---->`);
            }
            if (!contentHtml.value) {
              _push2(`<p class="imas-about-page__empty text-muted text-base" data-v-1fce4a6b${_scopeId}>${ssrInterpolate(trans("about_us.no_content"))}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</section>`);
...
const AboutUs = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1fce4a6b"]]);
export {
  AboutUs as default
};
