import { a as refreshScrollTrigger, f as _plugin_vue_export_helper_default, i as prefersReducedMotion, p as IMAS_OPEN_AUTH_EVENT, r as createGsapContext } from "../ssr.js";
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (mounted.value) ssrRenderTeleport(_push, (_push) => {
				if (__props.open) {
					_push(`<div class="login-and-register-form modal imas-auth-modal" role="dialog" aria-modal="true"${ssrRenderAttr("aria-label", trans("auth_modal.dialog_label"))} data-v-f97699f8><div class="main-overlay" tabindex="-1" data-v-f97699f8></div><div class="main-register-holder" data-v-f97699f8><div class="main-register fl-wrap" data-v-f97699f8><button type="button" class="close-reg"${ssrRenderAttr("aria-label", trans("auth_modal.close"))} data-v-f97699f8><i class="fa fa-times" aria-hidden="true" data-v-f97699f8></i></button>`);
					if (logoUrl.value) _push(`<div class="app_logo" data-v-f97699f8><img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-f97699f8></div>`);
					else _push(`<!---->`);
					_push(`<h3 class="text-center" data-v-f97699f8>${ssrInterpolate(authNoteText.value)}</h3>`);
					if (authSubview.value === "forgot") {
						_push(`<div class="custom-form" data-v-f97699f8><p class="mb-3 text-start px-0" data-v-f97699f8></p><a href="#" class="imas-auth-modal__back text-start" data-v-f97699f8><i class="fa fa-angle-left fa-lg imas-auth-modal__back-icon" aria-hidden="true" data-v-f97699f8></i><span class="imas-auth-modal__back-label" data-v-f97699f8>${ssrInterpolate(trans("auth_modal.back_to_login"))}</span></a>`);
						if (authStatusMessage.value) _push(`<p class="imas-auth-modal__status" role="status" data-v-f97699f8>${ssrInterpolate(authStatusMessage.value)}</p>`);
						else _push(`<!---->`);
						_push(`<form class="forgot-password-form" data-v-f97699f8><div data-v-f97699f8><label for="imas-auth-forgot-email" data-v-f97699f8>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-forgot-email"${ssrRenderAttr("value", unref(forgotForm).email)} type="email" autocomplete="email" required data-v-f97699f8>`);
						if (unref(forgotForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(forgotForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(forgotForm).processing) ? " disabled" : ""} data-v-f97699f8><span data-v-f97699f8>${ssrInterpolate(trans("Send Email Verification"))}</span></button></div></form></div>`);
					} else {
						_push(`<div id="tabs-container" data-v-f97699f8>`);
						if (authStatusMessage.value && activeMainTab.value === "login") _push(`<p class="imas-auth-modal__status" role="status" data-v-f97699f8>${ssrInterpolate(authStatusMessage.value)}</p>`);
						else _push(`<!---->`);
						_push(`<ul class="tabs-menu" data-v-f97699f8><li class="${ssrRenderClass({ current: activeMainTab.value === "login" })}" data-v-f97699f8><a href="#tab-imas-login" data-v-f97699f8>${ssrInterpolate(trans("Login"))}</a></li><li class="${ssrRenderClass({ current: activeMainTab.value === "register" })}" data-v-f97699f8><a href="#tab-imas-register" data-v-f97699f8>${ssrInterpolate(trans("Register"))}</a></li>`);
						if (activeMainTab.value === "reset" || resetToken.value) _push(`<li class="${ssrRenderClass({ current: activeMainTab.value === "reset" })}" data-v-f97699f8><a href="#tab-imas-reset" data-v-f97699f8>${ssrInterpolate(trans("Reset Password"))}</a></li>`);
						else _push(`<!---->`);
						_push(`</ul><div class="tab" data-v-f97699f8><div id="tab-imas-login" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "login" }, "tab-contents"])}" data-v-f97699f8><div class="custom-form" data-v-f97699f8><form data-v-f97699f8><label for="imas-auth-login-email" data-v-f97699f8>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-login-email"${ssrRenderAttr("value", unref(loginForm).email)} type="email" autocomplete="username" required data-v-f97699f8>`);
						if (unref(loginForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(loginForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-login-password" data-v-f97699f8>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-f97699f8><input id="imas-auth-login-password"${ssrRenderDynamicModel(passwordVisible.value.login ? "text" : "password", unref(loginForm).password, null)}${ssrRenderAttr("type", passwordVisible.value.login ? "text" : "password")} autocomplete="current-password" required data-v-f97699f8><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("login"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.login)} data-v-f97699f8><i class="${ssrRenderClass(passwordVisible.value.login ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-f97699f8></i></button></div>`);
						if (unref(loginForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(loginForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(loginForm).processing) ? " disabled" : ""} data-v-f97699f8><span data-v-f97699f8>${ssrInterpolate(trans("Login"))}</span></button><div class="clearfix" data-v-f97699f8></div><div class="filter-tags" data-v-f97699f8><input id="imas-auth-remember"${ssrIncludeBooleanAttr(Array.isArray(unref(loginForm).remember) ? ssrLooseContain(unref(loginForm).remember, null) : unref(loginForm).remember) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-f97699f8><label for="imas-auth-remember" data-v-f97699f8>${ssrInterpolate(trans("Remember Me"))}</label></div></form><div class="lost_password" data-v-f97699f8><a href="#" data-v-f97699f8>${ssrInterpolate(trans("Forgot Password"))}</a></div></div></div><div class="tab" data-v-f97699f8><div id="tab-imas-register" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "register" }, "tab-contents"])}" data-v-f97699f8><div class="custom-form main-register-form" data-v-f97699f8><form data-v-f97699f8><div class="imas-auth-form-field-row" data-v-f97699f8><div class="imas-auth-form-field" data-v-f97699f8><label for="imas-auth-reg-first-name" data-v-f97699f8>${ssrInterpolate(trans("contact_us.first_name"))} *</label><input id="imas-auth-reg-first-name"${ssrRenderAttr("value", unref(registerForm).first_name)} type="text" autocomplete="given-name" required maxlength="120" data-v-f97699f8>`);
						if (unref(registerForm).errors.first_name) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(registerForm).errors.first_name)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-f97699f8><label for="imas-auth-reg-last-name" data-v-f97699f8>${ssrInterpolate(trans("contact_us.last_name"))} *</label><input id="imas-auth-reg-last-name"${ssrRenderAttr("value", unref(registerForm).last_name)} type="text" autocomplete="family-name" required maxlength="120" data-v-f97699f8>`);
						if (unref(registerForm).errors.last_name) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(registerForm).errors.last_name)}</span>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="imas-auth-form-field" data-v-f97699f8><label for="imas-auth-reg-email" data-v-f97699f8>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reg-email"${ssrRenderAttr("value", unref(registerForm).email)} type="email" autocomplete="email" required data-v-f97699f8>`);
						if (unref(registerForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(registerForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-f97699f8><label for="imas-auth-reg-mobile" data-v-f97699f8>${ssrInterpolate(trans("Mobile"))} *</label><div class="${ssrRenderClass([{ "imas-auth-phone-field--country-open": registerCountryDropdownOpen.value }, "imas-auth-phone-field"])}" dir="ltr" data-v-f97699f8><div class="imas-auth-country-select-shell" data-v-f97699f8><button id="imas-auth-reg-country-code" type="button" class="imas-auth-country-trigger"${ssrRenderAttr("aria-expanded", registerCountryDropdownOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", registerCountrySelectAriaLabel.value)} data-v-f97699f8>`);
						if (selectedRegisterCountry.value?.flag) _push(`<img class="imas-auth-country-flag-img"${ssrRenderAttr("src", selectedRegisterCountry.value.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-f97699f8>`);
						else _push(`<!---->`);
						_push(`<span class="imas-auth-country-code-label" aria-hidden="true" data-v-f97699f8>+${ssrInterpolate(displayCallingCode(selectedRegisterCountry.value?.phone_code))}</span></button><div class="imas-auth-country-dropdown-panel" style="${ssrRenderStyle(registerCountryDropdownOpen.value ? null : { display: "none" })}" data-v-f97699f8><div class="imas-auth-country-dropdown-search-wrap text-start" data-v-f97699f8><input${ssrRenderAttr("value", registerCountrySearchQuery.value)} type="search" enterkeyhint="search" autocomplete="off" autocorrect="off" spellcheck="false" class="imas-auth-country-dropdown-search"${ssrRenderAttr("placeholder", trans("Search"))}${ssrRenderAttr("aria-label", trans("Search"))} data-v-f97699f8></div><ul class="imas-auth-country-dropdown-scroll" role="listbox" tabindex="-1" data-v-f97699f8>`);
						if (countriesWithPhoneFiltered.value.length === 0) _push(`<li class="imas-auth-country-option imas-auth-country-option--empty" aria-live="polite" data-v-f97699f8>${ssrInterpolate(trans("auth_modal.country_code_search_empty"))}</li>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(countriesWithPhoneFiltered.value, (c) => {
							_push(`<li role="option" class="${ssrRenderClass([{ "imas-auth-country-option--selected": c.id === registerCountryId.value }, "imas-auth-country-option"])}"${ssrRenderAttr("aria-selected", c.id === registerCountryId.value)} data-v-f97699f8>`);
							if (c.flag) _push(`<img class="imas-auth-country-flag-img imas-auth-country-flag-img--option"${ssrRenderAttr("src", c.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-f97699f8>`);
							else _push(`<!---->`);
							_push(`<span class="imas-auth-country-option-code" data-v-f97699f8>+${ssrInterpolate(displayCallingCode(c.phone_code))}</span></li>`);
						});
						_push(`<!--]--></ul></div></div><span class="imas-auth-phone-sep" aria-hidden="true" data-v-f97699f8></span><input id="imas-auth-reg-mobile"${ssrRenderAttr("value", registerMobileLocal.value)} type="tel" inputmode="numeric" autocomplete="tel-national" class="imas-auth-phone-input" required${ssrRenderAttr("placeholder", trans("auth_modal.mobile_national_placeholder"))} data-v-f97699f8></div>`);
						if (registerMobileClientError.value) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(registerMobileClientError.value)}</span>`);
						else _push(`<!---->`);
						if (unref(registerForm).errors.mobile) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(registerForm).errors.mobile)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-f97699f8><label for="imas-auth-reg-password" data-v-f97699f8>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-f97699f8><input id="imas-auth-reg-password"${ssrRenderDynamicModel(passwordVisible.value.register ? "text" : "password", unref(registerForm).password, null)}${ssrRenderAttr("type", passwordVisible.value.register ? "text" : "password")} autocomplete="new-password" required data-v-f97699f8><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("register"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.register)} data-v-f97699f8><i class="${ssrRenderClass(passwordVisible.value.register ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-f97699f8></i></button></div>`);
						if (unref(registerForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(registerForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-f97699f8><label for="imas-auth-reg-password-confirmation" data-v-f97699f8>${ssrInterpolate(trans("Confirm Password"))} *</label><div class="imas-auth-password-field" data-v-f97699f8><input id="imas-auth-reg-password-confirmation"${ssrRenderDynamicModel(passwordVisible.value.registerConfirm ? "text" : "password", unref(registerForm).password_confirmation, null)}${ssrRenderAttr("type", passwordVisible.value.registerConfirm ? "text" : "password")} autocomplete="new-password" required data-v-f97699f8><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("registerConfirm"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.registerConfirm)} data-v-f97699f8><i class="${ssrRenderClass(passwordVisible.value.registerConfirm ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-f97699f8></i></button></div>`);
						if (unref(registerForm).errors.password_confirmation) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(registerForm).errors.password_confirmation)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-terms-wrap" data-v-f97699f8><div class="filter-tags imas-auth-terms" data-v-f97699f8><input id="imas-auth-terms"${ssrIncludeBooleanAttr(Array.isArray(registerTermsAccepted.value) ? ssrLooseContain(registerTermsAccepted.value, null) : registerTermsAccepted.value) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-f97699f8><label for="imas-auth-terms" class="imas-auth-terms__label" data-v-f97699f8>${ssrInterpolate(trans("auth_modal.agree_terms_prefix"))} <a href="#" class="imas-auth-terms__link" data-v-f97699f8>${ssrInterpolate(trans("auth_modal.terms_and_conditions"))}</a> ${ssrInterpolate(trans("auth_modal.agree_terms_suffix"))}</label></div>`);
						if (registerTermsClientError.value) _push(`<p class="imas-auth-terms__error" role="alert" data-v-f97699f8>${ssrInterpolate(registerTermsClientError.value)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field imas-auth-form-field--actions" data-v-f97699f8><button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(registerForm).processing) ? " disabled" : ""} data-v-f97699f8><span data-v-f97699f8>${ssrInterpolate(trans("Register"))}</span></button></div></form></div></div></div><div class="tab" data-v-f97699f8><div id="tab-imas-reset" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "reset" }, "tab-contents"])}" data-v-f97699f8><div class="custom-form" data-v-f97699f8>`);
						if (!resetToken.value) _push(`<p class="imas-auth-modal__hint" data-v-f97699f8>${ssrInterpolate(trans("auth_modal.reset_hint"))}</p>`);
						else _push(`<!---->`);
						_push(`<form data-v-f97699f8><label for="imas-auth-reset-email" data-v-f97699f8>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reset-email"${ssrRenderAttr("value", unref(resetForm).email)} type="email" autocomplete="email" required data-v-f97699f8>`);
						if (unref(resetForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(resetForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-reset-password" data-v-f97699f8>${ssrInterpolate(trans("Password"))} *</label><input id="imas-auth-reset-password"${ssrRenderAttr("value", unref(resetForm).password)} type="password" autocomplete="new-password" required data-v-f97699f8>`);
						if (unref(resetForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(resetForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-reset-password-confirmation" data-v-f97699f8>${ssrInterpolate(trans("Confirm Password"))} *</label><input id="imas-auth-reset-password-confirmation"${ssrRenderAttr("value", unref(resetForm).password_confirmation)} type="password" autocomplete="new-password" required data-v-f97699f8>`);
						if (unref(resetForm).errors.password_confirmation) _push(`<span class="imas-auth-field-error" data-v-f97699f8>${ssrInterpolate(unref(resetForm).errors.password_confirmation)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(resetForm).processing || !resetToken.value) ? " disabled" : ""} data-v-f97699f8><span data-v-f97699f8>${ssrInterpolate(trans("Reset Password"))}</span></button></form></div></div></div></div></div>`);
					}
					_push(`</div></div></div>`);
				} else _push(`<!---->`);
			}, "body", false, _parent);
...
var AuthModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$7, [["__scopeId", "data-v-f97699f8"]]);
//#endregion
	...
	setup(__props) {
		...
		*/
		...
		function initMobileMenuMmenu() {
			const $ = window.jQuery;
			if (!$ || !$.fn?.mmenu) {
				if (!initMobileMenuMmenu._retries) initMobileMenuMmenu._retries = 0;
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-62aad782><div id="header" class="${ssrRenderClass([{
				"imas-scroll-pinned": headerPinned.value,
				"imas-scroll-pinned--in": headerPinned.value && headerPinnedVisible.value
			}, "imas-nav imas-nav__bar bottom"])}" data-v-62aad782><div class="container imas-nav__container" data-v-62aad782><div id="logo" class="imas-nav__logo" data-v-62aad782>`);
			_push(ssrRenderComponent(unref(Link), {
				href: homeHref.value,
				class: "imas-nav__logo-link"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-62aad782${_scopeId}><span class="imas-brand-text" data-v-62aad782${_scopeId}><span class="website-name" data-v-62aad782${_scopeId}>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-62aad782${_scopeId}>${ssrInterpolate(websiteSlogan$1)}</span></span>`);
			...
			_push(`</div><nav id="navigation" class="imas-nav__menu style-1" data-v-62aad782><ul id="responsive" data-v-62aad782><!--[-->`);
			ssrRenderList(__props.navLinks, (item) => {
				_push(`<li class="${ssrRenderClass([{ "has-submenu": item?.children?.length }, "imas-nav-item"])}" data-v-62aad782>`);
				...
				else _push(`<a href="#" class="${ssrRenderClass({ active: isNavLinkActive(item) })}" data-v-62aad782>${ssrInterpolate(item.label ?? trans(item.key))}</a>`);
				if (item?.children?.length) {
					_push(`<ul class="imas-nav__submenu" data-v-62aad782><!--[-->`);
					ssrRenderList(item.children, (child) => {
						_push(`<li class="imas-nav__submenu-item" data-v-62aad782>`);
						_push(ssrRenderComponent(unref(Link), {
							href: child.href,
			...
			_push(`<!--]-->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-62aad782><a href="#" class="imas-auth-nav-link" data-open-auth="login" data-v-62aad782>${ssrInterpolate(trans("Login"))}</a></li>`);
			else _push(`<!---->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-62aad782><a href="#" class="imas-auth-nav-link" data-open-auth="register" data-v-62aad782>${ssrInterpolate(trans("Register"))}</a></li>`);
			else _push(`<!---->`);
			_push(`</ul></nav><div class="imas-nav__end" data-v-62aad782><div class="${ssrRenderClass([{ "imas-nav__actions--rtl": isRtl.value }, "imas-nav__actions right"])}" data-v-62aad782><div class="header-user-menu user-menu add imas-nav__lang imas-header-action" data-v-62aad782><div class="${ssrRenderClass([{ "lang-wrap--open": langMenuOpen.value }, "lang-wrap"])}" data-v-62aad782><button type="button" class="show-lang imas-nav__lang-trigger"${ssrRenderAttr("aria-expanded", langMenuOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", trans("Language"))} data-v-62aad782><span class="show-lang-trigger-inner" data-v-62aad782>`);
			if (flagCountryClass(currentLocale.value)) _push(`<span class="${ssrRenderClass([flagCountryClass(currentLocale.value), "fi lang-switch-flag lang-switch-flag--trigger"])}" aria-hidden="true" data-v-62aad782></span>`);
			else _push(`<!---->`);
			_push(`</span><i class="fa fa-caret-down arrlan" data-v-62aad782></i></button><ul class="lang-tooltip lang-action no-list-style" role="listbox" data-v-62aad782><!--[-->`);
			ssrRenderList(localeSwitcher.value, (loc) => {
				_push(`<li data-v-62aad782><a href="#" class="${ssrRenderClass([{ "current-lan": loc.code === currentLocale.value }, "lang-switch-row"])}" role="option"${ssrRenderAttr("aria-selected", loc.code === currentLocale.value)} data-v-62aad782>`);
				if (flagCountryClass(loc.code)) _push(`<span class="${ssrRenderClass([flagCountryClass(loc.code), "fi lang-switch-flag"])}" aria-hidden="true" data-v-62aad782></span>`);
				else _push(`<!---->`);
				_push(`<span class="mx-2" data-v-62aad782>${ssrInterpolate(loc.native)}</span></a></li>`);
			});
			_push(`<!--]--></ul></div></div><button type="button" class="imas-nav__search imas-header-action"${ssrRenderAttr("aria-label", trans("Search"))}${ssrRenderAttr("title", trans("Search"))} data-v-62aad782><i class="fa fa-search" aria-hidden="true" data-v-62aad782></i></button>`);
			if (auth.value && mounted.value) _push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<i class="fa fa-heart" aria-hidden="true" data-v-62aad782${_scopeId}></i>`);
			...
			if (mounted.value) {
				_push(`<div class="${ssrRenderClass([{ active: userMenuOpen.value }, "header-user-menu user-menu add UserMenu imas-header-action"])}" data-v-62aad782>`);
				if (auth.value) {
					_push(`<!--[--><button type="button" class="${ssrRenderClass([{ "imas-nav__account-trigger--rtl": isRtl.value }, "header-user-name imas-nav__account-trigger"])}"${ssrRenderAttr("aria-expanded", userMenuOpen.value)} aria-haspopup="true"${ssrRenderAttr("aria-label", trans("Account menu"))} data-v-62aad782><span class="imas-nav__avatar" data-v-62aad782><img${ssrRenderAttr("src", auth.value.avatar)} alt="" data-v-62aad782></span><span class="imas-nav__account-text imas-nav__desktop-only" data-v-62aad782>${ssrInterpolate(accountGreeting.value)}</span><i class="fa fa-caret-down imas-nav__account-caret imas-nav__desktop-only" aria-hidden="true" data-v-62aad782></i></button><ul class="imas-user-menu-dropdown text-start" data-v-62aad782>`);
					if (isAdmin.value) {
						_push(`<li data-v-62aad782>`);
						_push(ssrRenderComponent(unref(Link), {
					...
					_push(`<li data-v-62aad782><button type="button" class="imas-user-menu-dropdown__item dropdown-logout" data-v-62aad782>${ssrInterpolate(trans("global.LogOut"))}</button></li></ul><!--]-->`);
				} else _push(`<div class="imas-nav__sign-in imas-header-action" data-v-62aad782><a href="#" class="imas-nav__sign-in-link show-reg-form modal-open" data-open-auth="login" data-v-62aad782>${ssrInterpolate(trans("Sign In"))}</a></div>`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`</div><div class="mmenu-trigger imas-nav__mmenu" data-v-62aad782><button class="hamburger hamburger--collapse" type="button"${ssrRenderAttr("aria-label", trans("Menu"))} data-v-62aad782><span class="hamburger-box" data-v-62aad782><span class="hamburger-inner" data-v-62aad782></span></span></button></div></div></div></div><div class="imas-header-scroll-spacer" style="${ssrRenderStyle([{ height: `${scrollPinSpacerPx.value}px` }, headerPinned.value ? null : { display: "none" }])}" aria-hidden="true" data-v-62aad782></div>`);
...
var UserNavbar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["__scopeId", "data-v-62aad782"]]);
//#endregion
...
var _sfc_main$4 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-e69f552d><div class="container imas-nav__container imas-top-bar__inner" data-v-e69f552d><div class="imas-top-bar__contacts contact" data-v-e69f552d>`);
			if (phoneDisplay.value && phoneHref.value) _push(`<a class="imas-top-bar__link"${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-e69f552d><i class="fa fa-phone" aria-hidden="true" data-v-e69f552d></i><span class="imas-top-bar__phone" dir="ltr" data-v-e69f552d>${ssrInterpolate(phoneDisplay.value)}</span></a>`);
			else _push(`<!---->`);
			if (emailDisplay.value) _push(`<a class="imas-top-bar__link"${ssrRenderAttr("href", emailHref.value)} data-v-e69f552d><i class="fa fa-envelope" aria-hidden="true" data-v-e69f552d></i><span data-v-e69f552d>${ssrInterpolate(emailDisplay.value)}</span></a>`);
			else _push(`<!---->`);
			if (topBarPages.value.length && hasContactInfo.value) _push(`<span class="imas-top-bar__separator" aria-hidden="true" data-v-e69f552d>|</span>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			...
			if (topSocialLinks.value.length) {
				_push(`<ul class="imas-top-bar__socials socials"${ssrRenderAttr("aria-label", trans("Social media"))} data-v-e69f552d><!--[-->`);
				ssrRenderList(topSocialLinks.value, (item) => {
					_push(`<li data-v-e69f552d><a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-e69f552d><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-e69f552d></i></a></li>`);
				});
				_push(`<!--]--></ul>`);
			} else _push(`<!---->`);
			_push(`</div></div>`);
...
var UserTopBar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$4, [["__scopeId", "data-v-e69f552d"]]);
//#endregion
...
var _sfc_main$3 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[--><footer class="first-footer rec-pro imas-blog-footer" data-v-c8e658d8><div class="top-footer" data-v-c8e658d8><div class="container imas-footer-wrap" data-v-c8e658d8><div class="row imas-footer-grid" data-v-c8e658d8><div class="col-lg-3 col-md-6 f-col imas-footer-col--brand" data-v-c8e658d8><div class="netabout" data-v-c8e658d8><div class="brand-line" data-v-c8e658d8><div class="logo" data-v-c8e658d8><img${ssrRenderAttr("src", logoUrl.value)} alt="logo" class="footer_logo" data-v-c8e658d8></div><div class="imas-brand-text" data-v-c8e658d8><span class="website-name" data-v-c8e658d8>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-c8e658d8>${ssrInterpolate(websiteSlogan)}</span></div></div></div><div class="contactus text-start" data-v-c8e658d8><ul data-v-c8e658d8><li class="contact-line" data-v-c8e658d8><div class="info" data-v-c8e658d8><span class="ic" aria-hidden="true" data-v-c8e658d8><i class="fa fa-map-marker" data-v-c8e658d8></i></span><p class="in-p" data-v-c8e658d8>${ssrInterpolate(settings.value.contact_address || fallbackAddress)}</p></div></li><li class="contact-line" data-v-c8e658d8><div class="info" data-v-c8e658d8><span class="ic" aria-hidden="true" data-v-c8e658d8><i class="fa fa-phone" data-v-c8e658d8></i></span><p class="in-p in-p--phone" dir="ltr" data-v-c8e658d8>`);
			if (phoneDisplay.value && phoneHref.value) _push(`<span class="in-p-link-wrap" data-v-c8e658d8><a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-c8e658d8>${ssrInterpolate(phoneDisplay.value)}</a></span>`);
			else if (phoneDisplay.value) _push(`<!--[-->${ssrInterpolate(phoneDisplay.value)}<!--]-->`);
			else _push(`<!---->`);
			_push(`</p></div></li><li class="contact-line" data-v-c8e658d8><div class="info" data-v-c8e658d8><span class="ic" aria-hidden="true" data-v-c8e658d8><i class="fa fa-envelope" data-v-c8e658d8></i></span><p class="in-p ti" data-v-c8e658d8>${ssrInterpolate(settings.value.contact_email || fallbackEmail)}</p></div></li></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-c8e658d8><div class="navigation text-start" data-v-c8e658d8><h3 data-v-c8e658d8>${ssrInterpolate(trans("navBar.navigation"))}</h3><div class="nav-footer text-start" data-v-c8e658d8><ul class="links" data-v-c8e658d8><!--[-->`);
			ssrRenderList(mainNavLinks.value, (item) => {
				_push(`<li data-v-c8e658d8>`);
			...
			_push(`<!--]--></ul></div></div></div><div class="col-lg-3 col-md-6 f-col" data-v-c8e658d8><div class="navigation text-start" data-v-c8e658d8><h3 data-v-c8e658d8>${ssrInterpolate(trans("navBar.useful_links"))}</h3><ul class="links links--single" data-v-c8e658d8><!--[-->`);
			...
			_push(`<!--]--></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-c8e658d8><div class="newsletters text-start" data-v-c8e658d8><h3 data-v-c8e658d8>${ssrInterpolate(trans("navBar.newsLetters"))}</h3><p data-v-c8e658d8>${ssrInterpolate(trans("navBar.signup_for_newsletters"))}</p></div><form class="bloq-email mailchimp form-inline newsletter" data-v-c8e658d8><div class="email" data-v-c8e658d8><input id="subscribeEmail"${ssrRenderAttr("value", unref(subscribeForm).email)} type="email" name="email" required maxlength="255"${ssrRenderAttr("placeholder", trans("navBar.enter_your_email"))}${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} class="${ssrRenderClass({ "is-invalid": unref(subscribeForm).errors.email })}" data-v-c8e658d8><button type="submit"${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} data-v-c8e658d8>${ssrInterpolate(trans("navBar.subscribe"))}</button></div>`);
			if (unref(subscribeForm).errors.email) _push(`<p class="subscription-error" role="alert" data-v-c8e658d8>${ssrInterpolate(unref(subscribeForm).errors.email)}</p>`);
			else _push(`<!---->`);
			if (showSubscriptionSuccess.value) _push(`<p class="subscription-success" role="status" data-v-c8e658d8>${ssrInterpolate(trans("navBar.subscription_success"))}</p>`);
			else _push(`<!---->`);
			_push(`</form>`);
			if (footerSocialLinks.value.length) {
				_push(`<div class="socials imas-footer-socials" role="group"${ssrRenderAttr("aria-label", trans("Social media"))} data-v-c8e658d8><!--[-->`);
				ssrRenderList(footerSocialLinks.value, (item) => {
					_push(`<a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-c8e658d8><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-c8e658d8></i></a>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div></div></div></div><div class="second-footer rec-pro copyright" data-v-c8e658d8><div class="container imas-footer-wrap imas-second-footer__inner" data-v-c8e658d8>`);
			if (bottomBarPages.value.length) {
				_push(`<nav class="imas-second-footer__bottom-bar"${ssrRenderAttr("aria-label", trans("navBar.useful_links"))} data-v-c8e658d8><!--[-->`);
				ssrRenderList(bottomBarPages.value, (p, index) => {
					_push(`<!--[-->`);
					if (index > 0) _push(`<span class="imas-second-footer__separator" aria-hidden="true" data-v-c8e658d8>|</span>`);
					else _push(`<!---->`);
					_push(ssrRenderComponent(unref(Link), {
				...
				_push(`<!--]--></nav>`);
			} else _push(`<div class="imas-second-footer__bottom-bar imas-second-footer__bottom-bar--empty" aria-hidden="true" data-v-c8e658d8></div>`);
			_push(`<p class="imas-second-footer__copy" data-v-c8e658d8>${ssrInterpolate(year.value)} © ${ssrInterpolate(appName.value)} — ${ssrInterpolate(trans("navBar.All Rights Reserved"))}</p><a href="https://symfonix.io/en" target="_blank" rel="noopener noreferrer" class="text-decoration-none" data-v-c8e658d8><p class="imas-second-footer__developer" data-v-c8e658d8><span data-v-c8e658d8>${ssrInterpolate(trans("Developed By Symfonix"))}</span></p></a></div></div></footer><a data-scroll href="#wrapper" class="go-up"${ssrRenderAttr("aria-label", trans("navBar.back_to_top"))} data-v-c8e658d8><i class="fa fa-angle-double-up" aria-hidden="true" data-v-c8e658d8></i></a><!--]-->`);
		};
	}
};
...
var UserFooter_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-c8e658d8"]]);
//#endregion
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const skipToContentLabel = computed(() => trans("Skip to content", "Skip to content"));
		...
		const blogNavCategories = computed(() => (page.props.globals?.blog_categories ?? []).filter((c) => c.add_to_navbar));
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div id="wrapper" class="imas-theme-dark"><a class="imas-skip-link" href="#main-content">${ssrInterpolate(skipToContentLabel.value)}</a>`);
			...
			_push(`<div class="clearfix"></div><main id="main-content" class="imas-main" tabindex="-1">`);
