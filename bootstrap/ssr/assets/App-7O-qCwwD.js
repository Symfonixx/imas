	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-4010911c><div id="header" class="${ssrRenderClass([{
				"imas-scroll-pinned": headerPinned.value,
				"imas-scroll-pinned--in": headerPinned.value && headerPinnedVisible.value
			}, "imas-nav imas-nav__bar bottom"])}" data-v-4010911c><div class="container imas-nav__container" data-v-4010911c><div id="logo" class="imas-nav__logo" data-v-4010911c>`);
			_push(ssrRenderComponent(unref(Link), {
				href: homeHref.value,
				class: "imas-nav__logo-link"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-4010911c${_scopeId}><span class="imas-brand-text" data-v-4010911c${_scopeId}><span class="website-name" data-v-4010911c${_scopeId}>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-4010911c${_scopeId}>${ssrInterpolate(websiteSlogan$1)}</span></span>`);
			...
			_push(`</div><nav id="navigation" class="imas-nav__menu style-1" data-v-4010911c><ul id="responsive" data-v-4010911c><!--[-->`);
			ssrRenderList(__props.navLinks, (item) => {
				_push(`<li class="${ssrRenderClass([{ "has-submenu": item?.children?.length }, "imas-nav-item"])}" data-v-4010911c>`);
				...
				else _push(`<a href="#" class="${ssrRenderClass({ active: isNavLinkActive(item) })}" data-v-4010911c>${ssrInterpolate(item.label ?? trans(item.key))}</a>`);
				if (item?.children?.length) {
					_push(`<ul class="imas-nav__submenu" data-v-4010911c><!--[-->`);
					ssrRenderList(item.children, (child) => {
						_push(`<li class="imas-nav__submenu-item" data-v-4010911c>`);
						_push(ssrRenderComponent(unref(Link), {
							href: child.href,
			...
			_push(`<!--]-->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-4010911c><a href="#" class="imas-auth-nav-link" data-open-auth="login" data-v-4010911c>${ssrInterpolate(trans("Login"))}</a></li>`);
			else _push(`<!---->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-4010911c><a href="#" class="imas-auth-nav-link" data-open-auth="register" data-v-4010911c>${ssrInterpolate(trans("Register"))}</a></li>`);
			else _push(`<!---->`);
			_push(`</ul></nav><div class="imas-nav__end" data-v-4010911c><div class="${ssrRenderClass([{ "imas-nav__actions--rtl": isRtl.value }, "imas-nav__actions right"])}" data-v-4010911c><div class="header-user-menu user-menu add imas-nav__lang imas-header-action" data-v-4010911c><div class="${ssrRenderClass([{ "lang-wrap--open": langMenuOpen.value }, "lang-wrap"])}" data-v-4010911c><button type="button" class="show-lang imas-nav__lang-trigger"${ssrRenderAttr("aria-expanded", langMenuOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", trans("Language"))} data-v-4010911c><span class="show-lang-trigger-inner" data-v-4010911c>`);
			if (flagCountryClass(currentLocale.value)) _push(`<span class="${ssrRenderClass([flagCountryClass(currentLocale.value), "fi lang-switch-flag lang-switch-flag--trigger"])}" aria-hidden="true" data-v-4010911c></span>`);
			else _push(`<!---->`);
			_push(`</span><i class="fa fa-caret-down arrlan" data-v-4010911c></i></button><ul class="lang-tooltip lang-action no-list-style" role="listbox" data-v-4010911c><!--[-->`);
			ssrRenderList(localeSwitcher.value, (loc) => {
				_push(`<li data-v-4010911c><a href="#" class="${ssrRenderClass([{ "current-lan": loc.code === currentLocale.value }, "lang-switch-row"])}" role="option"${ssrRenderAttr("aria-selected", loc.code === currentLocale.value)} data-v-4010911c>`);
				if (flagCountryClass(loc.code)) _push(`<span class="${ssrRenderClass([flagCountryClass(loc.code), "fi lang-switch-flag"])}" aria-hidden="true" data-v-4010911c></span>`);
				else _push(`<!---->`);
				_push(`<span class="mx-2" data-v-4010911c>${ssrInterpolate(loc.native)}</span></a></li>`);
			});
			_push(`<!--]--></ul></div></div><button type="button" class="imas-nav__search imas-header-action"${ssrRenderAttr("aria-label", trans("Search"))}${ssrRenderAttr("title", trans("Search"))} data-v-4010911c><i class="fa fa-search" aria-hidden="true" data-v-4010911c></i></button>`);
			if (auth.value && mounted.value) _push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<i class="fa fa-heart" aria-hidden="true" data-v-4010911c${_scopeId}></i>`);
			...
			if (mounted.value) {
				_push(`<div class="${ssrRenderClass([{ active: userMenuOpen.value }, "header-user-menu user-menu add UserMenu imas-header-action"])}" data-v-4010911c>`);
				if (auth.value) {
					_push(`<!--[--><button type="button" class="${ssrRenderClass([{ "imas-nav__account-trigger--rtl": isRtl.value }, "header-user-name imas-nav__account-trigger"])}"${ssrRenderAttr("aria-expanded", userMenuOpen.value)} aria-haspopup="true"${ssrRenderAttr("aria-label", trans("Account menu"))} data-v-4010911c><span class="imas-nav__avatar" data-v-4010911c><img${ssrRenderAttr("src", auth.value.avatar)} alt="" data-v-4010911c></span><span class="imas-nav__account-text imas-nav__desktop-only" data-v-4010911c>${ssrInterpolate(accountGreeting.value)}</span><i class="fa fa-caret-down imas-nav__account-caret imas-nav__desktop-only" aria-hidden="true" data-v-4010911c></i></button><ul class="imas-user-menu-dropdown text-start" data-v-4010911c>`);
					if (isAdmin.value) {
						_push(`<li data-v-4010911c>`);
						_push(ssrRenderComponent(unref(Link), {
					...
					_push(`<li data-v-4010911c><button type="button" class="imas-user-menu-dropdown__item dropdown-logout" data-v-4010911c>${ssrInterpolate(trans("global.LogOut"))}</button></li></ul><!--]-->`);
				} else _push(`<div class="imas-nav__sign-in imas-header-action" data-v-4010911c><a href="#" class="imas-nav__sign-in-link show-reg-form modal-open" data-open-auth="login" data-v-4010911c>${ssrInterpolate(trans("Sign In"))}</a></div>`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`</div><div class="mmenu-trigger imas-nav__mmenu" data-v-4010911c><button class="hamburger hamburger--collapse" type="button"${ssrRenderAttr("aria-label", trans("Menu"))} data-v-4010911c><span class="hamburger-box" data-v-4010911c><span class="hamburger-inner" data-v-4010911c></span></span></button></div></div></div></div><div class="imas-header-scroll-spacer" style="${ssrRenderStyle([{ height: `${scrollPinSpacerPx.value}px` }, headerPinned.value ? null : { display: "none" }])}" aria-hidden="true" data-v-4010911c></div>`);
...
var UserNavbar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["__scopeId", "data-v-4010911c"]]);
//#endregion
...
var _sfc_main$3 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[--><footer class="first-footer rec-pro imas-blog-footer" data-v-a58e0105><div class="top-footer" data-v-a58e0105><div class="container imas-footer-wrap" data-v-a58e0105><div class="row imas-footer-grid" data-v-a58e0105><div class="col-lg-3 col-md-6 f-col imas-footer-col--brand" data-v-a58e0105><div class="netabout" data-v-a58e0105><div class="brand-line" data-v-a58e0105><div class="logo" data-v-a58e0105><img${ssrRenderAttr("src", logoUrl.value)} alt="logo" class="footer_logo" data-v-a58e0105></div><div class="imas-brand-text" data-v-a58e0105><span class="website-name" data-v-a58e0105>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-a58e0105>${ssrInterpolate(websiteSlogan)}</span></div></div></div><div class="contactus text-start" data-v-a58e0105><ul data-v-a58e0105><li class="contact-line" data-v-a58e0105><div class="info" data-v-a58e0105><span class="ic" aria-hidden="true" data-v-a58e0105><i class="fa fa-map-marker" data-v-a58e0105></i></span><p class="in-p" data-v-a58e0105>${ssrInterpolate(settings.value.contact_address || fallbackAddress)}</p></div></li><li class="contact-line" data-v-a58e0105><div class="info" data-v-a58e0105><span class="ic" aria-hidden="true" data-v-a58e0105><i class="fa fa-phone" data-v-a58e0105></i></span><p class="in-p in-p--phone" dir="ltr" data-v-a58e0105>`);
			if (phoneDisplay.value && phoneHref.value) _push(`<span class="in-p-link-wrap" data-v-a58e0105><a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-a58e0105>${ssrInterpolate(phoneDisplay.value)}</a></span>`);
			else if (phoneDisplay.value) _push(`<!--[-->${ssrInterpolate(phoneDisplay.value)}<!--]-->`);
			else _push(`<!---->`);
			_push(`</p></div></li><li class="contact-line" data-v-a58e0105><div class="info" data-v-a58e0105><span class="ic" aria-hidden="true" data-v-a58e0105><i class="fa fa-envelope" data-v-a58e0105></i></span><p class="in-p ti" data-v-a58e0105>${ssrInterpolate(settings.value.contact_email || fallbackEmail)}</p></div></li></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-a58e0105><div class="navigation text-start" data-v-a58e0105><h3 data-v-a58e0105>${ssrInterpolate(trans("navBar.navigation"))}</h3><div class="nav-footer text-start" data-v-a58e0105><ul class="links" data-v-a58e0105><!--[-->`);
			ssrRenderList(mainNavLinks.value, (item) => {
				_push(`<li data-v-a58e0105>`);
			...
			_push(`<!--]--></ul></div></div></div><div class="col-lg-3 col-md-6 f-col" data-v-a58e0105><div class="navigation text-start" data-v-a58e0105><h3 data-v-a58e0105>${ssrInterpolate(trans("navBar.useful_links"))}</h3><ul class="links links--single" data-v-a58e0105><!--[-->`);
			...
			_push(`<!--]--></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-a58e0105><div class="newsletters text-start" data-v-a58e0105><h3 data-v-a58e0105>${ssrInterpolate(trans("navBar.newsLetters"))}</h3><p data-v-a58e0105>${ssrInterpolate(trans("navBar.signup_for_newsletters"))}</p></div><form class="bloq-email mailchimp form-inline newsletter" data-v-a58e0105><div class="email" data-v-a58e0105><input id="subscribeEmail"${ssrRenderAttr("value", unref(subscribeForm).email)} type="email" name="email" required maxlength="255"${ssrRenderAttr("placeholder", trans("navBar.enter_your_email"))}${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} class="${ssrRenderClass({ "is-invalid": unref(subscribeForm).errors.email })}" data-v-a58e0105><button type="submit"${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} data-v-a58e0105>${ssrInterpolate(trans("navBar.subscribe"))}</button></div>`);
			if (unref(subscribeForm).errors.email) _push(`<p class="subscription-error" role="alert" data-v-a58e0105>${ssrInterpolate(unref(subscribeForm).errors.email)}</p>`);
			else _push(`<!---->`);
			if (showSubscriptionSuccess.value) _push(`<p class="subscription-success" role="status" data-v-a58e0105>${ssrInterpolate(trans("navBar.subscription_success"))}</p>`);
			else _push(`<!---->`);
			_push(`</form>`);
			if (footerSocialLinks.value.length) {
				_push(`<div class="socials imas-footer-socials" role="group"${ssrRenderAttr("aria-label", trans("Social media"))} data-v-a58e0105><!--[-->`);
				ssrRenderList(footerSocialLinks.value, (item) => {
					_push(`<a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-a58e0105><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-a58e0105></i></a>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div></div></div></div><div class="second-footer rec-pro copyright" data-v-a58e0105><div class="container imas-footer-wrap imas-second-footer__inner" data-v-a58e0105>`);
			if (bottomBarPages.value.length) {
				_push(`<nav class="imas-second-footer__bottom-bar"${ssrRenderAttr("aria-label", trans("navBar.useful_links"))} data-v-a58e0105><!--[-->`);
				ssrRenderList(bottomBarPages.value, (p, index) => {
					_push(`<!--[-->`);
					if (index > 0) _push(`<span class="imas-second-footer__separator" aria-hidden="true" data-v-a58e0105>|</span>`);
					else _push(`<!---->`);
					_push(ssrRenderComponent(unref(Link), {
				...
				_push(`<!--]--></nav>`);
			} else _push(`<div class="imas-second-footer__bottom-bar imas-second-footer__bottom-bar--empty" aria-hidden="true" data-v-a58e0105></div>`);
			_push(`<p class="imas-second-footer__copy" data-v-a58e0105>${ssrInterpolate(year.value)} © ${ssrInterpolate(appName.value)} — ${ssrInterpolate(trans("navBar.All Rights Reserved"))}</p><a href="https://symfonix.io/en" target="_blank" class="text-decoration-none" data-v-a58e0105><p class="imas-second-footer__developer" data-v-a58e0105><span data-v-a58e0105>${ssrInterpolate(trans("Developed By Symfonix"))}</span></p></a></div></div></footer><a data-scroll href="#wrapper" class="go-up" data-v-a58e0105><i class="fa fa-angle-double-up" aria-hidden="true" data-v-a58e0105></i></a><!--]-->`);
		};
	}
};
...
var UserFooter_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-a58e0105"]]);
//#endregion
