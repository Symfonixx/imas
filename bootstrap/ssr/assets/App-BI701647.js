import { d as _plugin_vue_export_helper_default, i as refreshScrollTrigger, n as createGsapContext, p as IMAS_OPEN_AUTH_EVENT, r as prefersReducedMotion } from "../ssr.js";
...
var AuthModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$7, [["__scopeId", "data-v-064b5c15"]]);
//#endregion
...
var _sfc_main$3 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[--><footer class="first-footer rec-pro imas-blog-footer" data-v-a559791a><div class="top-footer" data-v-a559791a><div class="container imas-footer-wrap" data-v-a559791a><div class="row imas-footer-grid" data-v-a559791a><div class="col-lg-3 col-md-6 f-col imas-footer-col--brand" data-v-a559791a><div class="netabout" data-v-a559791a><div class="brand-line" data-v-a559791a><div class="logo" data-v-a559791a><img${ssrRenderAttr("src", logoUrl.value)} alt="logo" class="footer_logo" data-v-a559791a></div><div class="imas-brand-text" data-v-a559791a><span class="website-name" data-v-a559791a>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-a559791a>${ssrInterpolate(websiteSlogan)}</span></div></div></div><div class="contactus text-start" data-v-a559791a><ul data-v-a559791a><li class="contact-line" data-v-a559791a><div class="info" data-v-a559791a><span class="ic" aria-hidden="true" data-v-a559791a><i class="fa fa-map-marker" data-v-a559791a></i></span><p class="in-p" data-v-a559791a>${ssrInterpolate(settings.value.contact_address || fallbackAddress)}</p></div></li><li class="contact-line" data-v-a559791a><div class="info" data-v-a559791a><span class="ic" aria-hidden="true" data-v-a559791a><i class="fa fa-phone" data-v-a559791a></i></span><p class="in-p in-p--phone" dir="ltr" data-v-a559791a>`);
			if (phoneDisplay.value && phoneHref.value) _push(`<span class="in-p-link-wrap" data-v-a559791a><a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-a559791a>${ssrInterpolate(phoneDisplay.value)}</a></span>`);
			else if (phoneDisplay.value) _push(`<!--[-->${ssrInterpolate(phoneDisplay.value)}<!--]-->`);
			else _push(`<!---->`);
			_push(`</p></div></li><li class="contact-line" data-v-a559791a><div class="info" data-v-a559791a><span class="ic" aria-hidden="true" data-v-a559791a><i class="fa fa-envelope" data-v-a559791a></i></span><p class="in-p ti" data-v-a559791a>${ssrInterpolate(settings.value.contact_email || fallbackEmail)}</p></div></li></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-a559791a><div class="navigation text-start" data-v-a559791a><h3 data-v-a559791a>${ssrInterpolate(trans("navBar.navigation"))}</h3><div class="nav-footer text-start" data-v-a559791a><ul class="links" data-v-a559791a><!--[-->`);
			ssrRenderList(mainNavLinks.value, (item) => {
				_push(`<li data-v-a559791a>`);
			...
			_push(`<!--]--></ul></div></div></div><div class="col-lg-3 col-md-6 f-col" data-v-a559791a><div class="navigation text-start" data-v-a559791a><h3 data-v-a559791a>${ssrInterpolate(trans("navBar.useful_links"))}</h3><ul class="links links--single" data-v-a559791a><!--[-->`);
			...
			_push(`<!--]--></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-a559791a><div class="newsletters text-start" data-v-a559791a><h3 data-v-a559791a>${ssrInterpolate(trans("navBar.newsLetters"))}</h3><p data-v-a559791a>${ssrInterpolate(trans("navBar.signup_for_newsletters"))}</p></div><form class="bloq-email mailchimp form-inline newsletter" data-v-a559791a><div class="email" data-v-a559791a><input id="subscribeEmail"${ssrRenderAttr("value", unref(subscribeForm).email)} type="email" name="email" required maxlength="255"${ssrRenderAttr("placeholder", trans("navBar.enter_your_email"))}${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} class="${ssrRenderClass({ "is-invalid": unref(subscribeForm).errors.email })}" data-v-a559791a><button type="submit"${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} data-v-a559791a>${ssrInterpolate(trans("navBar.subscribe"))}</button></div>`);
			if (unref(subscribeForm).errors.email) _push(`<p class="subscription-error" role="alert" data-v-a559791a>${ssrInterpolate(unref(subscribeForm).errors.email)}</p>`);
			else _push(`<!---->`);
			if (showSubscriptionSuccess.value) _push(`<p class="subscription-success" role="status" data-v-a559791a>${ssrInterpolate(trans("navBar.subscription_success"))}</p>`);
			else _push(`<!---->`);
			_push(`</form>`);
			if (footerSocialLinks.value.length) {
				_push(`<div class="socials imas-footer-socials"${ssrRenderAttr("aria-label", trans("Social media"))} data-v-a559791a><!--[-->`);
				ssrRenderList(footerSocialLinks.value, (item) => {
					_push(`<a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-a559791a><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-a559791a></i></a>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div></div></div></div><div class="second-footer rec-pro copyright" data-v-a559791a><div class="container imas-footer-wrap imas-second-footer__inner" data-v-a559791a>`);
			if (bottomBarPages.value.length) {
				_push(`<nav class="imas-second-footer__bottom-bar"${ssrRenderAttr("aria-label", trans("navBar.useful_links"))} data-v-a559791a><!--[-->`);
				ssrRenderList(bottomBarPages.value, (p, index) => {
					_push(`<!--[-->`);
					if (index > 0) _push(`<span class="imas-second-footer__separator" aria-hidden="true" data-v-a559791a>|</span>`);
					else _push(`<!---->`);
					_push(ssrRenderComponent(unref(Link), {
				...
				_push(`<!--]--></nav>`);
			} else _push(`<div class="imas-second-footer__bottom-bar imas-second-footer__bottom-bar--empty" aria-hidden="true" data-v-a559791a></div>`);
			_push(`<p class="imas-second-footer__copy" data-v-a559791a>${ssrInterpolate(year.value)} © ${ssrInterpolate(appName.value)} — ${ssrInterpolate(trans("navBar.All Rights Reserved"))}</p><p class="imas-second-footer__developer" data-v-a559791a><span data-v-a559791a>${ssrInterpolate(trans("Developed By Symfonix"))}</span><a href="https://symfonix.io/" target="_blank" rel="noopener noreferrer" class="imas-second-footer__developer-link" data-v-a559791a>${ssrInterpolate(trans("Go to website"))}</a></p></div></div></footer><a data-scroll href="#wrapper" class="go-up" data-v-a559791a><i class="fa fa-angle-double-up" aria-hidden="true" data-v-a559791a></i></a><!--]-->`);
		};
	}
};
...
var UserFooter_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-a559791a"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (hasAnyChannel.value) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: ["imas-floating-contact", { "imas-floating-contact--open": isOpen.value }] }, _attrs))} data-v-86f80b4b><div id="imas-floating-contact-menu" class="imas-floating-contact__panel" role="dialog"${ssrRenderAttr("aria-label", menuAriaLabel.value)} style="${ssrRenderStyle(isOpen.value ? null : { display: "none" })}" data-v-86f80b4b><p class="imas-floating-contact__title text-md font-semibold" data-v-86f80b4b>${ssrInterpolate(menuTitle.value)}</p><ul class="imas-floating-contact__list" data-v-86f80b4b>`);
				if (whatsappHref.value) _push(`<li data-v-86f80b4b><a${ssrRenderAttr("href", whatsappHref.value)} class="imas-floating-contact__item" target="_blank" rel="noopener noreferrer" data-v-86f80b4b><span class="imas-floating-contact__icon imas-floating-contact__icon--whatsapp" aria-hidden="true" data-v-86f80b4b><i class="fa fa-whatsapp" data-v-86f80b4b></i></span><span class="imas-floating-contact__label text-sm font-medium" data-v-86f80b4b>${ssrInterpolate(labelWhatsApp.value)}</span></a></li>`);
				else _push(`<!---->`);
				if (gmailHref.value) _push(`<li data-v-86f80b4b><a${ssrRenderAttr("href", gmailHref.value)} class="imas-floating-contact__item" target="_blank" rel="noopener noreferrer" data-v-86f80b4b><span class="imas-floating-contact__icon imas-floating-contact__icon--gmail" aria-hidden="true" data-v-86f80b4b><i class="fab fa-google" data-v-86f80b4b></i></span><span class="imas-floating-contact__label text-sm font-medium" data-v-86f80b4b>${ssrInterpolate(labelGmail.value)}</span></a></li>`);
				else _push(`<!---->`);
				if (phoneHref.value) _push(`<li data-v-86f80b4b><a${ssrRenderAttr("href", phoneHref.value)} class="imas-floating-contact__item" data-v-86f80b4b><span class="imas-floating-contact__icon imas-floating-contact__icon--phone" aria-hidden="true" data-v-86f80b4b><i class="fa fa-phone" data-v-86f80b4b></i></span><span class="imas-floating-contact__label text-sm font-medium" data-v-86f80b4b>${ssrInterpolate(labelDirectCall.value)}</span></a></li>`);
				else _push(`<!---->`);
				_push(`</ul></div><button type="button" class="imas-floating-contact__toggle"${ssrRenderAttr("aria-expanded", isOpen.value)}${ssrRenderAttr("aria-controls", isOpen.value ? "imas-floating-contact-menu" : void 0)}${ssrRenderAttr("aria-label", toggleAriaLabel.value)} data-v-86f80b4b><i class="${ssrRenderClass([isOpen.value ? "fa-times" : "fa-comment", "fa"])}" aria-hidden="true" data-v-86f80b4b></i></button></div>`);
			} else _push(`<!---->`);
		};
	}
};
...
var FloatingContactButton_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-86f80b4b"]]);
//#endregion
