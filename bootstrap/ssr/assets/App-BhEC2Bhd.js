...
var _sfc_main$8 = {
	...
	setup(__props, { emit: __emit }) {
		...
		const authNoteText = computed(() => activeMainTab.value === "register" ? trans("RegisterNote") : trans("LoginNote"));
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (mounted.value) ssrRenderTeleport(_push, (_push) => {
				if (__props.open) {
					_push(`<div class="login-and-register-form modal imas-auth-modal" role="dialog" aria-modal="true"${ssrRenderAttr("aria-label", trans("auth_modal.dialog_label"))} data-v-441f9c3d><div class="main-overlay" tabindex="-1" data-v-441f9c3d></div><div class="main-register-holder" data-v-441f9c3d><div class="main-register fl-wrap" data-v-441f9c3d><div class="close-reg" role="button" tabindex="0"${ssrRenderAttr("aria-label", trans("auth_modal.close"))} data-v-441f9c3d><i class="fa fa-times" aria-hidden="true" data-v-441f9c3d></i></div>`);
					if (logoUrl.value) _push(`<div class="app_logo" data-v-441f9c3d><img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-441f9c3d></div>`);
					else _push(`<!---->`);
					_push(`<h3 class="text-center" data-v-441f9c3d>${ssrInterpolate(authNoteText.value)}</h3>`);
					if (authSubview.value === "forgot") {
						_push(`<div class="custom-form" data-v-441f9c3d><p class="mb-3 text-start px-0" data-v-441f9c3d></p><a href="#" class="imas-auth-modal__back text-start" data-v-441f9c3d><i class="fa fa-angle-left fa-lg imas-auth-modal__back-icon" aria-hidden="true" data-v-441f9c3d></i><span class="imas-auth-modal__back-label" data-v-441f9c3d>${ssrInterpolate(trans("auth_modal.back_to_login"))}</span></a><form class="forgot-password-form" data-v-441f9c3d><div data-v-441f9c3d><label for="imas-auth-forgot-email" data-v-441f9c3d>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-forgot-email"${ssrRenderAttr("value", unref(forgotForm).email)} type="email" autocomplete="email" required data-v-441f9c3d>`);
						if (unref(forgotForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(forgotForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(forgotForm).processing) ? " disabled" : ""} data-v-441f9c3d><span data-v-441f9c3d>${ssrInterpolate(trans("Send Email Verification"))}</span></button></div></form></div>`);
					} else {
						_push(`<div id="tabs-container" data-v-441f9c3d><ul class="tabs-menu" data-v-441f9c3d><li class="${ssrRenderClass({ current: activeMainTab.value === "login" })}" data-v-441f9c3d><a href="#tab-imas-login" data-v-441f9c3d>${ssrInterpolate(trans("Login"))}</a></li><li class="${ssrRenderClass({ current: activeMainTab.value === "register" })}" data-v-441f9c3d><a href="#tab-imas-register" data-v-441f9c3d>${ssrInterpolate(trans("Register"))}</a></li></ul><div class="tab" data-v-441f9c3d><div id="tab-imas-login" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "login" }, "tab-contents"])}" data-v-441f9c3d><div class="custom-form" data-v-441f9c3d><form data-v-441f9c3d><label for="imas-auth-login-email" data-v-441f9c3d>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-login-email"${ssrRenderAttr("value", unref(loginForm).email)} type="email" autocomplete="username" required data-v-441f9c3d>`);
						if (unref(loginForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(loginForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-login-password" data-v-441f9c3d>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-441f9c3d><input id="imas-auth-login-password"${ssrRenderDynamicModel(passwordVisible.value.login ? "text" : "password", unref(loginForm).password, null)}${ssrRenderAttr("type", passwordVisible.value.login ? "text" : "password")} autocomplete="current-password" required data-v-441f9c3d><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("login"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.login)} data-v-441f9c3d><i class="${ssrRenderClass(passwordVisible.value.login ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-441f9c3d></i></button></div>`);
						if (unref(loginForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(loginForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(loginForm).processing) ? " disabled" : ""} data-v-441f9c3d><span data-v-441f9c3d>${ssrInterpolate(trans("Sign In"))}</span></button><div class="clearfix" data-v-441f9c3d></div><div class="filter-tags" data-v-441f9c3d><input id="imas-auth-remember"${ssrIncludeBooleanAttr(Array.isArray(unref(loginForm).remember) ? ssrLooseContain(unref(loginForm).remember, null) : unref(loginForm).remember) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-441f9c3d><label for="imas-auth-remember" data-v-441f9c3d>${ssrInterpolate(trans("Remember Me"))}</label></div></form><div class="lost_password" data-v-441f9c3d><a href="#" data-v-441f9c3d>${ssrInterpolate(trans("Forgot Password"))}</a></div></div></div><div class="tab" data-v-441f9c3d><div id="tab-imas-register" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "register" }, "tab-contents"])}" data-v-441f9c3d><div class="custom-form main-register-form" data-v-441f9c3d><form data-v-441f9c3d><div class="imas-auth-form-field-row" data-v-441f9c3d><div class="imas-auth-form-field" data-v-441f9c3d><label for="imas-auth-reg-first-name" data-v-441f9c3d>${ssrInterpolate(trans("contact_us.first_name"))} *</label><input id="imas-auth-reg-first-name"${ssrRenderAttr("value", unref(registerForm).first_name)} type="text" autocomplete="given-name" required maxlength="120" data-v-441f9c3d>`);
						if (unref(registerForm).errors.first_name) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(registerForm).errors.first_name)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-441f9c3d><label for="imas-auth-reg-last-name" data-v-441f9c3d>${ssrInterpolate(trans("contact_us.last_name"))} *</label><input id="imas-auth-reg-last-name"${ssrRenderAttr("value", unref(registerForm).last_name)} type="text" autocomplete="family-name" required maxlength="120" data-v-441f9c3d>`);
						if (unref(registerForm).errors.last_name) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(registerForm).errors.last_name)}</span>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="imas-auth-form-field" data-v-441f9c3d><label for="imas-auth-reg-email" data-v-441f9c3d>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reg-email"${ssrRenderAttr("value", unref(registerForm).email)} type="email" autocomplete="email" required data-v-441f9c3d>`);
						if (unref(registerForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(registerForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-441f9c3d><label for="imas-auth-reg-mobile" data-v-441f9c3d>${ssrInterpolate(trans("Mobile"))} *</label><div class="${ssrRenderClass([{ "imas-auth-phone-field--country-open": registerCountryDropdownOpen.value }, "imas-auth-phone-field"])}" dir="ltr" data-v-441f9c3d><div class="imas-auth-country-select-shell" data-v-441f9c3d><button id="imas-auth-reg-country-code" type="button" class="imas-auth-country-trigger"${ssrRenderAttr("aria-expanded", registerCountryDropdownOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", registerCountrySelectAriaLabel.value)} data-v-441f9c3d>`);
						if (selectedRegisterCountry.value?.flag) _push(`<img class="imas-auth-country-flag-img"${ssrRenderAttr("src", selectedRegisterCountry.value.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-441f9c3d>`);
						else _push(`<!---->`);
						_push(`<span class="imas-auth-country-code-label" aria-hidden="true" data-v-441f9c3d>+${ssrInterpolate(displayCallingCode(selectedRegisterCountry.value?.phone_code))}</span></button><div class="imas-auth-country-dropdown-panel" style="${ssrRenderStyle(registerCountryDropdownOpen.value ? null : { display: "none" })}" data-v-441f9c3d><div class="imas-auth-country-dropdown-search-wrap text-start" data-v-441f9c3d><input${ssrRenderAttr("value", registerCountrySearchQuery.value)} type="search" enterkeyhint="search" autocomplete="off" autocorrect="off" spellcheck="false" class="imas-auth-country-dropdown-search"${ssrRenderAttr("placeholder", trans("Search"))}${ssrRenderAttr("aria-label", trans("Search"))} data-v-441f9c3d></div><ul class="imas-auth-country-dropdown-scroll" role="listbox" tabindex="-1" data-v-441f9c3d>`);
						if (countriesWithPhoneFiltered.value.length === 0) _push(`<li class="imas-auth-country-option imas-auth-country-option--empty" aria-live="polite" data-v-441f9c3d>${ssrInterpolate(trans("auth_modal.country_code_search_empty"))}</li>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(countriesWithPhoneFiltered.value, (c) => {
							_push(`<li role="option" class="${ssrRenderClass([{ "imas-auth-country-option--selected": c.id === registerCountryId.value }, "imas-auth-country-option"])}"${ssrRenderAttr("aria-selected", c.id === registerCountryId.value)} data-v-441f9c3d>`);
							if (c.flag) _push(`<img class="imas-auth-country-flag-img imas-auth-country-flag-img--option"${ssrRenderAttr("src", c.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-441f9c3d>`);
							else _push(`<!---->`);
							_push(`<span class="imas-auth-country-option-code" data-v-441f9c3d>+${ssrInterpolate(displayCallingCode(c.phone_code))}</span></li>`);
						});
						_push(`<!--]--></ul></div></div><span class="imas-auth-phone-sep" aria-hidden="true" data-v-441f9c3d></span><input id="imas-auth-reg-mobile"${ssrRenderAttr("value", registerMobileLocal.value)} type="tel" inputmode="numeric" autocomplete="tel-national" class="imas-auth-phone-input" required${ssrRenderAttr("placeholder", trans("auth_modal.mobile_national_placeholder"))} data-v-441f9c3d></div>`);
						if (registerMobileClientError.value) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(registerMobileClientError.value)}</span>`);
						else _push(`<!---->`);
						if (unref(registerForm).errors.mobile) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(registerForm).errors.mobile)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-441f9c3d><label for="imas-auth-reg-password" data-v-441f9c3d>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-441f9c3d><input id="imas-auth-reg-password"${ssrRenderDynamicModel(passwordVisible.value.register ? "text" : "password", unref(registerForm).password, null)}${ssrRenderAttr("type", passwordVisible.value.register ? "text" : "password")} autocomplete="new-password" required data-v-441f9c3d><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("register"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.register)} data-v-441f9c3d><i class="${ssrRenderClass(passwordVisible.value.register ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-441f9c3d></i></button></div>`);
						if (unref(registerForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(registerForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-441f9c3d><label for="imas-auth-reg-password-confirmation" data-v-441f9c3d>${ssrInterpolate(trans("Confirm Password"))} *</label><div class="imas-auth-password-field" data-v-441f9c3d><input id="imas-auth-reg-password-confirmation"${ssrRenderDynamicModel(passwordVisible.value.registerConfirm ? "text" : "password", unref(registerForm).password_confirmation, null)}${ssrRenderAttr("type", passwordVisible.value.registerConfirm ? "text" : "password")} autocomplete="new-password" required data-v-441f9c3d><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("registerConfirm"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.registerConfirm)} data-v-441f9c3d><i class="${ssrRenderClass(passwordVisible.value.registerConfirm ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-441f9c3d></i></button></div>`);
						if (unref(registerForm).errors.password_confirmation) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(registerForm).errors.password_confirmation)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-terms-wrap" data-v-441f9c3d><div class="filter-tags imas-auth-terms" data-v-441f9c3d><input id="imas-auth-terms"${ssrIncludeBooleanAttr(Array.isArray(registerTermsAccepted.value) ? ssrLooseContain(registerTermsAccepted.value, null) : registerTermsAccepted.value) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-441f9c3d><label for="imas-auth-terms" class="imas-auth-terms__label" data-v-441f9c3d>${ssrInterpolate(trans("auth_modal.agree_terms_prefix"))} <a href="#" class="imas-auth-terms__link" data-v-441f9c3d>${ssrInterpolate(trans("auth_modal.terms_and_conditions"))}</a></label></div>`);
						if (registerTermsClientError.value) _push(`<p class="imas-auth-terms__error" role="alert" data-v-441f9c3d>${ssrInterpolate(registerTermsClientError.value)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field imas-auth-form-field--actions" data-v-441f9c3d><button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(registerForm).processing) ? " disabled" : ""} data-v-441f9c3d><span data-v-441f9c3d>${ssrInterpolate(trans("Register"))}</span></button></div></form></div></div></div><div class="tab" data-v-441f9c3d><div id="tab-imas-reset" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "reset" }, "tab-contents"])}" data-v-441f9c3d><div class="custom-form" data-v-441f9c3d>`);
						if (!resetToken.value) _push(`<p class="imas-auth-modal__hint" data-v-441f9c3d>${ssrInterpolate(trans("auth_modal.reset_hint"))}</p>`);
						else _push(`<!---->`);
						_push(`<form data-v-441f9c3d><label for="imas-auth-reset-email" data-v-441f9c3d>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reset-email"${ssrRenderAttr("value", unref(resetForm).email)} type="email" autocomplete="email" required data-v-441f9c3d>`);
						if (unref(resetForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(resetForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-reset-password" data-v-441f9c3d>${ssrInterpolate(trans("Password"))} *</label><input id="imas-auth-reset-password"${ssrRenderAttr("value", unref(resetForm).password)} type="password" autocomplete="new-password" required data-v-441f9c3d>`);
						if (unref(resetForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(resetForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-reset-password-confirmation" data-v-441f9c3d>${ssrInterpolate(trans("Confirm Password"))} *</label><input id="imas-auth-reset-password-confirmation"${ssrRenderAttr("value", unref(resetForm).password_confirmation)} type="password" autocomplete="new-password" required data-v-441f9c3d>`);
						if (unref(resetForm).errors.password_confirmation) _push(`<span class="imas-auth-field-error" data-v-441f9c3d>${ssrInterpolate(unref(resetForm).errors.password_confirmation)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(resetForm).processing || !resetToken.value) ? " disabled" : ""} data-v-441f9c3d><span data-v-441f9c3d>${ssrInterpolate(trans("Reset Password"))}</span></button></form></div></div></div></div></div>`);
					}
					_push(`</div></div></div>`);
				} else _push(`<!---->`);
			}, "body", false, _parent);
...
var AuthModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$8, [["__scopeId", "data-v-441f9c3d"]]);
//#endregion
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			ssrRenderList(__props.navLinks, (item) => {
				_push(`<li class="${ssrRenderClass([{ "has-submenu": item?.children?.length }, "imas-nav-item"])}" data-v-75ddbaa3>`);
				...
				else _push(`<a href="#" class="${ssrRenderClass({ active: isNavLinkActive(item) })}" data-v-75ddbaa3>${ssrInterpolate(item.label ?? trans(item.key))}</a>`);
			...
			_push(`<!--]-->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-75ddbaa3><a href="#" class="imas-auth-nav-link" data-open-auth="login" data-v-75ddbaa3>${ssrInterpolate(trans("Login"))}</a></li>`);
			else _push(`<!---->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-75ddbaa3><a href="#" class="imas-auth-nav-link" data-open-auth="register" data-v-75ddbaa3>${ssrInterpolate(trans("Register"))}</a></li>`);
			else _push(`<!---->`);
			...
			if (flagCountryClass(currentLocale.value)) _push(`<span class="${ssrRenderClass([flagCountryClass(currentLocale.value), "fi lang-switch-flag lang-switch-flag--trigger"])}" aria-hidden="true" data-v-75ddbaa3></span>`);
			else _push(`<!---->`);
			...
			ssrRenderList(localeSwitcher.value, (loc) => {
				_push(`<li data-v-75ddbaa3><a href="#" class="${ssrRenderClass([{ "current-lan": loc.code === currentLocale.value }, "lang-switch-row"])}" role="option"${ssrRenderAttr("aria-selected", loc.code === currentLocale.value)} data-v-75ddbaa3>`);
				if (flagCountryClass(loc.code)) _push(`<span class="${ssrRenderClass([flagCountryClass(loc.code), "fi lang-switch-flag"])}" aria-hidden="true" data-v-75ddbaa3></span>`);
				else _push(`<!---->`);
			...
			if (auth.value && mounted.value) _push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<i class="fa fa-heart" aria-hidden="true" data-v-75ddbaa3${_scopeId}></i>`);
...
var UserNavbar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$6, [["__scopeId", "data-v-75ddbaa3"]]);
//#endregion
...
var _sfc_main$4 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[--><footer class="first-footer rec-pro imas-blog-footer" data-v-c9f807c0><div class="top-footer" data-v-c9f807c0><div class="container imas-footer-wrap" data-v-c9f807c0><div class="row imas-footer-grid" data-v-c9f807c0><div class="col-lg-3 col-md-6 f-col imas-footer-col--brand" data-v-c9f807c0><div class="netabout" data-v-c9f807c0><div class="brand-line" data-v-c9f807c0><div class="logo" data-v-c9f807c0><img${ssrRenderAttr("src", logoUrl.value)} alt="logo" class="footer_logo" data-v-c9f807c0></div><div class="imas-brand-text" data-v-c9f807c0><span class="website-name" data-v-c9f807c0>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-c9f807c0>${ssrInterpolate(websiteSlogan)}</span></div></div></div><div class="contactus text-start" data-v-c9f807c0><ul data-v-c9f807c0><li class="contact-line" data-v-c9f807c0><div class="info" data-v-c9f807c0><span class="ic" aria-hidden="true" data-v-c9f807c0><i class="fa fa-map-marker" data-v-c9f807c0></i></span><p class="in-p" data-v-c9f807c0>${ssrInterpolate(settings.value.contact_address || fallbackAddress)}</p></div></li><li class="contact-line" data-v-c9f807c0><div class="info" data-v-c9f807c0><span class="ic" aria-hidden="true" data-v-c9f807c0><i class="fa fa-phone" data-v-c9f807c0></i></span><p class="in-p in-p--phone" dir="ltr" data-v-c9f807c0>`);
			if (phoneDisplay.value && phoneHref.value) _push(`<span class="in-p-link-wrap" data-v-c9f807c0><a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-c9f807c0>${ssrInterpolate(phoneDisplay.value)}</a></span>`);
			else if (phoneDisplay.value) _push(`<!--[-->${ssrInterpolate(phoneDisplay.value)}<!--]-->`);
			else _push(`<!---->`);
			_push(`</p></div></li><li class="contact-line" data-v-c9f807c0><div class="info" data-v-c9f807c0><span class="ic" aria-hidden="true" data-v-c9f807c0><i class="fa fa-envelope" data-v-c9f807c0></i></span><p class="in-p ti" data-v-c9f807c0>${ssrInterpolate(settings.value.contact_email || fallbackEmail)}</p></div></li><li class="contact-line" data-v-c9f807c0><div class="info" data-v-c9f807c0><p class="in-p" data-v-c9f807c0>${ssrInterpolate(trans("navBar.footer_location"))}</p></div></li></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-c9f807c0><div class="navigation text-start" data-v-c9f807c0><h3 data-v-c9f807c0>${ssrInterpolate(trans("navBar.navigation"))}</h3><div class="nav-footer text-start" data-v-c9f807c0><ul class="links" data-v-c9f807c0><!--[-->`);
			ssrRenderList(mainNavLinks.value, (item) => {
				_push(`<li data-v-c9f807c0>`);
			...
			_push(`<!--]--></ul></div></div></div><div class="col-lg-3 col-md-6 f-col" data-v-c9f807c0><div class="navigation text-start" data-v-c9f807c0><h3 data-v-c9f807c0>${ssrInterpolate(trans("navBar.useful_links"))}</h3><ul class="links links--single" data-v-c9f807c0><!--[-->`);
			...
			_push(`<!--]--></ul></div></div><div class="col-lg-3 col-md-6 f-col" data-v-c9f807c0><div class="newsletters text-start" data-v-c9f807c0><h3 data-v-c9f807c0>${ssrInterpolate(trans("navBar.newsLetters"))}</h3><p data-v-c9f807c0>${ssrInterpolate(trans("navBar.signup_for_newsletters"))}</p></div><form class="bloq-email mailchimp form-inline newsletter" data-v-c9f807c0><div class="email" data-v-c9f807c0><input id="subscribeEmail"${ssrRenderAttr("value", unref(subscribeForm).email)} type="email" name="email" required maxlength="255"${ssrRenderAttr("placeholder", trans("navBar.enter_your_email"))}${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} class="${ssrRenderClass({ "is-invalid": unref(subscribeForm).errors.email })}" data-v-c9f807c0><button type="submit"${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} data-v-c9f807c0>${ssrInterpolate(trans("navBar.subscribe"))}</button></div>`);
			if (unref(subscribeForm).errors.email) _push(`<p class="subscription-error" role="alert" data-v-c9f807c0>${ssrInterpolate(unref(subscribeForm).errors.email)}</p>`);
			else _push(`<!---->`);
			if (showSubscriptionSuccess.value) _push(`<p class="subscription-success" role="status" data-v-c9f807c0>${ssrInterpolate(trans("navBar.subscription_success"))}</p>`);
			else _push(`<!---->`);
			_push(`</form>`);
			if (footerSocialLinks.value.length) {
				_push(`<div class="socials imas-footer-socials"${ssrRenderAttr("aria-label", trans("Social media"))} data-v-c9f807c0><!--[-->`);
				ssrRenderList(footerSocialLinks.value, (item) => {
					_push(`<a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-c9f807c0><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-c9f807c0></i></a>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div></div></div></div><div class="second-footer rec-pro copyright" data-v-c9f807c0><div class="container imas-footer-wrap imas-second-footer__inner" data-v-c9f807c0>`);
			if (bottomBarPages.value.length) {
				_push(`<nav class="imas-second-footer__bottom-bar"${ssrRenderAttr("aria-label", trans("navBar.useful_links"))} data-v-c9f807c0><!--[-->`);
				ssrRenderList(bottomBarPages.value, (p, index) => {
					_push(`<!--[-->`);
					if (index > 0) _push(`<span class="imas-second-footer__separator" aria-hidden="true" data-v-c9f807c0>|</span>`);
					else _push(`<!---->`);
					_push(ssrRenderComponent(unref(Link), {
				...
				_push(`<!--]--></nav>`);
			} else _push(`<div class="imas-second-footer__bottom-bar imas-second-footer__bottom-bar--empty" aria-hidden="true" data-v-c9f807c0></div>`);
			_push(`<p class="imas-second-footer__copy" data-v-c9f807c0>${ssrInterpolate(year.value)} © ${ssrInterpolate(appName.value)} — ${ssrInterpolate(trans("navBar.All Rights Reserved"))}</p><p class="imas-second-footer__developer" data-v-c9f807c0><span data-v-c9f807c0>${ssrInterpolate(developedByPrefix.value)}</span><a href="https://symfonix.io/" target="_blank" rel="noopener noreferrer" class="imas-second-footer__developer-link" data-v-c9f807c0>Symfonix</a></p></div></div></footer><a data-scroll href="#wrapper" class="go-up" data-v-c9f807c0><i class="fa fa-angle-double-up" aria-hidden="true" data-v-c9f807c0></i></a><!--]-->`);
		};
	}
};
...
var UserFooter_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$4, [["__scopeId", "data-v-c9f807c0"]]);
//#endregion
