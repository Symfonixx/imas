      ...
      if (mounted.value) {
        ssrRenderTeleport(_push, (_push2) => {
          ...
          if (__props.open) {
            ...
            if (logoUrl.value) {
              _push2(`<div class="app_logo" data-v-064b5c15><img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-064b5c15></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h3 class="text-center" data-v-064b5c15>${ssrInterpolate(authNoteText.value)}</h3>`);
            if (authSubview.value === "forgot") {
              _push2(`<div class="custom-form" data-v-064b5c15><p class="mb-3 text-start px-0" data-v-064b5c15></p><a href="#" class="imas-auth-modal__back text-start" data-v-064b5c15><i class="fa fa-angle-left fa-lg imas-auth-modal__back-icon" aria-hidden="true" data-v-064b5c15></i><span class="imas-auth-modal__back-label" data-v-064b5c15>${ssrInterpolate(trans("auth_modal.back_to_login"))}</span></a>`);
              if (authStatusMessage.value) {
                _push2(`<p class="imas-auth-modal__status" role="status" data-v-064b5c15>${ssrInterpolate(authStatusMessage.value)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<form class="forgot-password-form" data-v-064b5c15><div data-v-064b5c15><label for="imas-auth-forgot-email" data-v-064b5c15>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-forgot-email"${ssrRenderAttr("value", unref(forgotForm).email)} type="email" autocomplete="email" required data-v-064b5c15>`);
              if (unref(forgotForm).errors.email) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(forgotForm).errors.email)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(forgotForm).processing) ? " disabled" : ""} data-v-064b5c15><span data-v-064b5c15>${ssrInterpolate(trans("Send Email Verification"))}</span></button></div></form></div>`);
            } else {
              _push2(`<div id="tabs-container" data-v-064b5c15>`);
              if (authStatusMessage.value && activeMainTab.value === "login") {
                _push2(`<p class="imas-auth-modal__status" role="status" data-v-064b5c15>${ssrInterpolate(authStatusMessage.value)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<ul class="tabs-menu" data-v-064b5c15><li class="${ssrRenderClass({ current: activeMainTab.value === "login" })}" data-v-064b5c15><a href="#tab-imas-login" data-v-064b5c15>${ssrInterpolate(trans("Login"))}</a></li><li class="${ssrRenderClass({
                current: activeMainTab.value === "register"
              })}" data-v-064b5c15><a href="#tab-imas-register" data-v-064b5c15>${ssrInterpolate(trans("Register"))}</a></li>`);
              if (activeMainTab.value === "reset" || resetToken.value) {
                _push2(`<li class="${ssrRenderClass({ current: activeMainTab.value === "reset" })}" data-v-064b5c15><a href="#tab-imas-reset" data-v-064b5c15>${ssrInterpolate(trans("Reset Password"))}</a></li>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</ul><div class="tab" data-v-064b5c15><div id="tab-imas-login" class="${ssrRenderClass([{
                "imas-auth-tab--active": activeMainTab.value === "login"
              }, "tab-contents"])}" data-v-064b5c15><div class="custom-form" data-v-064b5c15><form data-v-064b5c15><label for="imas-auth-login-email" data-v-064b5c15>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-login-email"${ssrRenderAttr("value", unref(loginForm).email)} type="email" autocomplete="username" required data-v-064b5c15>`);
              if (unref(loginForm).errors.email) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(loginForm).errors.email)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<label for="imas-auth-login-password" data-v-064b5c15>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-064b5c15><input id="imas-auth-login-password"${ssrRenderDynamicModel(
                ...
                "type",
                passwordVisible.value.login ? "text" : "password"
              )} autocomplete="current-password" required data-v-064b5c15><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr(
                "aria-label",
                passwordToggleAria("login")
              )}${ssrRenderAttr(
                "aria-pressed",
                passwordVisible.value.login
              )} data-v-064b5c15><i class="${ssrRenderClass(
                passwordVisible.value.login ? "fa fa-eye-slash" : "fa fa-eye"
              )}" aria-hidden="true" data-v-064b5c15></i></button></div>`);
              if (unref(loginForm).errors.password) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(loginForm).errors.password)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              }, "tab-contents"])}" data-v-064b5c15><div class="custom-form main-register-form" data-v-064b5c15><form data-v-064b5c15><div class="imas-auth-form-field-row" data-v-064b5c15><div class="imas-auth-form-field" data-v-064b5c15><label for="imas-auth-reg-first-name" data-v-064b5c15>${ssrInterpolate(trans(
                "contact_us.first_name"
              ))} *</label><input id="imas-auth-reg-first-name"${ssrRenderAttr(
                "value",
                unref(registerForm).first_name
              )} type="text" autocomplete="given-name" required maxlength="120" data-v-064b5c15>`);
              if (unref(registerForm).errors.first_name) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(registerForm).errors.first_name)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="imas-auth-form-field" data-v-064b5c15><label for="imas-auth-reg-last-name" data-v-064b5c15>${ssrInterpolate(trans(
                "contact_us.last_name"
              ))} *</label><input id="imas-auth-reg-last-name"${ssrRenderAttr(
                "value",
                unref(registerForm).last_name
              )} type="text" autocomplete="family-name" required maxlength="120" data-v-064b5c15>`);
              if (unref(registerForm).errors.last_name) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(registerForm).errors.last_name)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="imas-auth-form-field" data-v-064b5c15><label for="imas-auth-reg-email" data-v-064b5c15>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reg-email"${ssrRenderAttr("value", unref(registerForm).email)} type="email" autocomplete="email" required data-v-064b5c15>`);
              if (unref(registerForm).errors.email) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(registerForm).errors.email)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="imas-auth-form-field" data-v-064b5c15><label for="imas-auth-reg-mobile" data-v-064b5c15>${ssrInterpolate(trans("Mobile"))} *</label><div class="${ssrRenderClass([{
                "imas-auth-phone-field--country-open": registerCountryDropdownOpen.value
              }, "imas-auth-phone-field"])}" dir="ltr" data-v-064b5c15><div class="imas-auth-country-select-shell" data-v-064b5c15><button id="imas-auth-reg-country-code" type="button" class="imas-auth-country-trigger"${ssrRenderAttr(
                "aria-expanded",
              ...
              if ((_a = selectedRegisterCountry.value) == null ? void 0 : _a.flag) {
                ...
                )} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-064b5c15>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span class="imas-auth-country-code-label" aria-hidden="true" data-v-064b5c15>+${ssrInterpolate(displayCallingCode(
                (_b = selectedRegisterCountry.value) == null ? void 0 : _b.phone_code
              ))}</span></button><div style="${ssrRenderStyle(registerCountryDropdownOpen.value ? null : { display: "none" })}" class="imas-auth-country-dropdown-panel" data-v-064b5c15><div class="imas-auth-country-dropdown-search-wrap text-start" data-v-064b5c15><input${ssrRenderAttr(
                "value",
                registerCountrySearchQuery.value
              ...
              )} data-v-064b5c15></div><ul class="imas-auth-country-dropdown-scroll" role="listbox" tabindex="-1" data-v-064b5c15>`);
              if (countriesWithPhoneFiltered.value.length === 0) {
                _push2(`<li class="imas-auth-country-option imas-auth-country-option--empty" aria-live="polite" data-v-064b5c15>${ssrInterpolate(trans(
              ...
              ssrRenderList(countriesWithPhoneFiltered.value, (c) => {
                ...
                _push2(`<span class="imas-auth-country-option-code" data-v-064b5c15>+${ssrInterpolate(displayCallingCode(
                  c.phone_code
                ))}</span></li>`);
              });
              _push2(`<!--]--></ul></div></div><span class="imas-auth-phone-sep" aria-hidden="true" data-v-064b5c15></span><input id="imas-auth-reg-mobile"${ssrRenderAttr(
                "value",
              ...
              if (registerMobileClientError.value) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(registerMobileClientError.value)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (unref(registerForm).errors.mobile) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(registerForm).errors.mobile)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="imas-auth-form-field" data-v-064b5c15><label for="imas-auth-reg-password" data-v-064b5c15>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-064b5c15><input id="imas-auth-reg-password"${ssrRenderDynamicModel(
                ...
                "type",
                passwordVisible.value.register ? "text" : "password"
              )} autocomplete="new-password" required data-v-064b5c15><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr(
                "aria-label",
                passwordToggleAria(
                  "register"
                )
              ...
              if (unref(registerForm).errors.password) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(registerForm).errors.password)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="imas-auth-form-field" data-v-064b5c15><label for="imas-auth-reg-password-confirmation" data-v-064b5c15>${ssrInterpolate(trans(
                "Confirm Password"
              ))} *</label><div class="imas-auth-password-field" data-v-064b5c15><input id="imas-auth-reg-password-confirmation"${ssrRenderDynamicModel(
              ...
              if (unref(registerForm).errors.password_confirmation) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(registerForm).errors.password_confirmation)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="imas-auth-terms-wrap" data-v-064b5c15><div class="filter-tags imas-auth-terms" data-v-064b5c15><input id="imas-auth-terms"${ssrIncludeBooleanAttr(
                Array.isArray(
              ...
              ) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-064b5c15><label for="imas-auth-terms" class="imas-auth-terms__label" data-v-064b5c15>${ssrInterpolate(trans(
                "auth_modal.agree_terms_prefix"
              ))} <a href="#" class="imas-auth-terms__link" data-v-064b5c15>${ssrInterpolate(trans(
                "auth_modal.terms_and_conditions"
              ))}</a></label></div>`);
              if (registerTermsClientError.value) {
                _push2(`<p class="imas-auth-terms__error" role="alert" data-v-064b5c15>${ssrInterpolate(registerTermsClientError.value)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="imas-auth-form-field imas-auth-form-field--actions" data-v-064b5c15><button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(
                unref(registerForm).processing
              ) ? " disabled" : ""} data-v-064b5c15><span data-v-064b5c15>${ssrInterpolate(trans("Register"))}</span></button></div></form></div></div></div><div class="tab" data-v-064b5c15><div id="tab-imas-reset" class="${ssrRenderClass([{
                "imas-auth-tab--active": activeMainTab.value === "reset"
              }, "tab-contents"])}" data-v-064b5c15><div class="custom-form" data-v-064b5c15>`);
              if (!resetToken.value) {
                _push2(`<p class="imas-auth-modal__hint" data-v-064b5c15>${ssrInterpolate(trans("auth_modal.reset_hint"))}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<form data-v-064b5c15><label for="imas-auth-reset-email" data-v-064b5c15>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reset-email"${ssrRenderAttr("value", unref(resetForm).email)} type="email" autocomplete="email" required data-v-064b5c15>`);
              if (unref(resetForm).errors.email) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(resetForm).errors.email)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<label for="imas-auth-reset-password" data-v-064b5c15>${ssrInterpolate(trans("Password"))} *</label><input id="imas-auth-reset-password"${ssrRenderAttr("value", unref(resetForm).password)} type="password" autocomplete="new-password" required data-v-064b5c15>`);
              if (unref(resetForm).errors.password) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(resetForm).errors.password)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<label for="imas-auth-reset-password-confirmation" data-v-064b5c15>${ssrInterpolate(trans("Confirm Password"))} *</label><input id="imas-auth-reset-password-confirmation"${ssrRenderAttr(
                "value",
                unref(resetForm).password_confirmation
              )} type="password" autocomplete="new-password" required data-v-064b5c15>`);
              if (unref(resetForm).errors.password_confirmation) {
                _push2(`<span class="imas-auth-field-error" data-v-064b5c15>${ssrInterpolate(unref(resetForm).errors.password_confirmation)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(
                unref(resetForm).processing || !resetToken.value
              ) ? " disabled" : ""} data-v-064b5c15><span data-v-064b5c15>${ssrInterpolate(trans("Reset Password"))}</span></button></form></div></div></div></div></div>`);
            }
            _push2(`</div></div></div>`);
          } else {
            _push2(`<!---->`);
...
const AuthModal = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-064b5c15"]]);
...
const NavbarSearchModal = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-bfb447fe"]]);
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    function onImasOpenAuthEvent(e) {
      var _a;
      openAuthModal(((_a = e.detail) == null ? void 0 : _a.tab) || "login");
    }
    function openAuthFromCurrentContext() {
      ...
      if (((_a = page.props.flash) == null ? void 0 : _a.status) && !authModalOpen.value) {
        openAuthModal("login");
      }
    }
    watch(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.navLinks, (item) => {
        ...
        if (item.href) {
          ...
          _push(`<a href="#" class="${ssrRenderClass({ active: isNavLinkActive(item) })}" data-v-0a7a998a>${ssrInterpolate(item.label ?? trans(item.key))}</a>`);
        }
      ...
      if (!auth.value && mounted.value) {
        _push(`<li class="imas-mmenu-only" data-v-0a7a998a><a href="#" class="imas-auth-nav-link" data-open-auth="login" data-v-0a7a998a>${ssrInterpolate(trans("Login"))}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      if (!auth.value && mounted.value) {
        _push(`<li class="imas-mmenu-only" data-v-0a7a998a><a href="#" class="imas-auth-nav-link" data-open-auth="register" data-v-0a7a998a>${ssrInterpolate(trans("Register"))}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (flagCountryClass(currentLocale.value)) {
        ...
        ])}" aria-hidden="true" data-v-0a7a998a></span>`);
      } else {
        _push(`<!---->`);
      }
      ...
      ssrRenderList(localeSwitcher.value, (loc) => {
        _push(`<li data-v-0a7a998a><a href="#" class="${ssrRenderClass([{
      ...
      if (auth.value && mounted.value) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fa fa-heart" aria-hidden="true" data-v-0a7a998a${_scopeId}></i>`);
            } else {
              return [
                createVNode("i", {
                  class: "fa fa-heart",
      ...
      if (mounted.value) {
        ...
        if (auth.value) {
          ...
          _push(`<div class="imas-nav__sign-in imas-header-action" data-v-0a7a998a><a href="#" class="imas-nav__sign-in-link show-reg-form modal-open" data-open-auth="login" data-v-0a7a998a>${ssrInterpolate(trans("Sign In"))}</a></div>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      ...
      ])}" class="imas-header-scroll-spacer" aria-hidden="true" data-v-0a7a998a></div>`);
...
const UserNavbar = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-0a7a998a"]]);
...
const UserTopBar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-6d1345a8"]]);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (phoneDisplay.value && phoneHref.value) {
        _push(`<span class="in-p-link-wrap" data-v-a559791a><a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-a559791a>${ssrInterpolate(phoneDisplay.value)}</a></span>`);
      ...
      })}" data-v-a559791a><button type="submit"${ssrIncludeBooleanAttr(unref(subscribeForm).processing) ? " disabled" : ""} data-v-a559791a>${ssrInterpolate(trans("navBar.subscribe"))}</button></div>`);
      if (unref(subscribeForm).errors.email) {
        _push(`<p class="subscription-error" role="alert" data-v-a559791a>${ssrInterpolate(unref(subscribeForm).errors.email)}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (showSubscriptionSuccess.value) {
        _push(`<p class="subscription-success" role="status" data-v-a559791a>${ssrInterpolate(trans("navBar.subscription_success"))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</form>`);
      ...
      if (bottomBarPages.value.length) {
        ...
        ssrRenderList(bottomBarPages.value, (p, index) => {
          _push(`<!--[-->`);
          if (index > 0) {
            _push(`<span class="imas-second-footer__separator" aria-hidden="true" data-v-a559791a>|</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(ssrRenderComponent(unref(Link), {
        ...
        _push(`<div class="imas-second-footer__bottom-bar imas-second-footer__bottom-bar--empty" aria-hidden="true" data-v-a559791a></div>`);
      }
...
const UserFooter = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a559791a"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const hasAnyChannel = computed(
      () => Boolean(
        whatsappHref.value || messengerHref.value || gmailHref.value || phoneHref.value
      )
    );
...
const FloatingContactButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-86f80b4b"]]);
