	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-a88dcc10><div id="header" class="${ssrRenderClass([{
				"imas-scroll-pinned": headerPinned.value,
				"imas-scroll-pinned--in": headerPinned.value && headerPinnedVisible.value
			}, "imas-nav imas-nav__bar bottom"])}" data-v-a88dcc10><div class="container imas-nav__container" data-v-a88dcc10><div id="logo" class="imas-nav__logo" data-v-a88dcc10>`);
			_push(ssrRenderComponent(unref(Link), {
				href: homeHref.value,
				class: "imas-nav__logo-link"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-a88dcc10${_scopeId}><span class="imas-brand-text" data-v-a88dcc10${_scopeId}><span class="website-name" data-v-a88dcc10${_scopeId}>${ssrInterpolate(websiteName.value)}</span><span class="website-slogan" data-v-a88dcc10${_scopeId}>${ssrInterpolate(websiteSlogan$1)}</span></span>`);
			...
			_push(`</div><nav id="navigation" class="imas-nav__menu style-1" data-v-a88dcc10><ul id="responsive" data-v-a88dcc10><!--[-->`);
			ssrRenderList(__props.navLinks, (item) => {
				_push(`<li class="${ssrRenderClass([{ "has-submenu": item?.children?.length }, "imas-nav-item"])}" data-v-a88dcc10>`);
				...
				else _push(`<a href="#" class="${ssrRenderClass({ active: isNavLinkActive(item) })}" data-v-a88dcc10>${ssrInterpolate(item.label ?? trans(item.key))}</a>`);
				if (item?.children?.length) {
					_push(`<ul class="imas-nav__submenu" data-v-a88dcc10><!--[-->`);
					ssrRenderList(item.children, (child) => {
						_push(`<li class="imas-nav__submenu-item" data-v-a88dcc10>`);
						_push(ssrRenderComponent(unref(Link), {
							href: child.href,
			...
			_push(`<!--]-->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-a88dcc10><a href="#" class="imas-auth-nav-link" data-open-auth="login" data-v-a88dcc10>${ssrInterpolate(trans("Login"))}</a></li>`);
			else _push(`<!---->`);
			if (!auth.value && mounted.value) _push(`<li class="imas-mmenu-only" data-v-a88dcc10><a href="#" class="imas-auth-nav-link" data-open-auth="register" data-v-a88dcc10>${ssrInterpolate(trans("Register"))}</a></li>`);
			else _push(`<!---->`);
			_push(`</ul></nav><div class="imas-nav__end" data-v-a88dcc10><div class="${ssrRenderClass([{ "imas-nav__actions--rtl": isRtl.value }, "imas-nav__actions right"])}" data-v-a88dcc10><div class="header-user-menu user-menu add imas-nav__lang imas-header-action" data-v-a88dcc10><div class="${ssrRenderClass([{ "lang-wrap--open": langMenuOpen.value }, "lang-wrap"])}" data-v-a88dcc10><button type="button" class="show-lang imas-nav__lang-trigger"${ssrRenderAttr("aria-expanded", langMenuOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", trans("Language"))} data-v-a88dcc10><span class="show-lang-trigger-inner" data-v-a88dcc10>`);
			if (flagCountryClass(currentLocale.value)) _push(`<span class="${ssrRenderClass([flagCountryClass(currentLocale.value), "fi lang-switch-flag lang-switch-flag--trigger"])}" aria-hidden="true" data-v-a88dcc10></span>`);
			else _push(`<!---->`);
			_push(`</span><i class="fa fa-caret-down arrlan" data-v-a88dcc10></i></button><ul class="lang-tooltip lang-action no-list-style" role="listbox" data-v-a88dcc10><!--[-->`);
			ssrRenderList(localeSwitcher.value, (loc) => {
				_push(`<li data-v-a88dcc10><a href="#" class="${ssrRenderClass([{ "current-lan": loc.code === currentLocale.value }, "lang-switch-row"])}" role="option"${ssrRenderAttr("aria-selected", loc.code === currentLocale.value)} data-v-a88dcc10>`);
				if (flagCountryClass(loc.code)) _push(`<span class="${ssrRenderClass([flagCountryClass(loc.code), "fi lang-switch-flag"])}" aria-hidden="true" data-v-a88dcc10></span>`);
				else _push(`<!---->`);
				_push(`<span class="mx-2" data-v-a88dcc10>${ssrInterpolate(loc.native)}</span></a></li>`);
			});
			_push(`<!--]--></ul></div></div><button type="button" class="imas-nav__search imas-header-action"${ssrRenderAttr("aria-label", trans("Search"))}${ssrRenderAttr("title", trans("Search"))} data-v-a88dcc10><i class="fa fa-search" aria-hidden="true" data-v-a88dcc10></i></button>`);
			if (auth.value && mounted.value) _push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<i class="fa fa-heart" aria-hidden="true" data-v-a88dcc10${_scopeId}></i>`);
			...
			if (mounted.value) {
				_push(`<div class="${ssrRenderClass([{ active: userMenuOpen.value }, "header-user-menu user-menu add UserMenu imas-header-action"])}" data-v-a88dcc10>`);
				if (auth.value) {
					_push(`<!--[--><button type="button" class="${ssrRenderClass([{ "imas-nav__account-trigger--rtl": isRtl.value }, "header-user-name imas-nav__account-trigger"])}"${ssrRenderAttr("aria-expanded", userMenuOpen.value)} aria-haspopup="true"${ssrRenderAttr("aria-label", trans("Account menu"))} data-v-a88dcc10><span class="imas-nav__avatar" data-v-a88dcc10><img${ssrRenderAttr("src", auth.value.avatar)} alt="" data-v-a88dcc10></span><span class="imas-nav__account-text imas-nav__desktop-only" data-v-a88dcc10>${ssrInterpolate(accountGreeting.value)}</span><i class="fa fa-caret-down imas-nav__account-caret imas-nav__desktop-only" aria-hidden="true" data-v-a88dcc10></i></button><ul class="imas-user-menu-dropdown text-start" data-v-a88dcc10>`);
					if (isAdmin.value) {
						_push(`<li data-v-a88dcc10>`);
						_push(ssrRenderComponent(unref(Link), {
					...
					_push(`<li data-v-a88dcc10><button type="button" class="imas-user-menu-dropdown__item dropdown-logout" data-v-a88dcc10>${ssrInterpolate(trans("global.LogOut"))}</button></li></ul><!--]-->`);
				} else _push(`<div class="imas-nav__sign-in imas-header-action" data-v-a88dcc10><a href="#" class="imas-nav__sign-in-link show-reg-form modal-open" data-open-auth="login" data-v-a88dcc10>${ssrInterpolate(trans("Sign In"))}</a></div>`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`</div><div class="mmenu-trigger imas-nav__mmenu" data-v-a88dcc10><button class="hamburger hamburger--collapse" type="button"${ssrRenderAttr("aria-label", trans("Menu"))} data-v-a88dcc10><span class="hamburger-box" data-v-a88dcc10><span class="hamburger-inner" data-v-a88dcc10></span></span></button></div></div></div></div><div class="imas-header-scroll-spacer" style="${ssrRenderStyle([{ height: `${scrollPinSpacerPx.value}px` }, headerPinned.value ? null : { display: "none" }])}" aria-hidden="true" data-v-a88dcc10></div>`);
...
var UserNavbar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["__scopeId", "data-v-a88dcc10"]]);
//#endregion
