		...
		return (_ctx, _push, _parent, _attrs) => {
			if (mounted.value) ssrRenderTeleport(_push, (_push) => {
				if (__props.open) {
					...
					if (logoUrl.value) _push(`<div class="app_logo" data-v-a53510cb><img${ssrRenderAttr("src", logoUrl.value)}${ssrRenderAttr("data-sticky-logo", logoUrl.value)} alt="" data-v-a53510cb></div>`);
					else _push(`<!---->`);
					_push(`<h3 class="text-center" data-v-a53510cb>${ssrInterpolate(authNoteText.value)}</h3>`);
					if (authSubview.value === "forgot") {
						_push(`<div class="custom-form" data-v-a53510cb><p class="mb-3 text-start px-0" data-v-a53510cb></p><a href="#" class="imas-auth-modal__back text-start" data-v-a53510cb><i class="fa fa-angle-left fa-lg imas-auth-modal__back-icon" aria-hidden="true" data-v-a53510cb></i><span class="imas-auth-modal__back-label" data-v-a53510cb>${ssrInterpolate(trans("auth_modal.back_to_login"))}</span></a><form class="forgot-password-form" data-v-a53510cb><div data-v-a53510cb><label for="imas-auth-forgot-email" data-v-a53510cb>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-forgot-email"${ssrRenderAttr("value", unref(forgotForm).email)} type="email" autocomplete="email" required data-v-a53510cb>`);
						if (unref(forgotForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(forgotForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(forgotForm).processing) ? " disabled" : ""} data-v-a53510cb><span data-v-a53510cb>${ssrInterpolate(trans("Send Email Verification"))}</span></button></div></form></div>`);
					} else {
						_push(`<div id="tabs-container" data-v-a53510cb><ul class="tabs-menu" data-v-a53510cb><li class="${ssrRenderClass({ current: activeMainTab.value === "login" })}" data-v-a53510cb><a href="#tab-imas-login" data-v-a53510cb>${ssrInterpolate(trans("Login"))}</a></li><li class="${ssrRenderClass({ current: activeMainTab.value === "register" })}" data-v-a53510cb><a href="#tab-imas-register" data-v-a53510cb>${ssrInterpolate(trans("Register"))}</a></li></ul><div class="tab" data-v-a53510cb><div id="tab-imas-login" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "login" }, "tab-contents"])}" data-v-a53510cb><div class="custom-form" data-v-a53510cb><form data-v-a53510cb><label for="imas-auth-login-email" data-v-a53510cb>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-login-email"${ssrRenderAttr("value", unref(loginForm).email)} type="email" autocomplete="username" required data-v-a53510cb>`);
						if (unref(loginForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(loginForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-login-password" data-v-a53510cb>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-a53510cb><input id="imas-auth-login-password"${ssrRenderDynamicModel(passwordVisible.value.login ? "text" : "password", unref(loginForm).password, null)}${ssrRenderAttr("type", passwordVisible.value.login ? "text" : "password")} autocomplete="current-password" required data-v-a53510cb><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("login"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.login)} data-v-a53510cb><i class="${ssrRenderClass(passwordVisible.value.login ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-a53510cb></i></button></div>`);
						if (unref(loginForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(loginForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(loginForm).processing) ? " disabled" : ""} data-v-a53510cb><span data-v-a53510cb>${ssrInterpolate(trans("Sign In"))}</span></button><div class="clearfix" data-v-a53510cb></div><div class="filter-tags" data-v-a53510cb><input id="imas-auth-remember"${ssrIncludeBooleanAttr(Array.isArray(unref(loginForm).remember) ? ssrLooseContain(unref(loginForm).remember, null) : unref(loginForm).remember) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-a53510cb><label for="imas-auth-remember" data-v-a53510cb>${ssrInterpolate(trans("Remember Me"))}</label></div></form><div class="lost_password" data-v-a53510cb><a href="#" data-v-a53510cb>${ssrInterpolate(trans("Forgot Password"))}</a></div></div></div><div class="tab" data-v-a53510cb><div id="tab-imas-register" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "register" }, "tab-contents"])}" data-v-a53510cb><div class="custom-form main-register-form" data-v-a53510cb><form data-v-a53510cb><div class="imas-auth-form-field-row" data-v-a53510cb><div class="imas-auth-form-field" data-v-a53510cb><label for="imas-auth-reg-first-name" data-v-a53510cb>${ssrInterpolate(trans("contact_us.first_name"))} *</label><input id="imas-auth-reg-first-name"${ssrRenderAttr("value", unref(registerForm).first_name)} type="text" autocomplete="given-name" required maxlength="120" data-v-a53510cb>`);
						if (unref(registerForm).errors.first_name) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(registerForm).errors.first_name)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-a53510cb><label for="imas-auth-reg-last-name" data-v-a53510cb>${ssrInterpolate(trans("contact_us.last_name"))} *</label><input id="imas-auth-reg-last-name"${ssrRenderAttr("value", unref(registerForm).last_name)} type="text" autocomplete="family-name" required maxlength="120" data-v-a53510cb>`);
						if (unref(registerForm).errors.last_name) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(registerForm).errors.last_name)}</span>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="imas-auth-form-field" data-v-a53510cb><label for="imas-auth-reg-email" data-v-a53510cb>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reg-email"${ssrRenderAttr("value", unref(registerForm).email)} type="email" autocomplete="email" required data-v-a53510cb>`);
						if (unref(registerForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(registerForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-a53510cb><label for="imas-auth-reg-mobile" data-v-a53510cb>${ssrInterpolate(trans("Mobile"))} *</label><div class="${ssrRenderClass([{ "imas-auth-phone-field--country-open": registerCountryDropdownOpen.value }, "imas-auth-phone-field"])}" dir="ltr" data-v-a53510cb><div class="imas-auth-country-select-shell" data-v-a53510cb><button id="imas-auth-reg-country-code" type="button" class="imas-auth-country-trigger"${ssrRenderAttr("aria-expanded", registerCountryDropdownOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", registerCountrySelectAriaLabel.value)} data-v-a53510cb>`);
						if (selectedRegisterCountry.value?.flag) _push(`<img class="imas-auth-country-flag-img"${ssrRenderAttr("src", selectedRegisterCountry.value.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-a53510cb>`);
						else _push(`<!---->`);
						_push(`<span class="imas-auth-country-code-label" aria-hidden="true" data-v-a53510cb>+${ssrInterpolate(displayCallingCode(selectedRegisterCountry.value?.phone_code))}</span></button><div class="imas-auth-country-dropdown-panel" style="${ssrRenderStyle(registerCountryDropdownOpen.value ? null : { display: "none" })}" data-v-a53510cb><div class="imas-auth-country-dropdown-search-wrap text-start" data-v-a53510cb><input${ssrRenderAttr("value", registerCountrySearchQuery.value)} type="search" enterkeyhint="search" autocomplete="off" autocorrect="off" spellcheck="false" class="imas-auth-country-dropdown-search"${ssrRenderAttr("placeholder", trans("Search"))}${ssrRenderAttr("aria-label", trans("Search"))} data-v-a53510cb></div><ul class="imas-auth-country-dropdown-scroll" role="listbox" tabindex="-1" data-v-a53510cb>`);
						if (countriesWithPhoneFiltered.value.length === 0) _push(`<li class="imas-auth-country-option imas-auth-country-option--empty" aria-live="polite" data-v-a53510cb>${ssrInterpolate(trans("auth_modal.country_code_search_empty"))}</li>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(countriesWithPhoneFiltered.value, (c) => {
							_push(`<li role="option" class="${ssrRenderClass([{ "imas-auth-country-option--selected": c.id === registerCountryId.value }, "imas-auth-country-option"])}"${ssrRenderAttr("aria-selected", c.id === registerCountryId.value)} data-v-a53510cb>`);
							if (c.flag) _push(`<img class="imas-auth-country-flag-img imas-auth-country-flag-img--option"${ssrRenderAttr("src", c.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-a53510cb>`);
							else _push(`<!---->`);
							_push(`<span class="imas-auth-country-option-code" data-v-a53510cb>+${ssrInterpolate(displayCallingCode(c.phone_code))}</span></li>`);
						});
						_push(`<!--]--></ul></div></div><span class="imas-auth-phone-sep" aria-hidden="true" data-v-a53510cb></span><input id="imas-auth-reg-mobile"${ssrRenderAttr("value", registerMobileLocal.value)} type="tel" inputmode="numeric" autocomplete="tel-national" class="imas-auth-phone-input" required${ssrRenderAttr("placeholder", trans("auth_modal.mobile_national_placeholder"))} data-v-a53510cb></div>`);
						if (registerMobileClientError.value) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(registerMobileClientError.value)}</span>`);
						else _push(`<!---->`);
						if (unref(registerForm).errors.mobile) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(registerForm).errors.mobile)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-a53510cb><label for="imas-auth-reg-password" data-v-a53510cb>${ssrInterpolate(trans("Password"))} *</label><div class="imas-auth-password-field" data-v-a53510cb><input id="imas-auth-reg-password"${ssrRenderDynamicModel(passwordVisible.value.register ? "text" : "password", unref(registerForm).password, null)}${ssrRenderAttr("type", passwordVisible.value.register ? "text" : "password")} autocomplete="new-password" required data-v-a53510cb><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("register"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.register)} data-v-a53510cb><i class="${ssrRenderClass(passwordVisible.value.register ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-a53510cb></i></button></div>`);
						if (unref(registerForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(registerForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field" data-v-a53510cb><label for="imas-auth-reg-password-confirmation" data-v-a53510cb>${ssrInterpolate(trans("Confirm Password"))} *</label><div class="imas-auth-password-field" data-v-a53510cb><input id="imas-auth-reg-password-confirmation"${ssrRenderDynamicModel(passwordVisible.value.registerConfirm ? "text" : "password", unref(registerForm).password_confirmation, null)}${ssrRenderAttr("type", passwordVisible.value.registerConfirm ? "text" : "password")} autocomplete="new-password" required data-v-a53510cb><button type="button" class="imas-auth-password-toggle"${ssrRenderAttr("aria-label", passwordToggleAria("registerConfirm"))}${ssrRenderAttr("aria-pressed", passwordVisible.value.registerConfirm)} data-v-a53510cb><i class="${ssrRenderClass(passwordVisible.value.registerConfirm ? "fa fa-eye-slash" : "fa fa-eye")}" aria-hidden="true" data-v-a53510cb></i></button></div>`);
						if (unref(registerForm).errors.password_confirmation) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(registerForm).errors.password_confirmation)}</span>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-terms-wrap" data-v-a53510cb><div class="filter-tags imas-auth-terms" data-v-a53510cb><input id="imas-auth-terms"${ssrIncludeBooleanAttr(Array.isArray(registerTermsAccepted.value) ? ssrLooseContain(registerTermsAccepted.value, null) : registerTermsAccepted.value) ? " checked" : ""} type="checkbox" class="mx-2 remember-me-checkbox" data-v-a53510cb><label for="imas-auth-terms" class="imas-auth-terms__label" data-v-a53510cb>${ssrInterpolate(trans("auth_modal.agree_terms_prefix"))} <a href="#" class="imas-auth-terms__link" data-v-a53510cb>${ssrInterpolate(trans("auth_modal.terms_and_conditions"))}</a></label></div>`);
						if (registerTermsClientError.value) _push(`<p class="imas-auth-terms__error" role="alert" data-v-a53510cb>${ssrInterpolate(registerTermsClientError.value)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="imas-auth-form-field imas-auth-form-field--actions" data-v-a53510cb><button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(registerForm).processing) ? " disabled" : ""} data-v-a53510cb><span data-v-a53510cb>${ssrInterpolate(trans("Register"))}</span></button></div></form></div></div></div><div class="tab" data-v-a53510cb><div id="tab-imas-reset" class="${ssrRenderClass([{ "imas-auth-tab--active": activeMainTab.value === "reset" }, "tab-contents"])}" data-v-a53510cb><div class="custom-form" data-v-a53510cb>`);
						if (!resetToken.value) _push(`<p class="imas-auth-modal__hint" data-v-a53510cb>${ssrInterpolate(trans("auth_modal.reset_hint"))}</p>`);
						else _push(`<!---->`);
						_push(`<form data-v-a53510cb><label for="imas-auth-reset-email" data-v-a53510cb>${ssrInterpolate(trans("Email"))} *</label><input id="imas-auth-reset-email"${ssrRenderAttr("value", unref(resetForm).email)} type="email" autocomplete="email" required data-v-a53510cb>`);
						if (unref(resetForm).errors.email) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(resetForm).errors.email)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-reset-password" data-v-a53510cb>${ssrInterpolate(trans("Password"))} *</label><input id="imas-auth-reset-password"${ssrRenderAttr("value", unref(resetForm).password)} type="password" autocomplete="new-password" required data-v-a53510cb>`);
						if (unref(resetForm).errors.password) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(resetForm).errors.password)}</span>`);
						else _push(`<!---->`);
						_push(`<label for="imas-auth-reset-password-confirmation" data-v-a53510cb>${ssrInterpolate(trans("Confirm Password"))} *</label><input id="imas-auth-reset-password-confirmation"${ssrRenderAttr("value", unref(resetForm).password_confirmation)} type="password" autocomplete="new-password" required data-v-a53510cb>`);
						if (unref(resetForm).errors.password_confirmation) _push(`<span class="imas-auth-field-error" data-v-a53510cb>${ssrInterpolate(unref(resetForm).errors.password_confirmation)}</span>`);
						else _push(`<!---->`);
						_push(`<button type="submit" class="log-submit-btn"${ssrIncludeBooleanAttr(unref(resetForm).processing || !resetToken.value) ? " disabled" : ""} data-v-a53510cb><span data-v-a53510cb>${ssrInterpolate(trans("Reset Password"))}</span></button></form></div></div></div></div></div>`);
					}
					_push(`</div></div></div>`);
				} else _push(`<!---->`);
			}, "body", false, _parent);
...
var AuthModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$8, [["__scopeId", "data-v-a53510cb"]]);
//#endregion
...
var _sfc_main$4 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (phoneDisplay.value && phoneHref.value) _push(`<span class="in-p-link-wrap" data-v-dffb6a2a><a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-dffb6a2a>${ssrInterpolate(phoneDisplay.value)}</a></span>`);
			...
			if (bottomBarPages.value.length) {
				...
				ssrRenderList(bottomBarPages.value, (p, index) => {
					_push(`<!--[-->`);
					if (index > 0) _push(`<span class="imas-second-footer__separator" aria-hidden="true" data-v-dffb6a2a>|</span>`);
					else _push(`<!---->`);
					_push(ssrRenderComponent(unref(Link), {
				...
				_push(`<!--]--></nav>`);
			} else _push(`<div class="imas-second-footer__bottom-bar imas-second-footer__bottom-bar--empty" aria-hidden="true" data-v-dffb6a2a></div>`);
...
var UserFooter_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$4, [["__scopeId", "data-v-dffb6a2a"]]);
//#endregion
