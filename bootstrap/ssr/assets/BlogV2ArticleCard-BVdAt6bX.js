...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))}><a${ssrRenderAttr("href", __props.article.url)} class="imas-blog-v2-card__thumb"><img${ssrRenderAttr("src", __props.article.image)}${ssrRenderAttr("alt", __props.article.title)} loading="lazy"></a>`);
			...
			_push(`<div class="${ssrRenderClass([{ "imas-blog-v2-card__body--has-category": categoryName.value }, "imas-blog-v2-card__body"])}"><a${ssrRenderAttr("href", __props.article.url)}><h3 class="imas-blog-v2-card__title text-md font-semibold text-start">${ssrInterpolate(__props.article.title)}</h3></a><div class="imas-blog-v2-card__meta text-md text-dim">`);
			...
			_push(`<div class="imas-blog-v2-card__cta-wrap"><span class="imas-blog-v2-card__cta-text">${ssrInterpolate(__props.readMoreLabel)}</span><a${ssrRenderAttr("href", __props.article.url)} class="imas-blog-v2-card__pill">${ssrInterpolate(__props.readArticleLabel)}</a></div></div></article>`);
		};
	}
};
