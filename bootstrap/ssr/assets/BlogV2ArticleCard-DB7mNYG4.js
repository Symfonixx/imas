...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))}><a${ssrRenderAttr("href", __props.article.url)} class="imas-blog-v2-card__link"${ssrRenderAttr("aria-label", __props.article.title)}></a><div class="imas-blog-v2-card__thumb"><img${ssrRenderAttr("src", __props.article.image)}${ssrRenderAttr("alt", __props.article.image_alt || __props.article.title)} loading="lazy"></div>`);
