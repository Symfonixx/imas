...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (!__props.hideTitle) _push(`<h3 class="imas-contact-page__heading text-xl font-semibold mb-4 text-start" data-v-8ed81194>${ssrInterpolate(trans("contact_us.title"))}</h3>`);
			else _push(`<!---->`);
			if (successVisible.value) _push(`<div class="alert alert-success imas-contact-page__alert imas-contact-page__alert--success text-start" role="status" data-v-8ed81194>${ssrInterpolate(trans("contact_us.message_sent"))}</div>`);
			else _push(`<!---->`);
			...
			if (unref(form).errors.first_name) _push(`<div class="invalid-feedback d-block" data-v-8ed81194>${ssrInterpolate(unref(form).errors.first_name)}</div>`);
			else _push(`<!---->`);
			...
			if (unref(form).errors.mobile) _push(`<div class="invalid-feedback d-block" data-v-8ed81194>${ssrInterpolate(unref(form).errors.mobile)}</div>`);
			else _push(`<!---->`);
			_push(`</div></div></div>`);
			if (!__props.hideSubject) {
				...
				if (unref(form).errors.subject) _push(`<div class="invalid-feedback d-block" data-v-8ed81194>${ssrInterpolate(unref(form).errors.subject)}</div>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
...
var ContactForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-8ed81194"]]);
//#endregion
