import { computed, mergeProps, useSSRContext, ref, unref, withCtx, openBlock, createBlock, createCommentVNode, createVNode } from "vue";
...
import { f as formatTurkishPhone, n as normalizeTurkishPhoneDigits, r as resolveWhatsAppContactHref, l as localizedRoute, _ as _sfc_main$3 } from "./App-BMYoBaMl.js";
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "call-info imas-contact-page__details" }, _attrs))} data-v-8d1d8307><h3 class="imas-contact-page__heading text-xl font-semibold text-start" data-v-8d1d8307>${ssrInterpolate(trans("contact_us.contact_details"))}</h3><p class="imas-contact-page__intro text-card-excerpt text-dim mb-5 text-start" data-v-8d1d8307>${ssrInterpolate(trans(
        "contact_us.Please_find_below_contact_details_and_contact_us_today"
      ))}</p><div class="imas-contact-page__head-office mb-4 text-start" data-v-8d1d8307><p class="imas-contact-page__head-office-title mb-1" data-v-8d1d8307>`);
      if (headOfficePrefix.value) {
        _push(`<!--[-->${ssrInterpolate(headOfficePrefix.value)}<!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="imas-contact-page__head-office-brand" data-v-8d1d8307>IMAS GLOBAL</span>`);
      if (headOfficeSuffix.value) {
        _push(`<!--[-->${ssrInterpolate(" ")}${ssrInterpolate(headOfficeSuffix.value)}<!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`</p><p class="imas-contact-page__head-office-location mb-0" data-v-8d1d8307>${ssrInterpolate(trans("navBar.footer_location"))}</p></div><ul data-v-8d1d8307>`);
      if (contact.value.address) {
        _push(`<li data-v-8d1d8307><div class="info text-start" data-v-8d1d8307><i class="fa fa-map-marker m-end" aria-hidden="true" data-v-8d1d8307></i><p class="in-p" data-v-8d1d8307>${ssrInterpolate(contact.value.address)}</p></div></li>`);
      } else {
        _push(`<!---->`);
      }
      if (phoneDisplay.value) {
        _push(`<li class="imas-contact-phone" data-v-8d1d8307><div class="info" data-v-8d1d8307><i class="fa fa-phone m-end" aria-hidden="true" data-v-8d1d8307></i><p class="in-p in-p--phone" dir="ltr" data-v-8d1d8307>`);
        if (phoneHref.value) {
          _push(`<a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-8d1d8307>${ssrInterpolate(phoneDisplay.value)}</a>`);
        } else {
      ...
      if (contact.value.email) {
        _push(`<li class="imas-contact-email" data-v-8d1d8307><div class="info" data-v-8d1d8307><i class="fa fa-envelope m-end" aria-hidden="true" data-v-8d1d8307></i><p class="in-p ti" data-v-8d1d8307><a${ssrRenderAttr("href", "mailto:" + contact.value.email)} data-v-8d1d8307>${ssrInterpolate(contact.value.email)}</a></p></div></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</ul>`);
      if (socialLinks.value.length) {
        _push(`<!--[--><h4 class="imas-contact-page__social-title text-lg font-semibold mt-4 mb-3 text-start" data-v-8d1d8307>${ssrInterpolate(trans("contact_us.follow_us"))}</h4><ul class="netsocials d-flex flex-wrap" data-v-8d1d8307><!--[-->`);
        ssrRenderList(socialLinks.value, (item) => {
          _push(`<li data-v-8d1d8307><a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-8d1d8307><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-8d1d8307></i></a></li>`);
        });
        _push(`<!--]--></ul><!--]-->`);
      } else {
        _push(`<!---->`);
...
const ContactDetails = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-8d1d8307"]]);
const _sfc_main$1 = {
  __name: "ContactFaq",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const items = computed(() => {
      ...
      return raw.filter(
        (item) => item && typeof item.question === "string" && item.question.trim() !== "" && typeof item.answer === "string" && item.answer.trim() !== ""
      );
    });
    return (_ctx, _push, _parent, _attrs) => {
      if (items.value.length) {
        ...
        if (subtitle.value) {
          _push(`<p class="imas-contact-faq__subtitle text-card-excerpt text-dim text-start">${ssrInterpolate(subtitle.value)}</p>`);
        } else {
          _push(`<!---->`);
        }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$3, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="inner-pages imas-contact-page"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              "page-title": trans("contact_us.title"),
              items: blogHeadingItems.value,
              "banner-image-url": contactUsBannerUrl.value
            }, null, _parent2, _scopeId));
            _push2(`<section class="contact-us imas-contact-page__section"${_scopeId}><div class="container"${_scopeId}><div class="row g-4"${_scopeId}><div class="col-lg-8 col-md-12"${_scopeId}><div class="imas-contact-page__panel imas-contact-page__panel--form"${_scopeId}>`);
            _push2(ssrRenderComponent(ContactForm, {
              "contact-store-url": __props.contactStoreUrl,
              "source-page": trans("contact_us.title")
            }, null, _parent2, _scopeId));
            _push2(`</div></div><div class="col-lg-4 col-md-12"${_scopeId}><div class="imas-contact-page__panel imas-contact-page__panel--details"${_scopeId}>`);
            _push2(ssrRenderComponent(ContactDetails, null, null, _parent2, _scopeId));
            _push2(`</div></div></div><div class="row g-4 imas-contact-page__faq-row"${_scopeId}><div class="col-12"${_scopeId}>`);
            ...
            return [
              createVNode("div", {
                ...
                createVNode("section", { class: "contact-us imas-contact-page__section" }, [
                  createVNode("div", { class: "container" }, [
                    createVNode("div", { class: "row g-4" }, [
                      createVNode("div", { class: "col-lg-8 col-md-12" }, [
                        createVNode("div", { class: "imas-contact-page__panel imas-contact-page__panel--form" }, [
                          createVNode(ContactForm, {
                            "contact-store-url": __props.contactStoreUrl,
                            "source-page": trans("contact_us.title")
                          }, null, 8, ["contact-store-url", "source-page"])
                        ])
                      ]),
                      createVNode("div", { class: "col-lg-4 col-md-12" }, [
                        createVNode("div", { class: "imas-contact-page__panel imas-contact-page__panel--details" }, [
                          createVNode(ContactDetails)
                        ])
                      ])
                    ]),
                    createVNode("div", { class: "row g-4 imas-contact-page__faq-row" }, [
