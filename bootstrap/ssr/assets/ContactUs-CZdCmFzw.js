...
import { i as normalizeTurkishPhoneDigits, n as resolveWhatsAppContactHref, o as localizedRoute, r as formatTurkishPhone, t as _sfc_main$3 } from "./App-7O-qCwwD.js";
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "call-info imas-contact-page__details" }, _attrs))} data-v-bf561631><h3 class="imas-contact-page__heading text-xl font-semibold text-start" data-v-bf561631>${ssrInterpolate(trans("contact_us.contact_details"))}</h3><p class="imas-contact-page__intro text-card-excerpt text-dim mb-5 text-start" data-v-bf561631>${ssrInterpolate(trans("contact_us.Please_find_below_contact_details_and_contact_us_today"))}</p><div class="imas-contact-page__head-office mb-4 text-start" data-v-bf561631><p class="imas-contact-page__head-office-title mb-1" data-v-bf561631>`);
			if (headOfficePrefix.value) _push(`<!--[-->${ssrInterpolate(headOfficePrefix.value)}<!--]-->`);
			else _push(`<!---->`);
			_push(`<span class="imas-contact-page__head-office-brand" data-v-bf561631>IMAS GLOBAL</span></p></div><ul data-v-bf561631>`);
			if (contact.value.address) _push(`<li data-v-bf561631><div class="info text-start" data-v-bf561631><i class="fa fa-map-marker m-end" aria-hidden="true" data-v-bf561631></i><p class="in-p" data-v-bf561631>${ssrInterpolate(contact.value.address)}</p></div></li>`);
			else _push(`<!---->`);
			if (phoneDisplay.value) {
				_push(`<li class="imas-contact-phone" data-v-bf561631><div class="info" data-v-bf561631><i class="fa fa-phone m-end" aria-hidden="true" data-v-bf561631></i><p class="in-p in-p--phone" dir="ltr" data-v-bf561631>`);
				if (phoneHref.value) _push(`<a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-bf561631>${ssrInterpolate(phoneDisplay.value)}</a>`);
				else _push(`<!--[-->${ssrInterpolate(phoneDisplay.value)}<!--]-->`);
				_push(`</p></div></li>`);
			} else _push(`<!---->`);
			if (contact.value.email) _push(`<li class="imas-contact-email" data-v-bf561631><div class="info" data-v-bf561631><i class="fa fa-envelope m-end" aria-hidden="true" data-v-bf561631></i><p class="in-p ti" data-v-bf561631><a${ssrRenderAttr("href", "mailto:" + contact.value.email)} data-v-bf561631>${ssrInterpolate(contact.value.email)}</a></p></div></li>`);
			else _push(`<!---->`);
			_push(`</ul>`);
			if (socialLinks.value.length) {
				_push(`<!--[--><h4 class="imas-contact-page__social-title text-lg font-semibold mt-4 mb-3 text-start" data-v-bf561631>${ssrInterpolate(trans("contact_us.follow_us"))}</h4><ul class="netsocials d-flex flex-wrap" data-v-bf561631><!--[-->`);
				ssrRenderList(socialLinks.value, (item) => {
					_push(`<li data-v-bf561631><a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-bf561631><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-bf561631></i></a></li>`);
				});
				_push(`<!--]--></ul><!--]-->`);
			} else _push(`<!---->`);
			_push(`</div>`);
...
var ContactDetails_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-bf561631"]]);
//#endregion
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const { title: documentTitle, description: metaDescription, keywords: metaKeywords, ogTitle, ogDescription, ogImage, canonical: canonicalUrl, ogUrl, twitterCard } = useDocumentSeo({
			...
			canonical: () => localizedRoute("support.contact-us", {}, activeLocale.value, "/contact-us")
		});
