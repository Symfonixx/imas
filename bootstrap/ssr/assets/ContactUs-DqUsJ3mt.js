...
import { f as formatTurkishPhone, n as normalizeTurkishPhoneDigits, r as resolveWhatsAppContactHref, l as localizedRoute, _ as _sfc_main$3 } from "./App-DYVlVBS1.js";
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "call-info imas-contact-page__details" }, _attrs))} data-v-17a14408><h3 class="imas-contact-page__heading text-xl font-semibold text-start" data-v-17a14408>${ssrInterpolate(trans("contact_us.contact_details"))}</h3><p class="imas-contact-page__intro text-card-excerpt text-dim mb-5 text-start" data-v-17a14408>${ssrInterpolate(trans(
        "contact_us.Please_find_below_contact_details_and_contact_us_today"
      ))}</p><div class="imas-contact-page__head-office mb-4 text-start" data-v-17a14408><p class="imas-contact-page__head-office-title mb-1" data-v-17a14408>`);
      if (headOfficePrefix.value) {
        _push(`<!--[-->${ssrInterpolate(headOfficePrefix.value)}<!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="imas-contact-page__head-office-brand" data-v-17a14408>IMAS GLOBAL</span></p></div><ul data-v-17a14408>`);
      if (contact.value.address) {
        _push(`<li data-v-17a14408><div class="info text-start" data-v-17a14408><i class="fa fa-map-marker m-end" aria-hidden="true" data-v-17a14408></i><p class="in-p" data-v-17a14408>${ssrInterpolate(contact.value.address)}</p></div></li>`);
      } else {
        _push(`<!---->`);
      }
      if (phoneDisplay.value) {
        _push(`<li class="imas-contact-phone" data-v-17a14408><div class="info" data-v-17a14408><i class="fa fa-phone m-end" aria-hidden="true" data-v-17a14408></i><p class="in-p in-p--phone" dir="ltr" data-v-17a14408>`);
        if (phoneHref.value) {
          _push(`<a${ssrRenderAttr("href", phoneHref.value)} target="_blank" rel="noopener noreferrer" data-v-17a14408>${ssrInterpolate(phoneDisplay.value)}</a>`);
        } else {
      ...
      if (contact.value.email) {
        _push(`<li class="imas-contact-email" data-v-17a14408><div class="info" data-v-17a14408><i class="fa fa-envelope m-end" aria-hidden="true" data-v-17a14408></i><p class="in-p ti" data-v-17a14408><a${ssrRenderAttr("href", "mailto:" + contact.value.email)} data-v-17a14408>${ssrInterpolate(contact.value.email)}</a></p></div></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</ul>`);
      if (socialLinks.value.length) {
        _push(`<!--[--><h4 class="imas-contact-page__social-title text-lg font-semibold mt-4 mb-3 text-start" data-v-17a14408>${ssrInterpolate(trans("contact_us.follow_us"))}</h4><ul class="netsocials d-flex flex-wrap" data-v-17a14408><!--[-->`);
        ssrRenderList(socialLinks.value, (item) => {
          _push(`<li data-v-17a14408><a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", item.label)} data-v-17a14408><i class="${ssrRenderClass(item.icon)}" aria-hidden="true" data-v-17a14408></i></a></li>`);
        });
        _push(`<!--]--></ul><!--]-->`);
      } else {
        _push(`<!---->`);
...
const ContactDetails = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-17a14408"]]);
const _sfc_main$1 = {
  __name: "ContactFaq",
  __ssrInlineRender: true,
  setup(__props) {
