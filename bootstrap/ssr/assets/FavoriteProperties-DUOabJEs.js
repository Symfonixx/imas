...
import { o as localizedRoute, t as _sfc_main$1 } from "./App-nb92tFBB.js";
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: unref(documentTitle) }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(metaDescription)) _push(`<meta head-key="description" name="description"${ssrRenderAttr("content", unref(metaDescription))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(metaKeywords)) _push(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", unref(metaKeywords))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(canonicalUrl)) _push(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", unref(canonicalUrl))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogTitle)) _push(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", unref(ogTitle))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogDescription)) _push(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", unref(ogDescription))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogImage)) _push(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", unref(ogImage))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="og:type" property="og:type" content="website" data-v-a74f0340${_scopeId}>`);
						if (unref(ogUrl)) _push(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", unref(ogUrl))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(robots)) _push(`<meta head-key="robots" name="robots"${ssrRenderAttr("content", unref(robots))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", unref(twitterCard))} data-v-a74f0340${_scopeId}>`);
						if (unref(ogTitle)) _push(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", unref(ogTitle))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogDescription)) _push(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", unref(ogDescription))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
						if (unref(ogImage)) _push(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", unref(ogImage))} data-v-a74f0340${_scopeId}>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="imas-blog-v2 imas-property-listings imas-blog-section-anchor" data-v-a74f0340${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							"page-title": __props.title,
							items: headingItems.value,
							"banner-image-url": listingsBannerUrl.value
						}, null, _parent, _scopeId));
						_push(`<main class="imas-blog-v2__page" data-v-a74f0340${_scopeId}><section class="imas-blog-v2__main" data-v-a74f0340${_scopeId}>`);
						if ((__props.properties.data ?? []).length > 0) _push(`<p class="imas-property-listings__count text-dim" data-v-a74f0340${_scopeId}>${ssrInterpolate(resultsCountLabel.value)}</p>`);
						else _push(`<!---->`);
						if ((__props.properties.data ?? []).length > 0) {
							_push(`<div class="imas-property-listings__grid" data-v-a74f0340${_scopeId}>`);
							_push(ssrRenderComponent(_sfc_main$3, { properties: __props.properties }, null, _parent, _scopeId));
							_push(`</div>`);
						} else _push(`<p class="imas-blog-v2__empty text-dim" data-v-a74f0340${_scopeId}>${ssrInterpolate(trans("properties.favorite_properties_empty"))}</p>`);
						_push(ssrRenderComponent(_sfc_main$4, {
							properties: __props.properties,
							onNavigate: scrollToListingsTop
						}, null, _parent, _scopeId));
						_push(`</section><aside class="imas-blog-v2-sidebar" data-v-a74f0340${_scopeId}><div class="imas-favorites-aside-sticky" data-v-a74f0340${_scopeId}>`);
...
var FavoriteProperties_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-a74f0340"]]);
//#endregion
