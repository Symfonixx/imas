	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (names.value.length > 0) _push(`<div${ssrRenderAttrs(mergeProps({
				...
				"aria-live": "polite"
			}, _attrs))} data-v-2e0bee47><div class="imas-featured-unit-areas__flip" data-v-2e0bee47><span class="imas-featured-unit-areas__value" data-v-2e0bee47>${ssrInterpolate(activeName.value)}</span></div></div>`);
			else _push(`<!---->`);
		};
	}
};
...
var FeaturedPropertyUnitAreasFlip_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-2e0bee47"]]);
//#endregion
