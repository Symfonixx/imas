...
import { a as propertyStartPrice, b as propertyLocationLine } from "../ssr.js";
        ...
        ssrRenderList(__props.featuredProperties, (p) => {
          ...
          ssrRenderVNode(_push, createVNode(resolveDynamicComponent(isSoldOut(p) ? "div" : "a"), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="imas-featured-properties-sidebar__media"${_scopeId}><img${ssrRenderAttr("src", p.thumbnail_url)}${ssrRenderAttr("alt", displayTitle(p))} loading="lazy"${_scopeId}><div class="imas-featured-properties-sidebar__badges"${_scopeId}><span class="imas-featured-properties-sidebar__badge imas-featured-properties-sidebar__badge--price"${_scopeId}>${ssrInterpolate(formatMoney(unref(propertyStartPrice)(p)))}</span>`);
                if (isSoldOut(p)) {
                ...
                _push2(`</div><div class="imas-featured-properties-sidebar__overlay"${_scopeId}><h5 class="imas-featured-properties-sidebar__title"${_scopeId}>${ssrInterpolate(displayTitle(p))}</h5>`);
                if (locationLine(p)) {
