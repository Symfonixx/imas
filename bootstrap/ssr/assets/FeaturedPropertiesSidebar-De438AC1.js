import { a as propertyStartPrice, s as propertyLocationLine } from "../ssr.js";
					...
					ssrRenderVNode(_push, createVNode(resolveDynamicComponent(isSoldOut(p) ? "div" : "a"), {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								...
								_push(`</div><div class="imas-featured-properties-sidebar__overlay"${_scopeId}><h5 class="imas-featured-properties-sidebar__title"${_scopeId}>${ssrInterpolate(displayTitle(p))}</h5>`);
								...
								createVNode("div", { class: "imas-featured-properties-sidebar__badges" }, [createVNode("span", { class: "imas-featured-properties-sidebar__badge imas-featured-properties-sidebar__badge--price" }, toDisplayString(formatMoney(unref(propertyStartPrice)(p))), 1), isSoldOut(p) ? (openBlock(), createBlock("span", {
									key: 0,
