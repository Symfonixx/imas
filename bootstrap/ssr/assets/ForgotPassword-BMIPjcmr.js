...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Head, {
    title: `${$setup.trans("Forgot Password")} | ${$setup.appName}`
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<meta head-key="robots" name="robots" content="noindex, nofollow" data-v-7903c506${_scopeId}>`);
      } else {
        return [
          createVNode("meta", {
            "head-key": "robots",
              ...
              createVNode("div", { class: "col-md-6" }, [
                createVNode("div", { class: "card" }, [
                  createVNode("div", { class: "card-header text-center" }, [
                    createVNode("h3", null, toDisplayString($setup.trans("Forgot Password")), 1)
                  ]),
                  createVNode("div", { class: "card-body" }, [
                    createVNode("form", {
                      ...
                      createVNode("button", {
                        ...
                        type: "submit"
                      }, toDisplayString($setup.trans("Send Email Verification")), 1)
                    ], 40, ["onSubmit"])
                  ])
                ])
              ])
...
const ForgotPassword = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7903c506"]]);
export {
