import { i as refreshScrollTrigger, n as createGsapContext, r as prefersReducedMotion, u as _plugin_vue_export_helper_default } from "../ssr.js";
import { a as cmsPageUrl, s as useGsap, t as _sfc_main$10 } from "./App-BhEC2Bhd.js";
...
import { t as _sfc_main$11 } from "./BlogV2ArticleCard-BVdAt6bX.js";
import { a as destroyHeroRangeSliders, i as LocationAreaPicker_default, o as initHeroRangeSliders, r as LocationCityPicker_default, s as loadJqueryUi, t as useLocationSearchFilters } from "./useLocationSearchFilters-D8RIt2FR.js";
import { a as buildWebsiteSchema, o as collectSocialUrls, r as buildOrganizationSchema } from "./structuredData-BcvdJ8zz.js";
			...
			if (__props.properties.length > 0) {
				...
				if (isMobileCarousel.value && pageCount.value > 1) {
					...
					ssrRenderList(pageCount.value, (i) => {
						_push(`<li class="${ssrRenderClass({ "slick-active": activePage.value === i - 1 })}" role="presentation" data-v-f6ba8ccd><button type="button"${ssrRenderAttr("aria-label", `Slide ${i}`)}${ssrRenderAttr("aria-current", activePage.value === i - 1 ? "page" : void 0)} data-v-f6ba8ccd></button></li>`);
					});
					_push(`<!--]--></ul>`);
				} else _push(`<!---->`);
				_push(`</div>`);
...
var FeaturedPropertiesSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$8, [["__scopeId", "data-v-f6ba8ccd"]]);
//#endregion
...
var _sfc_main$7 = {
	...
	setup(__props) {
		...
		const citizenshipHref = computed(() => {
			try {
				if (typeof route === "function" && route().has?.("turkish-citizenship")) return route("turkish-citizenship");
			} catch {}
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (isVisible.value) {
				...
				}, _attrs))} data-v-31aa5c24><div class="imas-tc-overview__bg" style="${ssrRenderStyle(backgroundStyle.value)}" aria-hidden="true" data-v-31aa5c24></div><div class="imas-tc-overview__overlay" aria-hidden="true" data-v-31aa5c24></div><div class="container imas-tc-overview__inner" data-v-31aa5c24><div class="imas-tc-overview__panel" data-v-31aa5c24>`);
				...
				if (summaryText.value) {
					_push(`<p class="imas-tc-overview__text"${ssrRenderAttr("title", summaryText.value)} data-v-31aa5c24><span class="imas-tc-overview__text-flow" data-v-31aa5c24><!--[-->`);
					ssrRenderList(summaryWords.value, (word, index) => {
						_push(`<span class="imas-tc-overview__word" data-v-31aa5c24>${ssrInterpolate(word)} </span>`);
					});
					_push(`<!--]-->`);
					if (summaryWords.value.length) _push(`<span class="imas-tc-overview__cursor" aria-hidden="true" data-v-31aa5c24>|</span>`);
					else _push(`<!---->`);
					_push(`</span></p>`);
				} else _push(`<!---->`);
				_push(`<a${ssrRenderAttr("href", citizenshipHref.value)} class="imas-tc-overview__cta" data-v-31aa5c24><span data-v-31aa5c24>${ssrInterpolate(discoverLabel.value)}</span></a></div></div></section>`);
			} else _push(`<!---->`);
		};
	}
};
...
var TurkishCitizenshipOverview_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$7, [["__scopeId", "data-v-31aa5c24"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.articles.length) {
				...
				}, _attrs))} data-v-c0270253><div class="container" data-v-c0270253><div class="sec-title" data-v-c0270253><h2 data-v-c0270253>${ssrInterpolate(trans("articles.title"))}</h2><p data-v-c0270253>${ssrInterpolate(trans("articles.description"))}</p></div><div class="news-wrap" data-v-c0270253><div class="imas-articles-rail" data-v-c0270253><div dir="ltr" class="${ssrRenderClass([{ "is-dragging": isDragging.value }, "row imas-articles-viewport"])}" data-v-c0270253><!--[-->`);
				ssrRenderList(__props.articles, (article, index) => {
					_push(`<div class="imas-articles-slide d-flex"${ssrRenderAttr("dir", slideTextDir.value)} data-v-c0270253>`);
				...
				_push(`<!--]--></div>`);
				if (isMobileCarousel.value && pageCount.value > 1) {
					_push(`<ul class="slick-dots imas-articles-dots" role="tablist"${ssrRenderAttr("aria-label", trans("articles.title"))} data-v-c0270253><!--[-->`);
					ssrRenderList(pageCount.value, (i) => {
						_push(`<li class="${ssrRenderClass({ "slick-active": activePage.value === i - 1 })}" role="presentation" data-v-c0270253><button type="button"${ssrRenderAttr("aria-label", `Slide ${i}`)}${ssrRenderAttr("aria-current", activePage.value === i - 1 ? "page" : void 0)} data-v-c0270253></button></li>`);
					});
					_push(`<!--]--></ul>`);
				} else _push(`<!---->`);
				_push(`</div></div>`);
...
var HomeArticlesSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-c0270253"]]);
//#endregion
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "banner-search-wrap imas-hero-property-search" }, _attrs))} data-v-d0a90961><form class="tab-content" method="get"${ssrRenderAttr("action", __props.action)} data-v-d0a90961><input type="hidden" name="purpose"${ssrRenderAttr("value", __props.purpose)} data-v-d0a90961>`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-d0a90961>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-d0a90961>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-d0a90961>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-d0a90961>`);
			else _push(`<!---->`);
			_push(`<div class="tab-pane fade show active" data-v-d0a90961><div class="rld-main-search" data-v-d0a90961><div class="imas-hero-search-row" data-v-d0a90961><div class="imas-hero-search-fields" data-v-d0a90961><div class="rld-single-select imas-hero-city-cell" data-v-d0a90961>`);
			...
			_push(`</div><div class="rld-single-select imas-hero-location-cell" data-v-d0a90961>`);
			...
			_push(`</div><div class="rld-single-select ml-22" data-v-d0a90961><select class="select single-select wide" name="property_type_id" data-v-d0a90961><option value="" data-v-d0a90961${ssrIncludeBooleanAttr(Array.isArray(searchPropertyTypeId.value) ? ssrLooseContain(searchPropertyTypeId.value, "") : ssrLooseEqual(searchPropertyTypeId.value, "")) ? " selected" : ""}>${ssrInterpolate(trans("Property Type"))}</option><!--[-->`);
			ssrRenderList(__props.propertyTypes, (t) => {
				_push(`<option${ssrRenderAttr("value", String(t.id))} data-v-d0a90961${ssrIncludeBooleanAttr(Array.isArray(searchPropertyTypeId.value) ? ssrLooseContain(searchPropertyTypeId.value, String(t.id)) : ssrLooseEqual(searchPropertyTypeId.value, String(t.id))) ? " selected" : ""}>${ssrInterpolate(t.name)}</option>`);
			});
			_push(`<!--]--></select></div>`);
			if (projectUnitTypes.value.length) {
				_push(`<div class="rld-single-select unitTypeSelect" data-v-d0a90961><select class="select single-select wide" data-v-d0a90961><option value="" data-v-d0a90961${ssrIncludeBooleanAttr(Array.isArray(searchUnitTypeId.value) ? ssrLooseContain(searchUnitTypeId.value, "") : ssrLooseEqual(searchUnitTypeId.value, "")) ? " selected" : ""}>${ssrInterpolate(trans("Unit Types"))}</option><!--[-->`);
				ssrRenderList(projectUnitTypes.value, (ut) => {
					_push(`<option${ssrRenderAttr("value", String(ut.id))} data-v-d0a90961${ssrIncludeBooleanAttr(Array.isArray(searchUnitTypeId.value) ? ssrLooseContain(searchUnitTypeId.value, String(ut.id)) : ssrLooseEqual(searchUnitTypeId.value, String(ut.id))) ? " selected" : ""}>${ssrInterpolate(ut.name)}</option>`);
				});
				_push(`<!--]--></select>`);
				if (searchUnitTypeId.value) _push(`<input type="hidden" name="project_unit_type_id[]"${ssrRenderAttr("value", searchUnitTypeId.value)} data-v-d0a90961>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`<div class="imas-hero-advanced-wrap" data-v-d0a90961><div class="dropdown-filter" role="button" tabindex="0"${ssrRenderAttr("aria-expanded", advancedOpen.value)} data-v-d0a90961><span data-v-d0a90961>${ssrInterpolate(trans("Advanced Search"))}</span></div><div class="${ssrRenderClass([{ "filter-block": advancedOpen.value }, "explore__form-checkbox-list full-filter imas-hero-advanced-panel"])}" data-v-d0a90961><div class="row" data-v-d0a90961><div class="col-12 py-1 pr-30 sld" data-v-d0a90961><div class="main-search-field-2" data-v-d0a90961><div class="range-slider" data-v-d0a90961><label data-v-d0a90961>${ssrInterpolate(trans("Area Size"))}</label><div id="imas-hero-area-range"${ssrRenderAttr("data-min", areaBounds.value.min)}${ssrRenderAttr("data-max", areaBounds.value.max)}${ssrRenderAttr("data-unit", areaBounds.value.unit)} data-v-d0a90961></div><div class="clearfix" data-v-d0a90961></div></div><br data-v-d0a90961><div class="range-slider" data-v-d0a90961><label data-v-d0a90961>${ssrInterpolate(trans("Price Range"))}</label><div id="imas-hero-price-range"${ssrRenderAttr("data-min", priceBounds.value.min)}${ssrRenderAttr("data-max", priceBounds.value.max)}${ssrRenderAttr("data-unit", priceBounds.value.currency)} data-v-d0a90961></div><div class="clearfix" data-v-d0a90961></div></div></div></div></div></div></div><div class="imas-hero-search-submit" data-v-d0a90961><button type="submit" class="btn btn-yellow" data-v-d0a90961>${ssrInterpolate(trans("Search Now"))}</button></div></div></div></div></div></form></div>`);
		};
	}
};
...
var HomeHeroPropertySearch_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-d0a90961"]]);
//#endregion
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (slides.value.length > 0) {
				...
				ssrRenderList(slides.value, (slide, index) => {
					_push(`<div class="${ssrRenderClass([{ "imas-hero-slider__slide--active": index === activeSlideIndex.value }, "imas-hero-slider__slide"])}" style="${ssrRenderStyle({ backgroundImage: `url(${slide.image})` })}" data-v-7fe621d3></div>`);
				});
			...
			if (useStaticHeroCopy.value) _push(`<!--[--><h1 class="h1 imas-hero-title imas-hero-title--static" data-v-7fe621d3>${ssrInterpolate(heroTitle.value)}</h1><p class="mt-4 imas-hero-subtitle" data-v-7fe621d3>${ssrInterpolate(heroSubtitle.value)}</p><!--]-->`);
			else {
				...
				ssrRenderVNode(_push, createVNode(resolveDynamicComponent(heroTitleTag.value), mergeProps(heroTitleAttrs.value, { class: "imas-hero-title-link" }), {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							if (titleParts.value.lead) _push(`<span class="imas-hero-title-lead" data-v-7fe621d3${_scopeId}>${ssrInterpolate(titleParts.value.lead)}</span>`);
							else _push(`<!---->`);
							if (titleParts.value.lead) _push(`<span class="imas-hero-title-gap" aria-hidden="true" data-v-7fe621d3${_scopeId}> </span>`);
							else _push(`<!---->`);
							_push(`<span class="imas-hero-title-typed" data-v-7fe621d3${_scopeId}>${ssrInterpolate(displayedTypedText.value)}`);
							if (showTypeCursor.value) _push(`<span class="imas-hero-type-cursor" aria-hidden="true" data-v-7fe621d3${_scopeId}>|</span>`);
							else _push(`<!---->`);
							_push(`</span>`);
						} else return [
			...
			if (activeSlideLink.value) _push(`<a${ssrRenderAttr("href", activeSlideLink.value)} class="imas-hero-action" target="_blank" rel="noopener noreferrer" data-v-7fe621d3>${ssrInterpolate(actionLabel.value)}</a>`);
			else _push(`<!---->`);
			_push(`</div>`);
			if (slides.value.length > 1) {
				_push(`<div class="imas-hero-dots" role="tablist" aria-label="Slides" data-v-7fe621d3><!--[-->`);
				ssrRenderList(slides.value, (slide, index) => {
					_push(`<button type="button" class="${ssrRenderClass([{ "imas-hero-dot--active": index === activeSlideIndex.value }, "imas-hero-dot"])}"${ssrRenderAttr("aria-selected", index === activeSlideIndex.value)} data-v-7fe621d3></button>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
...
var HomeHero_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-7fe621d3"]]);
//#endregion
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const documentTitle = computed(() => {
			const fromSeo = pickSeoString("site_meta_title", "main_title", "website_name");
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (organizationJsonLd.value) _push(`<script head-key="jsonld-organization" type="application/ld+json"${_scopeId}>${ssrInterpolate(organizationJsonLd.value)}<\/script>`);
						else _push(`<!---->`);
						if (websiteJsonLd.value) _push(`<script head-key="jsonld-website" type="application/ld+json"${_scopeId}>${ssrInterpolate(websiteJsonLd.value)}<\/script>`);
						else _push(`<!---->`);
					} else return [
						...
						organizationJsonLd.value ? (openBlock(), createBlock("script", {
							key: 10,
							"head-key": "jsonld-organization",
							type: "application/ld+json",
							textContent: toDisplayString(organizationJsonLd.value)
						}, null, 8, ["textContent"])) : createCommentVNode("", true),
						websiteJsonLd.value ? (openBlock(), createBlock("script", {
							key: 11,
							"head-key": "jsonld-website",
							type: "application/ld+json",
							textContent: toDisplayString(websiteJsonLd.value)
						}, null, 8, ["textContent"])) : createCommentVNode("", true)
					];
				}),
				_: 1
