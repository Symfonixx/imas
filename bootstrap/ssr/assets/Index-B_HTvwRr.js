...
import { l as localizedRoute, u as useGsap, c as cmsPageUrl, _ as _sfc_main$c } from "./App-BMYoBaMl.js";
...
import { _ as _sfc_main$a } from "./BlogV2ArticleCard-B73CpwM6.js";
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "banner-search-wrap imas-hero-property-search" }, _attrs))} data-v-db08448d><form class="tab-content" method="get"${ssrRenderAttr("action", __props.action)} data-v-db08448d><input type="hidden" name="purpose"${ssrRenderAttr("value", __props.purpose)} data-v-db08448d>`);
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-db08448d>`);
      } else {
        _push(`<!---->`);
      }
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-db08448d>`);
      } else {
        _push(`<!---->`);
      }
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-db08448d>`);
      } else {
        _push(`<!---->`);
      }
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-db08448d>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="tab-pane fade show active" data-v-db08448d><div class="rld-main-search" data-v-db08448d><div class="imas-hero-search-row" data-v-db08448d><div class="imas-hero-search-fields" data-v-db08448d><div class="rld-single-select imas-hero-city-cell" data-v-db08448d>`);
      ...
      _push(`</div><div class="rld-single-select imas-hero-location-cell" data-v-db08448d>`);
      ...
      _push(`</div><div class="rld-single-select ml-22" data-v-db08448d><select class="select single-select wide" name="property_type_id" data-v-db08448d><option value="" data-v-db08448d${ssrIncludeBooleanAttr(Array.isArray(searchPropertyTypeId.value) ? ssrLooseContain(searchPropertyTypeId.value, "") : ssrLooseEqual(searchPropertyTypeId.value, "")) ? " selected" : ""}>${ssrInterpolate(trans("Property Type"))}</option><!--[-->`);
      ssrRenderList(__props.propertyTypes, (t) => {
        _push(`<option${ssrRenderAttr("value", String(t.id))} data-v-db08448d${ssrIncludeBooleanAttr(Array.isArray(searchPropertyTypeId.value) ? ssrLooseContain(searchPropertyTypeId.value, String(t.id)) : ssrLooseEqual(searchPropertyTypeId.value, String(t.id))) ? " selected" : ""}>${ssrInterpolate(t.name)}</option>`);
      });
      _push(`<!--]--></select></div>`);
      if (projectUnitTypes.value.length) {
        _push(`<div class="rld-single-select unitTypeSelect" data-v-db08448d><select class="select single-select wide" data-v-db08448d><option value="" data-v-db08448d${ssrIncludeBooleanAttr(Array.isArray(searchUnitTypeId.value) ? ssrLooseContain(searchUnitTypeId.value, "") : ssrLooseEqual(searchUnitTypeId.value, "")) ? " selected" : ""}>${ssrInterpolate(trans("Unit Types"))}</option><!--[-->`);
        ssrRenderList(projectUnitTypes.value, (ut) => {
          _push(`<option${ssrRenderAttr("value", String(ut.id))} data-v-db08448d${ssrIncludeBooleanAttr(Array.isArray(searchUnitTypeId.value) ? ssrLooseContain(searchUnitTypeId.value, String(ut.id)) : ssrLooseEqual(searchUnitTypeId.value, String(ut.id))) ? " selected" : ""}>${ssrInterpolate(ut.name)}</option>`);
        });
        _push(`<!--]--></select>`);
        if (searchUnitTypeId.value) {
          _push(`<input type="hidden" name="project_unit_type_id[]"${ssrRenderAttr("value", searchUnitTypeId.value)} data-v-db08448d>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="imas-hero-advanced-wrap" data-v-db08448d><div class="dropdown-filter" role="button" tabindex="0"${ssrRenderAttr("aria-expanded", advancedOpen.value)} data-v-db08448d><span data-v-db08448d>${ssrInterpolate(trans("Advanced Search"))}</span></div><div class="${ssrRenderClass([{ "filter-block": advancedOpen.value }, "explore__form-checkbox-list full-filter imas-hero-advanced-panel"])}" data-v-db08448d><div class="row" data-v-db08448d><div class="col-12 py-1 pr-30 sld" data-v-db08448d><div class="main-search-field-2" data-v-db08448d><div class="range-slider" data-v-db08448d><label data-v-db08448d>${ssrInterpolate(trans("Area Size"))}</label><div id="imas-hero-area-range"${ssrRenderAttr("data-min", areaBounds.value.min)}${ssrRenderAttr("data-max", areaBounds.value.max)}${ssrRenderAttr("data-unit", areaBounds.value.unit)} data-v-db08448d></div><div class="clearfix" data-v-db08448d></div></div><br data-v-db08448d><div class="range-slider" data-v-db08448d><label data-v-db08448d>${ssrInterpolate(trans("Price Range"))}</label><div id="imas-hero-price-range"${ssrRenderAttr("data-min", priceBounds.value.min)}${ssrRenderAttr("data-max", priceBounds.value.max)}${ssrRenderAttr(
        "data-unit",
        priceBounds.value.currency
      )} data-v-db08448d></div><div class="clearfix" data-v-db08448d></div></div></div></div></div></div></div><div class="imas-hero-search-submit" data-v-db08448d><button type="submit" class="btn btn-yellow" data-v-db08448d>${ssrInterpolate(trans("Search Now"))}</button></div></div></div></div></div></form></div>`);
    };
  }
};
...
const HomeHeroPropertySearch = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-db08448d"]]);
