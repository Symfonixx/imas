...
import { _ as _sfc_main$4 } from "./BlogV2ArticleCard-DD8iKI1k.js";
import { b as blogIndexLocalizedUrl, _ as _sfc_main$5 } from "./blogLocalizedRoute-D9Gu4BjL.js";
import "gsap";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.blogs.data.length > 0) {
              ...
              _push2(`<p class="imas-blog-v2__empty text-dim text-start"${_scopeId}>${ssrInterpolate(trans("blogs.no_posts"))}</p>`);
            }
