...
import { a as cmsPageUrl, o as localizedRoute, s as useGsap, t as _sfc_main$10 } from "./App-Tm_yWILr.js";
import { t as useScrollReveal } from "./useScrollReveal-DCquZn8b.js";
import { t as TurkishCitizenshipSplitTitle_default } from "./TurkishCitizenshipSplitTitle-CD6t7CeO.js";
import { t as PopularPropertiesSection_default } from "./PopularPropertiesSection-DCmqbEf2.js";
import { t as _sfc_main$11 } from "./BlogV2ArticleCard-CCYIn8IT.js";
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-db08448d>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-db08448d>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-db08448d>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-db08448d>`);
			else _push(`<!---->`);
...
var HomeHeroPropertySearch_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-db08448d"]]);
//#endregion
