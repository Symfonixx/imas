import { d as _plugin_vue_export_helper_default, i as refreshScrollTrigger, n as createGsapContext, r as prefersReducedMotion } from "../ssr.js";
import { a as cmsPageUrl, o as localizedRoute, s as useGsap, t as _sfc_main$10 } from "./App-BI701647.js";
...
import { t as TurkishCitizenshipSplitTitle_default } from "./TurkishCitizenshipSplitTitle-B45Ftp3w.js";
...
import { a as destroyHeroRangeSliders, i as LocationAreaPicker_default, o as initHeroRangeSliders, r as LocationCityPicker_default, s as loadJqueryUi, t as useLocationSearchFilters } from "./useLocationSearchFilters-CJ_W4_3I.js";
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-c53ff68e>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-c53ff68e>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-c53ff68e>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-c53ff68e>`);
			else _push(`<!---->`);
...
var HomeHeroPropertySearch_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-c53ff68e"]]);
//#endregion
