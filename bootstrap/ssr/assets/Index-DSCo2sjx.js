...
import { a as cmsPageUrl, o as localizedRoute, s as useGsap, t as _sfc_main$10 } from "./App-6l5p54Dj.js";
...
import { t as TurkishCitizenshipSplitTitle_default } from "./TurkishCitizenshipSplitTitle-BUyN1Mfc.js";
...
import { a as destroyHeroRangeSliders, c as setHeroRangeSliderValues, i as LocationAreaPicker_default, r as LocationCityPicker_default, t as useLocationSearchFilters } from "./useLocationSearchFilters-DvtfTN11.js";
	...
	setup(__props) {
		...
		*/
		...
		function syncActiveFromScroll() {
			...
			const maxStart = Math.max(0, slides.length - 1);
			const pos = isRtl.value ? maxScrollLeft(vp) - vp.scrollLeft : vp.scrollLeft;
			let best = 0;
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.properties.length > 0) {
				...
				}, _attrs))} data-v-25071020><div class="container" data-v-25071020><div class="sec-title" data-v-25071020><h2 data-v-25071020>${ssrInterpolate(__props.title)}</h2><p data-v-25071020>${ssrInterpolate(__props.subtitle)}</p></div><div class="imas-featured-rail" data-v-25071020><div dir="ltr" class="${ssrRenderClass([{
					"is-dragging": isDragging.value,
					"imas-featured-viewport--rtl": isRtl.value
				}, "row portfolio-items imas-featured-viewport"])}" data-v-25071020><!--[-->`);
				ssrRenderList(__props.properties, (property) => {
					_push(`<div class="imas-featured-slide"${ssrRenderAttr("dir", slideTextDir.value)} data-v-25071020>`);
				...
				if (isMobileCarousel.value && pageCount.value > 1) {
					_push(`<ul class="slick-dots imas-featured-dots" role="group"${ssrRenderAttr("aria-label", __props.title)} data-v-25071020><!--[-->`);
					ssrRenderList(pageCount.value, (i) => {
						_push(`<li class="${ssrRenderClass({ "slick-active": activePage.value === i - 1 })}" data-v-25071020><button type="button"${ssrRenderAttr("aria-label", `Slide ${i}`)}${ssrRenderAttr("aria-pressed", activePage.value === i - 1)} data-v-25071020></button></li>`);
					});
					_push(`<!--]--></ul>`);
				} else _push(`<!---->`);
				_push(`</div>`);
...
var FeaturedPropertiesSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$8, [["__scopeId", "data-v-25071020"]]);
//#endregion
...
var _sfc_main$4 = {
	...
	setup(__props) {
		...
		async function ensureOwlCarousel() {
			...
			const { loadOwlCarousel } = await import("./loadThemeAsset-ClrtYxqQ.js");
		...
		async function initOwl() {
			...
			$el.owlCarousel({
				...
				smartSpeed: 1e3,
				slideSpeed: 1e3,
				navText: [`<i class='fa fa-chevron-left' aria-hidden='true'></i><span class='visually-hidden'>${prevLabel}</span>`, `<i class='fa fa-chevron-right' aria-hidden='true'></i><span class='visually-hidden'>${nextLabel}</span>`],
				dots: false,
				responsive: {
					0: { items: 1 },
					991: { items: 3 }
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.testimonials.length) {
				...
				}, _attrs))} data-v-e4f8cd7c><div class="container-fluid" data-v-e4f8cd7c><div class="sec-title" data-v-e4f8cd7c><h2 data-v-e4f8cd7c><span data-v-e4f8cd7c>${ssrInterpolate(trans("testimonials.title"))}</span></h2><p data-v-e4f8cd7c>${ssrInterpolate(trans("testimonials.description"))}</p></div><div class="owl-carousel job_clientSlide" data-v-e4f8cd7c><!--[-->`);
				ssrRenderList(__props.testimonials, (item) => {
					_push(`<div class="singleJobClinet bg-gray" data-v-e4f8cd7c><p class="quote" data-v-e4f8cd7c>${item.quote ?? ""}</p><div class="detailJC" data-v-e4f8cd7c><span data-v-e4f8cd7c><img${ssrRenderAttr("src", item.avatar)}${ssrRenderAttr("alt", item.name)} width="72" height="72" loading="lazy" decoding="async" data-v-e4f8cd7c></span><h5 data-v-e4f8cd7c>`);
					if (item.link) _push(`<a${ssrRenderAttr("href", item.link)} rel="noopener noreferrer" target="_blank" data-v-e4f8cd7c>${ssrInterpolate(item.name)}</a>`);
					else _push(`<!--[-->${ssrInterpolate(item.name)}<!--]-->`);
					_push(`</h5><p data-v-e4f8cd7c>${ssrInterpolate(subtitleLine(item))}</p></div></div>`);
				});
				_push(`<!--]--></div></div></section>`);
			} else _push(`<!---->`);
		};
...
var HomeTestimonials_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$4, [["__scopeId", "data-v-e4f8cd7c"]]);
//#endregion
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.articles.length) {
				...
				}, _attrs))} data-v-69a42cf5><div class="container" data-v-69a42cf5><div class="sec-title" data-v-69a42cf5><h2 data-v-69a42cf5>${ssrInterpolate(trans("articles.title"))}</h2><p data-v-69a42cf5>${ssrInterpolate(trans("articles.description"))}</p></div><div class="news-wrap" data-v-69a42cf5><div class="imas-articles-rail" data-v-69a42cf5><div dir="ltr" class="${ssrRenderClass([{
					"is-dragging": isDragging.value,
					"imas-articles-viewport--rtl": isRtl.value
				}, "row imas-articles-viewport"])}" data-v-69a42cf5><!--[-->`);
				ssrRenderList(__props.articles, (article, index) => {
					_push(`<div class="imas-articles-slide d-flex"${ssrRenderAttr("dir", slideTextDir.value)} data-v-69a42cf5>`);
				...
				_push(`<!--]--></div>`);
				if (isMobileCarousel.value && pageCount.value > 1) {
					_push(`<ul class="slick-dots imas-articles-dots" role="group"${ssrRenderAttr("aria-label", trans("articles.title"))} data-v-69a42cf5><!--[-->`);
					ssrRenderList(pageCount.value, (i) => {
						_push(`<li class="${ssrRenderClass({ "slick-active": activePage.value === i - 1 })}" data-v-69a42cf5><button type="button"${ssrRenderAttr("aria-label", `Slide ${i}`)}${ssrRenderAttr("aria-pressed", activePage.value === i - 1)} data-v-69a42cf5></button></li>`);
					});
					_push(`<!--]--></ul>`);
				} else _push(`<!---->`);
				_push(`</div></div>`);
...
var HomeArticlesSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-69a42cf5"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: unref(documentTitle) }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<meta head-key="description" name="description"${ssrRenderAttr("content", unref(metaDescription))}${_scopeId}>`);
