import { mergeProps, unref, withCtx, createVNode, useSSRContext, computed, ref, onMounted, openBlock, createBlock, createCommentVNode, Fragment, renderList, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderAttr, ssrInterpolate } from "vue/server-renderer";
import { Link, usePage, Head } from "@inertiajs/vue3";
import { l as localizedRoute, _ as _sfc_main$2 } from "./App-BMYoBaMl.js";
import { _ as _sfc_main$3 } from "./InnerPageHeadingHero-CEyYr1UI.js";
import { _ as _sfc_main$4 } from "./BlogV2ArticleCard-B73CpwM6.js";
import { b as blogIndexLocalizedUrl, _ as _sfc_main$5 } from "./blogLocalizedRoute-BT6TpxW-.js";
import "gsap";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const paginationLinks = computed(() => {
      var _a;
      const raw = ((_a = props.blogs) == null ? void 0 : _a.links) ?? [];
      const n = raw.length;
      if (n < 2) {
      ...
      _push(ssrRenderComponent(_sfc_main$2, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<main class="imas-blog-v2__page container"${_scopeId}><section class="imas-blog-v2__main"${_scopeId}>`);
            if (__props.blogs.data.length > 0) {
              _push2(`<div class="imas-blog-v2__grid"${_scopeId}><!--[-->`);
              ...
              _push2(`<p class="imas-blog-v2__empty text-dim"${_scopeId}>${ssrInterpolate(trans("blogs.no_posts"))}</p>`);
            }
              ...
              createVNode("div", {
                ...
                createVNode("main", { class: "imas-blog-v2__page container" }, [
                  createVNode("section", { class: "imas-blog-v2__main" }, [
                    __props.blogs.data.length > 0 ? (openBlock(), createBlock("div", {
                      key: 0,
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(__props.blogs.data, (post, idx) => {
                        return openBlock(), createBlock(_sfc_main$4, {
                          ...
                          "read-more-label": trans("articles.read_more"),
                          "read-article-label": readArticleCta.value
                        }, null, 8, ["article", "stagger-index", "read-more-label", "read-article-label"]);
                      }), 128))
                    ])) : (openBlock(), createBlock("p", {
                      key: 1,
                      class: "imas-blog-v2__empty text-dim"
                    }, toDisplayString(trans("blogs.no_posts")), 1)),
