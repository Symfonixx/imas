import { o as localizedRoute, t as _sfc_main$2 } from "./App-6l5p54Dj.js";
...
import { n as _sfc_main$5, t as blogIndexLocalizedUrl } from "./blogLocalizedRoute-oIqo1o-n.js";
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const { media, title: documentTitle, description: metaDescription, keywords: metaKeywords, ogTitle, ogDescription, ogImage, canonical: canonicalUrl, ogUrl, twitterCard, robots } = useDocumentSeo({
			pageTitle: () => props.title,
			robots: () => {
				const f = props.filters ?? {};
				const hasQuery = typeof f.q === "string" && f.q.trim() !== "";
				const hasCategory = typeof f.category === "string" && f.category.trim() !== "";
			...
			_push(ssrRenderComponent(_sfc_main$2, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="imas-blog-v2__page container"${_scopeId}><section class="imas-blog-v2__main"${_scopeId}>`);
						...
						"items",
						"banner-image-url"
					]), createVNode("div", { class: "imas-blog-v2__page container" }, [createVNode("section", { class: "imas-blog-v2__main" }, [__props.blogs.data.length > 0 ? (openBlock(), createBlock("div", {
						key: 0,
