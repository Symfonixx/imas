...
import { a as cmsPageUrl, o as localizedRoute, s as useGsap, t as _sfc_main$10 } from "./App-D9ZDchZP.js";
...
import { t as TurkishCitizenshipSplitTitle_default } from "./TurkishCitizenshipSplitTitle-CdoWwPcQ.js";
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-b7e3d4d7>`);
			if (slides.value.length > 0) {
				_push(`<div class="imas-hero-slider__layers" aria-hidden="true" data-v-b7e3d4d7><!--[-->`);
				ssrRenderList(slides.value, (slide, index) => {
					_push(`<div class="${ssrRenderClass([{ "imas-hero-slider__slide--active": index === activeSlideIndex.value }, "imas-hero-slider__slide"])}" style="${ssrRenderStyle({ backgroundImage: `url(${slide.image})` })}" data-v-b7e3d4d7></div>`);
				});
				_push(`<!--]--><div class="imas-hero-slider__scrim" data-v-b7e3d4d7></div></div>`);
			} else _push(`<!---->`);
			_push(`<div class="hero-main" data-v-b7e3d4d7><div class="container" data-v-b7e3d4d7><div class="row" data-v-b7e3d4d7><div class="col-12" data-v-b7e3d4d7><div class="hero-inner" data-v-b7e3d4d7><div class="imas-hero-copy" data-v-b7e3d4d7><div class="welcome-text" data-v-b7e3d4d7>`);
			if (useStaticHeroCopy.value) _push(`<!--[--><h1 class="h1 imas-hero-title imas-hero-title--static" data-v-b7e3d4d7>${ssrInterpolate(heroTitle.value)}</h1><p class="mt-4 imas-hero-subtitle" data-v-b7e3d4d7>${ssrInterpolate(heroSubtitle.value)}</p><!--]-->`);
			else {
				_push(`<!--[--><h1 class="h1 imas-hero-title"${ssrRenderAttr("aria-label", heroTitle.value)} data-v-b7e3d4d7>`);
				ssrRenderVNode(_push, createVNode(resolveDynamicComponent(heroTitleTag.value), mergeProps(heroTitleAttrs.value, { class: "imas-hero-title-link" }), {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							if (titleParts.value.lead) _push(`<span class="imas-hero-title-lead" data-v-b7e3d4d7${_scopeId}>${ssrInterpolate(titleParts.value.lead)}</span>`);
							else _push(`<!---->`);
							if (titleParts.value.lead) _push(`<span class="imas-hero-title-gap" aria-hidden="true" data-v-b7e3d4d7${_scopeId}> </span>`);
							else _push(`<!---->`);
							_push(`<span class="imas-hero-title-typed" data-v-b7e3d4d7${_scopeId}>${ssrInterpolate(displayedTypedText.value)}`);
							if (showTypeCursor.value) _push(`<span class="imas-hero-type-cursor" aria-hidden="true" data-v-b7e3d4d7${_scopeId}>|</span>`);
							else _push(`<!---->`);
							_push(`</span>`);
						} else return [
				...
				_push(`</h1><p class="mt-4 imas-hero-subtitle" data-v-b7e3d4d7>${ssrInterpolate(heroSubtitle.value)}</p><!--]-->`);
			}
			if (activeSlideLink.value) _push(`<a${ssrRenderAttr("href", activeSlideLink.value)} class="imas-hero-action" target="_blank" rel="noopener noreferrer" data-v-b7e3d4d7>${ssrInterpolate(actionLabel.value)}</a>`);
			else _push(`<!---->`);
			_push(`</div>`);
			if (slides.value.length > 1) {
				_push(`<div class="imas-hero-dots" role="tablist" aria-label="Slides" data-v-b7e3d4d7><!--[-->`);
				ssrRenderList(slides.value, (slide, index) => {
					_push(`<button type="button" class="${ssrRenderClass([{ "imas-hero-dot--active": index === activeSlideIndex.value }, "imas-hero-dot"])}"${ssrRenderAttr("aria-selected", index === activeSlideIndex.value)} data-v-b7e3d4d7></button>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div></div></div></div></div><div class="imas-hero-filter-shell" data-v-b7e3d4d7><div class="imas-hero-filter" data-v-b7e3d4d7>`);
...
var HomeHero_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-b7e3d4d7"]]);
//#endregion
