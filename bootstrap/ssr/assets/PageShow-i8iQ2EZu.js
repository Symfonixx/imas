import { computed, unref, withCtx, openBlock, createBlock, createCommentVNode, createVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr } from "vue/server-renderer";
import { usePage, Head } from "@inertiajs/vue3";
import { l as localizedRoute, _ as _sfc_main$1 } from "./App-BMYoBaMl.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function trans(key) {
      var _a;
      return ((_a = inertiaPage.props.translations) == null ? void 0 : _a[key]) || key;
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="imas-blog-v2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              "page-title": __props.page.title,
              items: headingItems.value,
              "banner-image-url": heroBannerUrl.value
            }, null, _parent2, _scopeId));
            _push2(`<main class="imas-cms-page-show__page container"${_scopeId}><article class="imas-blog-show imas-cms-page-show"${_scopeId}><div class="imas-blog-show__content"${_scopeId}><div class="imas-blog-show-body imas-cms-page-show__body text-base text-start"${_scopeId}>${__props.page.content ?? ""}</div></div></article></main></div>`);
          } else {
            return [
              createVNode("div", { class: "imas-blog-v2" }, [
                createVNode(_sfc_main$2, {
                  "page-title": __props.page.title,
                  items: headingItems.value,
                  "banner-image-url": heroBannerUrl.value
                }, null, 8, ["page-title", "items", "banner-image-url"]),
                createVNode("main", { class: "imas-cms-page-show__page container" }, [
                  createVNode("article", { class: "imas-blog-show imas-cms-page-show" }, [
