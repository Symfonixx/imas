...
import { o as localizedRoute, t as _sfc_main$3 } from "./App-7O-qCwwD.js";
import { t as useScrollReveal } from "./useScrollReveal-D1MywBbX.js";
import { t as useDocumentSeo } from "./useDocumentSeo-IoWJXXs8.js";
import { t as _sfc_main$4 } from "./InnerPageHeadingHero-Cb2JTq3_.js";
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<aside${ssrRenderAttrs(mergeProps({ class: "imas-blog-v2-sidebar" }, _attrs))} data-v-cdbad6db><div class="imas-blog-v2-sidebar__box imas-property-listings-filter" data-v-cdbad6db><h4 class="imas-blog-v2-sidebar__heading text-start" data-v-cdbad6db>${ssrInterpolate(trans("listing_page.find_your_house"))}</h4><div class="banner-search-wrap imas-listing-property-search" data-v-cdbad6db><form class="tab-content" method="get"${ssrRenderAttr("action", __props.searchAction)} data-v-cdbad6db><input type="hidden" name="sort"${ssrRenderAttr("value", __props.sort)} data-v-cdbad6db>`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-cdbad6db>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-cdbad6db>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-cdbad6db>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-cdbad6db>`);
			else _push(`<!---->`);
			_push(`<div class="tab-pane fade show active" data-v-cdbad6db><div class="rld-main-search" data-v-cdbad6db><div class="row imas-listing-property-search__fields" data-v-cdbad6db><div class="rld-single-select imas-listing-city-cell" data-v-cdbad6db>`);
			...
			_push(`</div><div class="rld-single-select imas-listing-location-cell" data-v-cdbad6db>`);
			...
			_push(`</div><div class="rld-single-select" data-v-cdbad6db><select class="select single-select wide" name="property_type_id" data-v-cdbad6db><option value="" data-v-cdbad6db${ssrIncludeBooleanAttr(Array.isArray(searchPropertyTypeId.value) ? ssrLooseContain(searchPropertyTypeId.value, "") : ssrLooseEqual(searchPropertyTypeId.value, "")) ? " selected" : ""}>${ssrInterpolate(trans("Property Type"))}</option><!--[-->`);
			ssrRenderList(__props.propertyTypes, (t) => {
				_push(`<option${ssrRenderAttr("value", String(t.id))} data-v-cdbad6db${ssrIncludeBooleanAttr(Array.isArray(searchPropertyTypeId.value) ? ssrLooseContain(searchPropertyTypeId.value, String(t.id)) : ssrLooseEqual(searchPropertyTypeId.value, String(t.id))) ? " selected" : ""}>${ssrInterpolate(t.name)}</option>`);
			});
			_push(`<!--]--></select></div>`);
			if (projectUnitTypes.value.length) {
				_push(`<div class="rld-single-select unitTypeSelect" data-v-cdbad6db><select class="select single-select wide" data-v-cdbad6db><option value="" data-v-cdbad6db${ssrIncludeBooleanAttr(Array.isArray(searchUnitTypeId.value) ? ssrLooseContain(searchUnitTypeId.value, "") : ssrLooseEqual(searchUnitTypeId.value, "")) ? " selected" : ""}>${ssrInterpolate(trans("Unit Types"))}</option><!--[-->`);
				ssrRenderList(projectUnitTypes.value, (ut) => {
					_push(`<option${ssrRenderAttr("value", String(ut.id))} data-v-cdbad6db${ssrIncludeBooleanAttr(Array.isArray(searchUnitTypeId.value) ? ssrLooseContain(searchUnitTypeId.value, String(ut.id)) : ssrLooseEqual(searchUnitTypeId.value, String(ut.id))) ? " selected" : ""}>${ssrInterpolate(ut.name)}</option>`);
				});
				_push(`<!--]--></select>`);
				if (searchUnitTypeId.value) _push(`<input type="hidden" name="project_unit_type_id[]"${ssrRenderAttr("value", searchUnitTypeId.value)} data-v-cdbad6db>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`<div class="imas-listing-range-panel" data-v-cdbad6db><div class="main-search-field-2" data-v-cdbad6db><div class="range-slider" data-v-cdbad6db><label data-v-cdbad6db>${ssrInterpolate(trans("Area Size"))}</label><div id="imas-listing-area-range"${ssrRenderAttr("data-min", areaBounds.value.min)}${ssrRenderAttr("data-max", areaBounds.value.max)}${ssrRenderAttr("data-unit", areaBounds.value.unit)} data-v-cdbad6db></div><div class="clearfix" data-v-cdbad6db></div></div><br data-v-cdbad6db><div class="range-slider" data-v-cdbad6db><label data-v-cdbad6db>${ssrInterpolate(trans("Price Range"))}</label><div id="imas-listing-price-range"${ssrRenderAttr("data-min", priceBounds.value.min)}${ssrRenderAttr("data-max", priceBounds.value.max)}${ssrRenderAttr("data-unit", priceBounds.value.currency)} data-v-cdbad6db></div><div class="clearfix" data-v-cdbad6db></div></div></div></div><div class="imas-listing-property-search__submit" data-v-cdbad6db><button type="submit" class="btn btn-yellow btn-block" data-v-cdbad6db>${ssrInterpolate(trans("Search Now"))}</button></div></div></div></div></form></div></div>`);
			if (__props.recentProperties.length > 0) {
				_push(`<div class="imas-blog-v2-sidebar__box" data-v-cdbad6db><h4 class="imas-blog-v2-sidebar__heading text-start" data-v-cdbad6db>${ssrInterpolate(trans("listing_page.recent_properties"))}</h4><div class="imas-blog-v2-sidebar__recent" data-v-cdbad6db><!--[-->`);
				ssrRenderList(__props.recentProperties, (p) => {
					_push(`<a${ssrRenderAttr("href", p.url)} class="imas-blog-v2-sidebar__recent-item" data-v-cdbad6db><img${ssrRenderAttr("src", p.thumbnail_url)}${ssrRenderAttr("alt", displayTitle(p))} loading="lazy" data-v-cdbad6db><div class="imas-blog-v2-sidebar__recent-body" data-v-cdbad6db><div class="imas-blog-v2-sidebar__recent-title" data-v-cdbad6db>${ssrInterpolate(displayTitle(p))}</div><div class="imas-blog-v2-sidebar__recent-date text-dim" data-v-cdbad6db>${ssrInterpolate(formatMoney(unref(propertyStartPrice)(p)))}</div></div></a>`);
				});
				_push(`<!--]--></div></div>`);
			} else _push(`<!---->`);
...
var PropertyListingSidebar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-cdbad6db"]]);
//#endregion
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const { title: documentTitle, description: metaDescription, keywords: metaKeywords, ogTitle, ogDescription, ogImage, canonical: canonicalUrl, ogUrl, twitterCard } = useDocumentSeo({
			...
			ogImage: () => {
				if (props.seoOgImage) return props.seoOgImage;
				const banner = media.value.property_show_banner;
				return typeof banner === "string" ? banner : "";
			},
			canonical: () => {
				if (typeof route === "function" && route().has?.("property.index")) try {
			...
			_push(ssrRenderComponent(_sfc_main$3, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="imas-blog-v2__page"${_scopeId}><section class="imas-blog-v2__main"${_scopeId}>`);
