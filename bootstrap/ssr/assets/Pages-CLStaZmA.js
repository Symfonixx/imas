import { a as propertyStartPrice, u as _plugin_vue_export_helper_default } from "../ssr.js";
import { o as localizedRoute, t as _sfc_main$3 } from "./App-CcYXakTU.js";
...
import { t as _sfc_main$5 } from "./FeaturedPropertiesSidebar-De438AC1.js";
import { a as destroyHeroRangeSliders, i as LocationAreaPicker_default, n as splitLocationIds, o as initHeroRangeSliders, r as LocationCityPicker_default, s as loadJqueryUi, t as useLocationSearchFilters } from "./useLocationSearchFilters-D8RIt2FR.js";
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-a25617f6>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-a25617f6>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-a25617f6>`);
			else _push(`<!---->`);
			if (includeAdvancedParams.value) _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-a25617f6>`);
			else _push(`<!---->`);
			...
			if (projectUnitTypes.value.length) {
				...
				_push(`<!--]--></select>`);
				if (searchUnitTypeId.value) _push(`<input type="hidden" name="project_unit_type_id[]"${ssrRenderAttr("value", searchUnitTypeId.value)} data-v-a25617f6>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`<div class="imas-listing-range-panel" data-v-a25617f6><div class="main-search-field-2" data-v-a25617f6><div class="range-slider" data-v-a25617f6><label data-v-a25617f6>${ssrInterpolate(trans("Area Size"))}</label><div id="imas-listing-area-range"${ssrRenderAttr("data-min", areaBounds.value.min)}${ssrRenderAttr("data-max", areaBounds.value.max)}${ssrRenderAttr("data-unit", areaBounds.value.unit)} data-v-a25617f6></div><div class="clearfix" data-v-a25617f6></div></div><br data-v-a25617f6><div class="range-slider" data-v-a25617f6><label data-v-a25617f6>${ssrInterpolate(trans("Price Range"))}</label><div id="imas-listing-price-range"${ssrRenderAttr("data-min", priceBounds.value.min)}${ssrRenderAttr("data-max", priceBounds.value.max)}${ssrRenderAttr("data-unit", priceBounds.value.currency)} data-v-a25617f6></div><div class="clearfix" data-v-a25617f6></div></div></div></div><div class="imas-listing-property-search__submit" data-v-a25617f6><button type="submit" class="btn btn-yellow btn-block" data-v-a25617f6>${ssrInterpolate(trans("Search Now"))}</button></div></div></div></div></form></div></div>`);
...
var PropertyListingSidebar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-a25617f6"]]);
//#endregion
