	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({
				...
				dir: "ltr"
			}, _attrs))} data-v-ad7ae5e4><div class="imas-auth-country-select-shell" data-v-ad7ae5e4><button${ssrRenderAttr("id", countryTriggerId.value)} type="button" class="imas-auth-country-trigger"${ssrRenderAttr("aria-expanded", countryDropdownOpen.value)} aria-haspopup="listbox"${ssrRenderAttr("aria-label", countrySelectAriaLabel.value)} data-v-ad7ae5e4>`);
			if (selectedCountry.value?.flag) _push(`<img class="imas-auth-country-flag-img"${ssrRenderAttr("src", selectedCountry.value.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-ad7ae5e4>`);
			else _push(`<!---->`);
			_push(`<span class="imas-auth-country-code-label" aria-hidden="true" data-v-ad7ae5e4>+${ssrInterpolate(displayCallingCode(selectedCountry.value?.phone_code))}</span></button><div class="imas-auth-country-dropdown-panel" style="${ssrRenderStyle(countryDropdownOpen.value ? null : { display: "none" })}" data-v-ad7ae5e4><div class="imas-auth-country-dropdown-search-wrap text-start" data-v-ad7ae5e4><input${ssrRenderAttr("value", countrySearchQuery.value)} type="search" enterkeyhint="search" autocomplete="off" autocorrect="off" spellcheck="false" class="imas-auth-country-dropdown-search"${ssrRenderAttr("placeholder", trans("Search"))}${ssrRenderAttr("aria-label", trans("Search"))} data-v-ad7ae5e4></div><ul class="imas-auth-country-dropdown-scroll" role="listbox" tabindex="-1" data-v-ad7ae5e4>`);
			if (countriesWithPhoneFiltered.value.length === 0) _push(`<li class="imas-auth-country-option imas-auth-country-option--empty" aria-live="polite" data-v-ad7ae5e4>${ssrInterpolate(trans("auth_modal.country_code_search_empty"))}</li>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(countriesWithPhoneFiltered.value, (c) => {
				_push(`<li role="option" class="${ssrRenderClass([{ "imas-auth-country-option--selected": c.id === countryId.value }, "imas-auth-country-option"])}"${ssrRenderAttr("aria-selected", c.id === countryId.value)} data-v-ad7ae5e4>`);
				if (c.flag) _push(`<img class="imas-auth-country-flag-img imas-auth-country-flag-img--option"${ssrRenderAttr("src", c.flag)} alt="" width="22" height="16" decoding="async" loading="lazy" data-v-ad7ae5e4>`);
				else _push(`<!---->`);
				_push(`<span class="imas-auth-country-option-code" data-v-ad7ae5e4>+${ssrInterpolate(displayCallingCode(c.phone_code))}</span></li>`);
			});
			_push(`<!--]--></ul></div></div><span class="imas-auth-phone-sep" aria-hidden="true" data-v-ad7ae5e4></span><input${ssrRenderAttr("id", __props.inputId)}${ssrRenderAttr("value", mobileLocal.value)} type="tel" inputmode="numeric" autocomplete="tel-national" class="imas-auth-phone-input"${ssrIncludeBooleanAttr(__props.required) ? " required" : ""}${ssrRenderAttr("placeholder", __props.placeholder)} data-v-ad7ae5e4></div>`);
		};
	}
};
...
var PhoneCountryInput_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-ad7ae5e4"]]);
//#endregion
