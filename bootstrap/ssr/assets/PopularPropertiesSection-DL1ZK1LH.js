		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.properties.length > 0) {
				...
				}, _attrs))} data-v-d17a8d43><div class="container-fluid" data-v-d17a8d43>`);
				if (!__props.hideTitle) _push(`<div class="sec-title discover" data-v-d17a8d43><h2 data-v-d17a8d43><span data-v-d17a8d43>${ssrInterpolate(__props.title)}</span></h2><p data-v-d17a8d43>${ssrInterpolate(__props.subtitle)}</p></div>`);
				else _push(`<!---->`);
				_push(`<div class="portfolio col-xl-12" data-v-d17a8d43>`);
				...
				_push(`<div class="imas-popular-rail" data-v-d17a8d43><div dir="ltr" class="${ssrRenderClass([{
					"is-dragging": isDragging.value,
					"imas-popular-viewport--rtl": isRtl.value
				}, "slick-lancers imas-popular-viewport"])}" style="${ssrRenderStyle({ "--imas-slides-visible": visibleCount.value })}" data-v-d17a8d43><!--[-->`);
				ssrRenderList(__props.properties, (property) => {
					_push(`<div class="imas-popular-slide agents-grid"${ssrRenderAttr("dir", slideTextDir.value)} data-v-d17a8d43><div class="landscapes w-100" data-v-d17a8d43>`);
					_push(ssrRenderComponent(_component_PropertyCard, { property }, null, _parent));
					_push(`</div></div>`);
				});
				_push(`<!--]--></div></div>`);
				if (pageCount.value > 1) {
					_push(`<ul class="slick-dots imas-popular-dots" role="group" aria-label="Popular properties" data-v-d17a8d43><!--[-->`);
					ssrRenderList(pageCount.value, (i) => {
						_push(`<li class="${ssrRenderClass({ "slick-active": activePage.value === i - 1 })}" data-v-d17a8d43><button type="button"${ssrRenderAttr("aria-label", `Slide ${i}`)}${ssrRenderAttr("aria-pressed", activePage.value === i - 1)} data-v-d17a8d43></button></li>`);
					});
					_push(`<!--]--></ul>`);
				} else _push(`<!---->`);
...
var PopularPropertiesSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-d17a8d43"]]);
//#endregion
