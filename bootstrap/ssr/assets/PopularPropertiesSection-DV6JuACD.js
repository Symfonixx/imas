...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (hasContent.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "imas-custom-heading call-info" }, _attrs))} data-v-4a952e15>`);
        if (__props.title.trim()) {
          _push(`<h3 class="text-start imas-custom-heading__title" style="${ssrRenderStyle(textStyle.value)}" data-v-4a952e15>${ssrInterpolate(__props.title)}</h3>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const CustomHeading = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4a952e15"]]);
const _sfc_main = {
