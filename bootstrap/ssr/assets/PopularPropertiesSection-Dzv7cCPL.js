	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.properties.length > 0) {
				...
				}, _attrs))} data-v-4da18ba6><div class="container-fluid" data-v-4da18ba6>`);
				if (!__props.hideTitle) _push(`<div class="sec-title discover" data-v-4da18ba6><h2 data-v-4da18ba6><span data-v-4da18ba6>${ssrInterpolate(__props.title)}</span></h2><p data-v-4da18ba6>${ssrInterpolate(__props.subtitle)}</p></div>`);
				else _push(`<!---->`);
				_push(`<div class="portfolio col-xl-12" data-v-4da18ba6>`);
				...
				_push(`<div class="imas-popular-rail" data-v-4da18ba6><div dir="ltr" class="${ssrRenderClass([{ "is-dragging": isDragging.value }, "slick-lancers imas-popular-viewport"])}" style="${ssrRenderStyle({ "--imas-slides-visible": visibleCount.value })}" data-v-4da18ba6><!--[-->`);
				ssrRenderList(__props.properties, (property) => {
					_push(`<div class="imas-popular-slide agents-grid"${ssrRenderAttr("dir", slideTextDir.value)} data-v-4da18ba6><div class="landscapes w-100" data-v-4da18ba6>`);
					_push(ssrRenderComponent(_component_PropertyCard, { property }, null, _parent));
					_push(`</div></div>`);
				});
				_push(`<!--]--></div></div>`);
				if (pageCount.value > 1) {
					_push(`<ul class="slick-dots imas-popular-dots" role="tablist" aria-label="Popular properties" data-v-4da18ba6><!--[-->`);
					ssrRenderList(pageCount.value, (i) => {
						_push(`<li class="${ssrRenderClass({ "slick-active": activePage.value === i - 1 })}" role="presentation" data-v-4da18ba6><button type="button"${ssrRenderAttr("aria-label", `Slide ${i}`)}${ssrRenderAttr("aria-current", activePage.value === i - 1 ? "page" : void 0)} data-v-4da18ba6></button></li>`);
					});
					_push(`<!--]--></ul>`);
				} else _push(`<!---->`);
...
var PopularPropertiesSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-4da18ba6"]]);
//#endregion
