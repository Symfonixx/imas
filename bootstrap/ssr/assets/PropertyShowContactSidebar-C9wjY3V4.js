...
import { i as normalizeTurkishPhoneDigits, n as resolveWhatsAppContactHref, r as formatTurkishPhone } from "./App-BhEC2Bhd.js";
...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (canToggleFavorite.value) _push(`<button type="button" class="${ssrRenderClass([{ "is-favorited": localFavorited.value }, "imas-contact-favorite__toggle"])}"${ssrRenderAttr("aria-label", favoriteAriaLabel.value)}${ssrRenderAttr("aria-pressed", localFavorited.value)} data-v-eaac6701><i class="${ssrRenderClass([localFavorited.value ? "fa-heart" : "fa-heart-o", "fa favorite-icon"])}" aria-hidden="true" data-v-eaac6701></i></button>`);
			else _push(`<!---->`);
			_push(`<div class="imas-contact-share" data-v-eaac6701><button type="button" class="imas-contact-share__toggle"${ssrRenderAttr("aria-label", trans("property_show.share_page"))}${ssrRenderAttr("aria-expanded", shareOpen.value ? "true" : "false")} aria-haspopup="true" data-v-eaac6701><i class="fa fa-share-alt" aria-hidden="true" data-v-eaac6701></i></button><div class="imas-contact-share__menu" role="menu" style="${ssrRenderStyle(shareOpen.value ? null : { display: "none" })}" data-v-eaac6701><!--[-->`);
			...
			if (contactItems.value.length) {
				...
				ssrRenderList(contactItems.value, (item) => {
					...
					if (isRtl.value) {
						...
						if (item.href) _push(`<a class="imas-contact-list__link"${ssrRenderAttr("href", item.href)}${ssrRenderAttr("target", item.external ? "_blank" : void 0)}${ssrRenderAttr("rel", item.external ? "noopener noreferrer" : void 0)} data-v-eaac6701>${ssrInterpolate(item.text)}</a>`);
...
var PropertyShowContactSidebar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-eaac6701"]]);
//#endregion
