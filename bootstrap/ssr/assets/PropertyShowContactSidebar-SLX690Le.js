...
import { f as formatTurkishPhone, n as normalizeTurkishPhoneDigits, r as resolveWhatsAppContactHref } from "./App-DYVlVBS1.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (canToggleFavorite.value) {
        _push(`<button type="button" class="${ssrRenderClass([{ "is-favorited": localFavorited.value }, "imas-contact-favorite__toggle"])}"${ssrRenderAttr("aria-label", favoriteAriaLabel.value)}${ssrRenderAttr("aria-pressed", localFavorited.value)} data-v-370f7631><i class="${ssrRenderClass([localFavorited.value ? "fa-heart" : "fa-heart-o", "fa favorite-icon"])}" aria-hidden="true" data-v-370f7631></i></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="imas-contact-share" data-v-370f7631><button type="button" class="imas-contact-share__toggle"${ssrRenderAttr("aria-label", trans("property_show.share_page"))}${ssrRenderAttr("aria-expanded", shareOpen.value ? "true" : "false")} aria-haspopup="true" data-v-370f7631><i class="fa fa-share-alt" aria-hidden="true" data-v-370f7631></i></button><div style="${ssrRenderStyle(shareOpen.value ? null : { display: "none" })}" class="imas-contact-share__menu" role="menu" data-v-370f7631><!--[-->`);
        ...
        ssrRenderList(contactItems.value, (item) => {
          ...
          if (isRtl.value) {
            ...
            if (item.href) {
              ...
              )} data-v-370f7631>${ssrInterpolate(item.text)}</a>`);
            } else {
...
const PropertyShowContactSidebar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-370f7631"]]);
export {
