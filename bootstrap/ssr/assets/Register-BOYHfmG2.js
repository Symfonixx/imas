...
import { t as PhoneCountryInput_default } from "./PhoneCountryInput-Cx7dg9cG.js";
...
//#region Modules/User/resources/assets/js/Pages/Auth/Register.vue
var _sfc_main = {
	components: {
		AppLayout: _sfc_main$1,
		Link,
		PhoneCountryInput: PhoneCountryInput_default,
		Head
	},
	props: { errors: Object },
	setup() {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	_push(`<!--[-->`);
	_push(ssrRenderComponent(_component_Head, { title: `${$setup.trans("Register")} | ${$setup.appName}` }, {
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) _push(`<meta head-key="robots" name="robots" content="noindex, nofollow" data-v-5f03b53b${_scopeId}>`);
	...
	_push(ssrRenderComponent(_component_app_layout, null, {
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) {
				_push(`<div class="container mt-5" data-v-5f03b53b${_scopeId}><div class="row justify-content-center" data-v-5f03b53b${_scopeId}><div class="col-md-6" data-v-5f03b53b${_scopeId}><div class="card" data-v-5f03b53b${_scopeId}><div class="card-header text-center" data-v-5f03b53b${_scopeId}><h3 data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("Register"))}</h3></div><div class="card-body" data-v-5f03b53b${_scopeId}><form data-v-5f03b53b${_scopeId}><div class="row mb-3" data-v-5f03b53b${_scopeId}><div class="col-md-6" data-v-5f03b53b${_scopeId}><label class="form-label" for="first_name" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("contact_us.first_name"))}</label><input id="first_name"${ssrRenderAttr("value", $setup.form.first_name)} autofocus class="form-control" required type="text" maxlength="120" autocomplete="given-name" data-v-5f03b53b${_scopeId}>`);
				if ($props.errors.first_name) _push(`<span class="invalid-feedback d-block" data-v-5f03b53b${_scopeId}>${ssrInterpolate($props.errors.first_name)}</span>`);
				else _push(`<!---->`);
				_push(`</div><div class="col-md-6" data-v-5f03b53b${_scopeId}><label class="form-label" for="last_name" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("contact_us.last_name"))}</label><input id="last_name"${ssrRenderAttr("value", $setup.form.last_name)} class="form-control" required type="text" maxlength="120" autocomplete="family-name" data-v-5f03b53b${_scopeId}>`);
				if ($props.errors.last_name) _push(`<span class="invalid-feedback d-block" data-v-5f03b53b${_scopeId}>${ssrInterpolate($props.errors.last_name)}</span>`);
				else _push(`<!---->`);
				_push(`</div></div><div class="mb-3" data-v-5f03b53b${_scopeId}><label class="form-label" for="email" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("Email"))}</label><input id="email"${ssrRenderAttr("value", $setup.form.email)} class="form-control" required type="email" data-v-5f03b53b${_scopeId}>`);
				if ($props.errors.email) _push(`<span class="invalid-feedback d-block" data-v-5f03b53b${_scopeId}>${ssrInterpolate($props.errors.email)}</span>`);
				else _push(`<!---->`);
				_push(`</div><div class="mb-3" data-v-5f03b53b${_scopeId}><label class="form-label" for="register-mobile" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("Mobile"))}</label>`);
				_push(ssrRenderComponent(_component_PhoneCountryInput, {
				...
				if ($props.errors.mobile) _push(`<span class="invalid-feedback d-block" data-v-5f03b53b${_scopeId}>${ssrInterpolate($props.errors.mobile)}</span>`);
				else _push(`<!---->`);
				_push(`</div><div class="mb-3" data-v-5f03b53b${_scopeId}><label class="form-label" for="password" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("Password"))}</label><input id="password"${ssrRenderAttr("value", $setup.form.password)} class="form-control" required type="password" data-v-5f03b53b${_scopeId}>`);
				if ($props.errors.password) _push(`<span class="invalid-feedback d-block" data-v-5f03b53b${_scopeId}>${ssrInterpolate($props.errors.password)}</span>`);
				else _push(`<!---->`);
				_push(`</div><div class="mb-3" data-v-5f03b53b${_scopeId}><label class="form-label" for="password_confirmation" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("Confirm Password"))}</label><input id="password_confirmation"${ssrRenderAttr("value", $setup.form.password_confirmation)} class="form-control" required type="password_confirmation" data-v-5f03b53b${_scopeId}>`);
				if ($props.errors.password_confirmation) _push(`<span class="invalid-feedback d-block" data-v-5f03b53b${_scopeId}>${ssrInterpolate($props.errors.password_confirmation)}</span>`);
				else _push(`<!---->`);
				_push(`</div><button class="btn btn-primary w-100" type="submit" data-v-5f03b53b${_scopeId}>${ssrInterpolate($setup.trans("Register"))}</button></form></div></div></div></div></div>`);
			} else return [createVNode("div", { class: "container mt-5" }, [createVNode("div", { class: "row justify-content-center" }, [createVNode("div", { class: "col-md-6" }, [createVNode("div", { class: "card" }, [createVNode("div", { class: "card-header text-center" }, [createVNode("h3", null, toDisplayString($setup.trans("Register")), 1)]), createVNode("div", { class: "card-body" }, [createVNode("form", { onSubmit: withModifiers(($event) => $setup.form.post(_ctx.route("register")), ["prevent"]) }, [
				createVNode("div", { class: "row mb-3" }, [createVNode("div", { class: "col-md-6" }, [
					createVNode("label", {
						class: "form-label",
						for: "first_name"
					...
					}, null, 8, ["onUpdate:modelValue"]), [[vModelText, $setup.form.first_name]]),
					...
					}, null, 8, ["onUpdate:modelValue"]), [[vModelText, $setup.form.last_name]]),
				...
				createVNode("div", { class: "mb-3" }, [
					...
					}, null, 8, ["onUpdate:modelValue"]), [[vModelText, $setup.form.password_confirmation]]),
...
var Register_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-5f03b53b"]]);
//#endregion
