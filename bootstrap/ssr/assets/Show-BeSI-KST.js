import { o as localizedRoute, t as _sfc_main$1 } from "./App-BhEC2Bhd.js";
...
import { t as buildArticleSchema } from "./structuredData-BcvdJ8zz.js";
import { n as _sfc_main$3, t as blogIndexLocalizedUrl } from "./blogLocalizedRoute-DrNKCm-y.js";
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (articleJsonLd.value) _push(`<script head-key="jsonld-article" type="application/ld+json"${_scopeId}>${ssrInterpolate(articleJsonLd.value)}<\/script>`);
						else _push(`<!---->`);
					} else return [
						...
						articleJsonLd.value ? (openBlock(), createBlock("script", {
							key: 10,
							"head-key": "jsonld-article",
							type: "application/ld+json",
							textContent: toDisplayString(articleJsonLd.value)
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					...
					}, null, 8, ["innerHTML"])])], 512)]), createVNode(_sfc_main$3, {
						"search-action": blogIndexUrl.value,
						filters: __props.filters,
						categories: __props.categories,
						"recent-blogs": __props.recentBlogs,
