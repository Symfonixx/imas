import { o as localizedRoute, t as _sfc_main$1 } from "./App-7O-qCwwD.js";
...
import { n as _sfc_main$4, t as blogIndexLocalizedUrl } from "./blogLocalizedRoute-IFI3WSUk.js";
	...
	setup(__props) {
		...
		const articleSchema = computed(() => {
			...
			return buildArticleSchema({
				...
				image: ogImage.value,
				datePublished: articlePublishedTime.value || void 0,
				dateModified: articleModifiedTime.value || void 0,
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (articlePublishedTime.value) _push(`<meta head-key="article:published_time" property="article:published_time"${ssrRenderAttr("content", articlePublishedTime.value)}${_scopeId}>`);
						else _push(`<!---->`);
						if (articleModifiedTime.value) _push(`<meta head-key="article:modified_time" property="article:modified_time"${ssrRenderAttr("content", articleModifiedTime.value)}${_scopeId}>`);
						else _push(`<!---->`);
						...
						articlePublishedTime.value ? (openBlock(), createBlock("meta", {
							key: 10,
							"head-key": "article:published_time",
							property: "article:published_time",
							content: articlePublishedTime.value
						}, null, 8, ["content"])) : createCommentVNode("", true),
						articleModifiedTime.value ? (openBlock(), createBlock("meta", {
							key: 11,
							"head-key": "article:modified_time",
							property: "article:modified_time",
							content: articleModifiedTime.value
						}, null, 8, ["content"])) : createCommentVNode("", true),
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="imas-blog-v2__page container"${_scopeId}><section class="imas-blog-v2__main"${_scopeId}><article class="imas-blog-show"${_scopeId}>`);
						...
						"items",
						"banner-image-url"
					]), createVNode("div", { class: "imas-blog-v2__page container" }, [createVNode("section", { class: "imas-blog-v2__main" }, [createVNode("article", {
