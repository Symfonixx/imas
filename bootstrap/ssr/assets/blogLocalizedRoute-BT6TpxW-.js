...
import { l as localizedRoute } from "./App-BMYoBaMl.js";
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<aside${ssrRenderAttrs(mergeProps({
        class: ["imas-blog-v2-sidebar", { "col-lg-3 col-md-12": __props.asColumn }]
      }, _attrs))}>`);
      if (__props.showSearch && __props.searchAction) {
        ...
        if (__props.filters.category_id) {
          _push(`<input type="hidden" name="category_id"${ssrRenderAttr("value", __props.filters.category_id)}>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (__props.showCategories) {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(trans("blogs.all_categories"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(trans("blogs.all_categories")), 1)
              ];
            }
          }),
          _: 1
        ...
        ssrRenderList(__props.categories, (c) => {
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            class: ["imas-blog-v2-sidebar__cat-link", {
              "is-active": __props.filters.category_id != null && Number(__props.filters.category_id) === c.id
            }]
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
      ...
      if (__props.showRecentPosts) {
        ...
        ssrRenderList(__props.recentBlogs, (r) => {
          ...
          if (r.date) {
            _push(`<div class="imas-blog-v2-sidebar__recent-date text-dim text-start">${ssrInterpolate(r.date)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></a>`);
