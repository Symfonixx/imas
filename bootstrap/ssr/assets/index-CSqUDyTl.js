...
import { l as localizedRoute, _ as _sfc_main$4 } from "./App-DYVlVBS1.js";
...
import { _ as _export_sfc, a as propertyStartPrice, f as formatPropertyMoney } from "../ssr.js";
import { _ as _sfc_main$3 } from "./FeaturedPropertiesSidebar-JQX0EZj7.js";
import "gsap";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="min_price"${ssrRenderAttr("value", priceRange.value[0])} data-v-7d012e99>`);
      } else {
        _push(`<!---->`);
      }
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="max_price"${ssrRenderAttr("value", priceRange.value[1])} data-v-7d012e99>`);
      } else {
        _push(`<!---->`);
      }
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="min_area"${ssrRenderAttr("value", areaRange.value[0])} data-v-7d012e99>`);
      } else {
        _push(`<!---->`);
      }
      if (includeAdvancedParams.value) {
        _push(`<input type="hidden" name="max_area"${ssrRenderAttr("value", areaRange.value[1])} data-v-7d012e99>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (projectUnitTypes.value.length) {
        ...
        if (searchUnitTypeId.value) {
          _push(`<input type="hidden" name="project_unit_type_id[]"${ssrRenderAttr("value", searchUnitTypeId.value)} data-v-7d012e99>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const PropertyListingSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7d012e99"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  props: {
