import { ref, computed, watch, mergeProps, nextTick, useSSRContext, unref, withCtx, openBlock, createBlock, createCommentVNode, createVNode, toDisplayString, Fragment } from "vue";
...
import { l as localizedRoute, _ as _sfc_main$6 } from "./App-BMYoBaMl.js";
...
import { _ as _export_sfc, V as VideoLightbox, l as localizedField, b as propertyLocationLine, a as propertyStartPrice, d as localizedLocationName } from "../ssr.js";
import { P as PropertyShowContactSidebar } from "./PropertyShowContactSidebar-CgPpPmtw.js";
import "./FeaturedPropertiesSidebar-CGqAPeiJ.js";
import "gsap";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (images.value.length > 0) {
        ...
        if (images.value.length > 1) {
          _push(`<div class="imas-gallery-counter" aria-live="polite" data-v-5d94f2b4><i class="fa fa-image imas-gallery-counter__icon" aria-hidden="true" data-v-5d94f2b4></i><span class="imas-gallery-counter__text" data-v-5d94f2b4>${ssrInterpolate(activeIndex.value + 1)} / ${ssrInterpolate(images.value.length)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        if (images.value.length > 1) {
          _push(`<!--[--><a class="carousel-control left imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", previousLabel.value)} data-v-5d94f2b4><i class="fa fa-angle-left" aria-hidden="true" data-v-5d94f2b4></i></a><a class="carousel-control right imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", nextLabel.value)} data-v-5d94f2b4><i class="fa fa-angle-right" aria-hidden="true" data-v-5d94f2b4></i></a><!--]-->`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (images.value.length > 1) {
          ...
          ssrRenderList(images.value, (image, index) => {
            _push(`<li class="${ssrRenderClass([{ active: index === activeIndex.value }, "list-inline-item imas-gallery-thumbs__item"])}" data-v-5d94f2b4><a href="#" class="${ssrRenderClass({ selected: index === activeIndex.value })}"${ssrRenderAttr("aria-label", `Image ${index + 1}`)}${ssrRenderAttr(
              "aria-current",
              index === activeIndex.value ? "true" : void 0
            )} data-v-5d94f2b4><span class="imas-gallery-thumb__frame" data-v-5d94f2b4><img${ssrRenderAttr("src", image.url)} class="imas-gallery-thumb__img"${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-5d94f2b4></span></a></li>`);
          });
          _push(`<!--]--></ul></div>`);
        } else {
          _push(`<!---->`);
...
const PropertyShowGallery = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-5d94f2b4"]]);
const _sfc_main$3 = {
      ...
      if (__props.unitTypes.length > 0) {
        ...
        if (__props.projectId || __props.projectLocation) {
          ...
          if (__props.projectId) {
            _push(`<div class="imas-unit-types-table__meta-item" data-v-f2bb7d1a><dt class="imas-unit-types-table__meta-label" data-v-f2bb7d1a>${ssrInterpolate(__props.projectIdLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-f2bb7d1a>${ssrInterpolate(__props.projectId)}</dd></div>`);
          } else {
            _push(`<!---->`);
          }
          if (__props.projectLocation) {
            _push(`<div class="imas-unit-types-table__meta-item" data-v-f2bb7d1a><dt class="imas-unit-types-table__meta-label" data-v-f2bb7d1a>${ssrInterpolate(__props.projectLocationLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-f2bb7d1a>${ssrInterpolate(__props.projectLocation)}</dd></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</dl>`);
...
const PropertyShowUnitTypesTable = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f2bb7d1a"]]);
const _sfc_main$1 = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (metaDescription.value) {
              _push2(`<meta head-key="description" name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaKeywords.value) {
              _push2(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (canonicalUrl.value) {
              _push2(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", canonicalUrl.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogTitle.value) {
              _push2(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", ogTitle.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogDescription.value) {
              _push2(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", ogDescription.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogImage.value) {
              _push2(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", ogImage.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta head-key="og:type" property="og:type" content="website" data-v-a6033ce4${_scopeId}>`);
            if (ogUrl.value) {
              _push2(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", ogUrl.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", twitterCard.value)} data-v-a6033ce4${_scopeId}>`);
            if (ogTitle.value) {
              _push2(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", ogTitle.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogDescription.value) {
              _push2(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", ogDescription.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (ogImage.value) {
              _push2(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", ogImage.value)} data-v-a6033ce4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
      ...
      _push(ssrRenderComponent(_sfc_main$6, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="inner-pages blog imas-property-show-page imas-blog-v2 imas-property-listings" data-v-a6033ce4${_scopeId}>`);
            ...
            if (__props.property.project_code) {
              _push2(`<div class="mt-0" data-v-a6033ce4${_scopeId}><span class="listing-address" data-v-a6033ce4${_scopeId}>${ssrInterpolate(trans("property_show.project_id"))}: ${ssrInterpolate(__props.property.project_code)}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h3 data-v-a6033ce4${_scopeId}>${ssrInterpolate(displayTitle.value)}</h3>`);
            if (addressLine.value) {
              _push2(`<div class="mt-0" data-v-a6033ce4${_scopeId}>`);
              if (hasMapCoordinates.value) {
                _push2(`<a href="#listing-location" class="listing-address" data-v-a6033ce4${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-a6033ce4${_scopeId}></i><span data-v-a6033ce4${_scopeId}>${ssrInterpolate(addressLine.value)}</span></a>`);
              } else {
                _push2(`<span class="listing-address" data-v-a6033ce4${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-a6033ce4${_scopeId}></i><span data-v-a6033ce4${_scopeId}>${ssrInterpolate(addressLine.value)}</span></span>`);
              }
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (propertyTypeLabel.value) {
              _push2(`<div class="imas-property-type-badge mt-2" data-v-a6033ce4${_scopeId}>${ssrInterpolate(propertyTypeLabel.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="single detail-wrapper ms-lg-auto" data-v-a6033ce4${_scopeId}><div class="detail-wrapper-body" data-v-a6033ce4${_scopeId}><div class="listing-title-bar text-start text-lg-end" data-v-a6033ce4${_scopeId}><h4 class="imas-price-heading" data-v-a6033ce4${_scopeId}>`);
            if (priceAmount.value) {
              _push2(`<!--[--><span class="imas-price-heading__prefix" data-v-a6033ce4${_scopeId}>${ssrInterpolate(pricePrefix.value)}</span><span class="imas-price-heading__amount text-gold" data-v-a6033ce4${_scopeId}>${ssrInterpolate(priceAmount.value)}</span><!--]-->`);
            } else {
              _push2(`<span class="imas-price-heading__amount text-gold" data-v-a6033ce4${_scopeId}>—</span>`);
            }
            _push2(`</h4></div></div></div></div></section><div data-imas-reveal data-v-a6033ce4${_scopeId}>`);
            ...
            if (overviewHtml.value) {
              _push2(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-a6033ce4${_scopeId}><h5 class="imas-section-title mb-4" data-v-a6033ce4${_scopeId}>${ssrInterpolate(trans(
                "property_show.description"
              ))}</h5><div class="imas-rich-content text-md" data-v-a6033ce4${_scopeId}>${overviewHtml.value ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if ((_a = __props.property.unit_types) == null ? void 0 : _a.length) {
              _push2(`<div data-imas-reveal data-v-a6033ce4${_scopeId}>`);
            ...
            if (whyToBuyHtml.value) {
              ...
              ))}</h5><div class="imas-rich-content text-md" data-v-a6033ce4${_scopeId}>${whyToBuyHtml.value ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (facilitiesHtml.value) {
              _push2(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-a6033ce4${_scopeId}><h5 class="imas-section-title mb-4" data-v-a6033ce4${_scopeId}>${ssrInterpolate(trans(
                "property_show.facilities"
              ))}</h5><div class="imas-rich-content text-md" data-v-a6033ce4${_scopeId}>${facilitiesHtml.value ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
            if (contentHtml.value) {
              _push2(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-a6033ce4${_scopeId}><h5 class="imas-section-title mb-4" data-v-a6033ce4${_scopeId}>${ssrInterpolate(trans("property_show.details"))}</h5><div class="imas-rich-content text-md" data-v-a6033ce4${_scopeId}>${contentHtml.value ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            if (hasMapCoordinates.value) {
              _push2(`<div id="listing-location" data-imas-reveal data-v-a6033ce4${_scopeId}>`);
            ...
            _push2(`</div><aside class="col-lg-4 col-md-12 car imas-blog-v2-sidebar imas-property-show__sidebar-col" data-v-a6033ce4${_scopeId}><div class="imas-property-show__contact-sticky" data-imas-reveal="aside" data-v-a6033ce4${_scopeId}>`);
                          ...
                          createVNode("div", { class: "col-md-12" }, [
                            ...
                            createVNode("div", { "data-imas-reveal": "" }, [
                              createVNode(PropertyShowGallery, {
                                ...
                                alt: displayTitle.value,
                                title: trans("property_show.gallery")
                              }, null, 8, ["property-id", "slides", "thumbnail-url", "alt", "title"])
                            ]),
                            ...
                            ((_b = __props.property.unit_types) == null ? void 0 : _b.length) ? (openBlock(), createBlock("div", {
                              ...
                              createVNode(PropertyShowUnitTypesTable, {
                                ...
                                "col-area": trans("property_show.col_area"),
                                "col-price": trans("property_show.col_price")
                              }, null, 8, ["unit-types", "title", "project-id", "project-id-label", "project-location", "project-location-label", "col-rooms", "col-area", "col-price"])
                            ])) : createCommentVNode("", true),
...
const show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a6033ce4"]]);
export {
  show as default
};
