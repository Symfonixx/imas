import { a as propertyStartPrice, c as localizedField, l as VideoLightbox_default, o as localizedLocationName, s as propertyLocationLine, u as _plugin_vue_export_helper_default } from "../ssr.js";
import { o as localizedRoute, t as _sfc_main$6 } from "./App-Tm_yWILr.js";
import { t as useScrollReveal } from "./useScrollReveal-DCquZn8b.js";
import { t as _sfc_main$7 } from "./InnerPageHeadingHero-CFmV_XXE.js";
import "./FeaturedPropertiesSidebar-De438AC1.js";
import { t as PopularPropertiesSection_default } from "./PopularPropertiesSection-DCmqbEf2.js";
import { c as stripHtml, i as buildRealEstateListingSchema, n as buildBreadcrumbSchema, s as filterSchemaImages } from "./structuredData-BcvdJ8zz.js";
...
import { Fragment, computed, createBlock, createCommentVNode, createVNode, mergeProps, openBlock, ref, toDisplayString, unref, useSSRContext, withCtx } from "vue";
...
var _sfc_main$5 = {
	...
	setup(__props) {
		...
		const images = computed(() => {
			...
			if (rows.length === 0 && thumb && !isPlaceholderThumb) rows.push({
				key: "thumbnail",
				url: thumb,
				alt: props.alt
			});
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (images.value.length > 0) {
				...
				}, _attrs))} data-v-9b315af6><h5 class="imas-section-title mb-4" data-v-9b315af6>${ssrInterpolate(__props.title)}</h5><div class="imas-gallery-main" data-v-9b315af6><div class="carousel-inner imas-gallery-main__inner" data-v-9b315af6><!--[-->`);
				ssrRenderList(images.value, (image, index) => {
					_push(`<div class="${ssrRenderClass([{ active: index === activeIndex.value }, "item carousel-item imas-gallery-slide"])}"${ssrRenderAttr("data-slide-number", index)} data-v-9b315af6><div class="imas-gallery-main__frame" data-v-9b315af6><img${ssrRenderAttr("src", image.url)} class="imas-gallery-main__img"${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-9b315af6></div></div>`);
				});
				_push(`<!--]--></div>`);
				if (images.value.length > 1) _push(`<div class="imas-gallery-counter" aria-live="polite" data-v-9b315af6><i class="fa fa-image imas-gallery-counter__icon" aria-hidden="true" data-v-9b315af6></i><span class="imas-gallery-counter__text" data-v-9b315af6>${ssrInterpolate(activeIndex.value + 1)} / ${ssrInterpolate(images.value.length)}</span></div>`);
				else _push(`<!---->`);
				if (images.value.length > 1) _push(`<!--[--><a class="carousel-control left imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", previousLabel.value)} data-v-9b315af6><i class="fa fa-angle-left" aria-hidden="true" data-v-9b315af6></i></a><a class="carousel-control right imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", nextLabel.value)} data-v-9b315af6><i class="fa fa-angle-right" aria-hidden="true" data-v-9b315af6></i></a><!--]-->`);
				else _push(`<!---->`);
				_push(`</div>`);
				if (images.value.length > 1) {
					_push(`<div class="imas-gallery-thumbs-outer" data-v-9b315af6><ul class="carousel-indicators smail-listing list-inline imas-gallery-thumbs" data-v-9b315af6><!--[-->`);
					ssrRenderList(images.value, (image, index) => {
						_push(`<li class="${ssrRenderClass([{ active: index === activeIndex.value }, "list-inline-item imas-gallery-thumbs__item"])}" data-v-9b315af6><a href="#" class="${ssrRenderClass({ selected: index === activeIndex.value })}"${ssrRenderAttr("aria-label", `Image ${index + 1}`)}${ssrRenderAttr("aria-current", index === activeIndex.value ? "true" : void 0)} data-v-9b315af6><span class="imas-gallery-thumb__frame" data-v-9b315af6><img${ssrRenderAttr("src", image.url)} class="imas-gallery-thumb__img"${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-9b315af6></span></a></li>`);
					});
					_push(`<!--]--></ul></div>`);
				} else _push(`<!---->`);
				_push(`</div>`);
...
var PropertyShowGallery_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["__scopeId", "data-v-9b315af6"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.unitTypes.length > 0) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: "imas-unit-types-table mb-30" }, _attrs))} data-v-f2bb7d1a><h5 class="imas-section-title mb-4" data-v-f2bb7d1a>${ssrInterpolate(__props.title)}</h5>`);
				if (__props.projectId || __props.projectLocation) {
					_push(`<dl class="imas-unit-types-table__meta mb-4" data-v-f2bb7d1a>`);
					if (__props.projectId) _push(`<div class="imas-unit-types-table__meta-item" data-v-f2bb7d1a><dt class="imas-unit-types-table__meta-label" data-v-f2bb7d1a>${ssrInterpolate(__props.projectIdLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-f2bb7d1a>${ssrInterpolate(__props.projectId)}</dd></div>`);
					else _push(`<!---->`);
					if (__props.projectLocation) _push(`<div class="imas-unit-types-table__meta-item" data-v-f2bb7d1a><dt class="imas-unit-types-table__meta-label" data-v-f2bb7d1a>${ssrInterpolate(__props.projectLocationLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-f2bb7d1a>${ssrInterpolate(__props.projectLocation)}</dd></div>`);
					else _push(`<!---->`);
					_push(`</dl>`);
				} else _push(`<!---->`);
				_push(`<div class="table-responsive" data-v-f2bb7d1a><table class="table imas-unit-types-table__grid mb-0" data-v-f2bb7d1a><thead data-v-f2bb7d1a><tr data-v-f2bb7d1a><th scope="col" data-v-f2bb7d1a>${ssrInterpolate(__props.colRooms)}</th><th scope="col" data-v-f2bb7d1a>${ssrInterpolate(__props.colArea)}</th><th scope="col" data-v-f2bb7d1a>${ssrInterpolate(__props.colPrice)}</th></tr></thead><tbody data-v-f2bb7d1a><!--[-->`);
				ssrRenderList(__props.unitTypes, (row) => {
					_push(`<tr data-v-f2bb7d1a><td data-v-f2bb7d1a>${ssrInterpolate(row.name || "—")}</td><td data-v-f2bb7d1a>${ssrInterpolate(formatArea(row))}</td><td data-v-f2bb7d1a>${ssrInterpolate(formatPrice(row.price))}</td></tr>`);
				});
...
var PropertyShowUnitTypesTable_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-f2bb7d1a"]]);
//#endregion
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (metaDescription.value) _push(`<meta head-key="description" name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (metaKeywords.value) _push(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (canonicalUrl.value) _push(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", canonicalUrl.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (ogTitle.value) _push(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", ogTitle.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", ogDescription.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", ogImage.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="og:type" property="og:type" content="website" data-v-af2e3abf${_scopeId}>`);
						if (ogUrl.value) _push(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", ogUrl.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", twitterCard.value)} data-v-af2e3abf${_scopeId}>`);
						if (ogTitle.value) _push(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", ogTitle.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", ogDescription.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", ogImage.value)} data-v-af2e3abf${_scopeId}>`);
						else _push(`<!---->`);
						if (realEstateListingJsonLd.value) _push(`<script head-key="jsonld-real-estate-listing" type="application/ld+json" data-v-af2e3abf${_scopeId}>${ssrInterpolate(realEstateListingJsonLd.value)}<\/script>`);
						else _push(`<!---->`);
						if (breadcrumbJsonLd.value) _push(`<script head-key="jsonld-breadcrumb" type="application/ld+json" data-v-af2e3abf${_scopeId}>${ssrInterpolate(breadcrumbJsonLd.value)}<\/script>`);
						else _push(`<!---->`);
						if (customSchemaJsonLd.value) _push(`<script head-key="jsonld-custom" type="application/ld+json" data-v-af2e3abf${_scopeId}>${ssrInterpolate(customSchemaJsonLd.value)}<\/script>`);
						else _push(`<!---->`);
					} else return [
						...
						realEstateListingJsonLd.value ? (openBlock(), createBlock("script", {
							key: 10,
							"head-key": "jsonld-real-estate-listing",
							type: "application/ld+json",
							textContent: toDisplayString(realEstateListingJsonLd.value)
						}, null, 8, ["textContent"])) : createCommentVNode("", true),
						breadcrumbJsonLd.value ? (openBlock(), createBlock("script", {
							key: 11,
							"head-key": "jsonld-breadcrumb",
							type: "application/ld+json",
							textContent: toDisplayString(breadcrumbJsonLd.value)
						}, null, 8, ["textContent"])) : createCommentVNode("", true),
						customSchemaJsonLd.value ? (openBlock(), createBlock("script", {
							key: 12,
							"head-key": "jsonld-custom",
							type: "application/ld+json",
							textContent: toDisplayString(customSchemaJsonLd.value)
						}, null, 8, ["textContent"])) : createCommentVNode("", true)
					];
				}),
				_: 1
			...
			_push(ssrRenderComponent(_sfc_main$6, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="inner-pages blog imas-property-show-page imas-blog-v2 imas-property-listings" data-v-af2e3abf${_scopeId}>`);
						...
						_push(`<section class="single-proper blog details imas-property-show" data-v-af2e3abf${_scopeId}><div class="container" data-v-af2e3abf${_scopeId}><div class="row imas-property-show__content-row" data-v-af2e3abf${_scopeId}><div class="col-lg-8 col-md-12 blog-pots" data-v-af2e3abf${_scopeId}><div class="row" data-v-af2e3abf${_scopeId}><div class="col-md-12" data-v-af2e3abf${_scopeId}><section data-imas-reveal class="headings-2 pt-0" data-v-af2e3abf${_scopeId}><div class="pro-wrapper imas-property-title-row" data-v-af2e3abf${_scopeId}><div class="detail-wrapper-body" data-v-af2e3abf${_scopeId}><div class="listing-title-bar text-start" data-v-af2e3abf${_scopeId}>`);
						if (__props.property.project_code) _push(`<div class="mt-0" data-v-af2e3abf${_scopeId}><span class="listing-address" data-v-af2e3abf${_scopeId}>${ssrInterpolate(trans("property_show.project_id"))}: ${ssrInterpolate(__props.property.project_code)}</span></div>`);
						else _push(`<!---->`);
						_push(`<h3 data-v-af2e3abf${_scopeId}>${ssrInterpolate(displayTitle.value)}</h3>`);
						if (addressLine.value) {
							_push(`<div class="mt-0" data-v-af2e3abf${_scopeId}>`);
							if (hasMapCoordinates.value) _push(`<a href="#listing-location" class="listing-address" data-v-af2e3abf${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-af2e3abf${_scopeId}></i><span data-v-af2e3abf${_scopeId}>${ssrInterpolate(addressLine.value)}</span></a>`);
							else _push(`<span class="listing-address" data-v-af2e3abf${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-af2e3abf${_scopeId}></i><span data-v-af2e3abf${_scopeId}>${ssrInterpolate(addressLine.value)}</span></span>`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (propertyTypeLabel.value) _push(`<div class="imas-property-type-badge mt-2" data-v-af2e3abf${_scopeId}>${ssrInterpolate(propertyTypeLabel.value)}</div>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="single detail-wrapper ms-lg-auto" data-v-af2e3abf${_scopeId}><div class="detail-wrapper-body" data-v-af2e3abf${_scopeId}><div class="listing-title-bar text-start text-lg-end" data-v-af2e3abf${_scopeId}><h4 class="imas-price-heading" data-v-af2e3abf${_scopeId}>`);
						if (priceAmount.value) _push(`<!--[--><span class="imas-price-heading__prefix" data-v-af2e3abf${_scopeId}>${ssrInterpolate(pricePrefix.value)}</span><span class="imas-price-heading__amount text-gold" data-v-af2e3abf${_scopeId}>${ssrInterpolate(priceAmount.value)}</span><!--]-->`);
						else _push(`<span class="imas-price-heading__amount text-gold" data-v-af2e3abf${_scopeId}>—</span>`);
						_push(`</h4></div></div></div></div></section><div data-imas-reveal data-v-af2e3abf${_scopeId}>`);
						...
						_push(`</div>`);
						if (overviewHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-af2e3abf${_scopeId}><h5 class="imas-section-title mb-4" data-v-af2e3abf${_scopeId}>${ssrInterpolate(trans("property_show.description"))}</h5><div class="imas-rich-content text-md" data-v-af2e3abf${_scopeId}>${overviewHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						if (__props.property.unit_types?.length) {
							_push(`<div data-imas-reveal data-v-af2e3abf${_scopeId}>`);
						...
						if (whyToBuyHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-af2e3abf${_scopeId}><h5 class="imas-section-title mb-4" data-v-af2e3abf${_scopeId}>${ssrInterpolate(trans("property_show.why_to_buy"))}</h5><div class="imas-rich-content text-md" data-v-af2e3abf${_scopeId}>${whyToBuyHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						if (facilitiesHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-af2e3abf${_scopeId}><h5 class="imas-section-title mb-4" data-v-af2e3abf${_scopeId}>${ssrInterpolate(trans("property_show.facilities"))}</h5><div class="imas-rich-content text-md" data-v-af2e3abf${_scopeId}>${facilitiesHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`</div></div>`);
						if (contentHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-af2e3abf${_scopeId}><h5 class="imas-section-title mb-4" data-v-af2e3abf${_scopeId}>${ssrInterpolate(trans("property_show.details"))}</h5><div class="imas-rich-content text-md" data-v-af2e3abf${_scopeId}>${contentHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						...
						if (hasMapCoordinates.value) {
							_push(`<div id="listing-location" data-imas-reveal data-v-af2e3abf${_scopeId}>`);
						...
						_push(`</div><aside class="col-lg-4 col-md-12 car imas-blog-v2-sidebar imas-property-show__sidebar-col" data-v-af2e3abf${_scopeId}><div class="imas-property-show__contact-sticky" data-imas-reveal="aside" data-v-af2e3abf${_scopeId}>`);
...
var show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-af2e3abf"]]);
//#endregion
