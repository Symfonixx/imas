		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (images.value.length > 0) {
				...
				_push(`<!--]--></div>`);
				if (images.value.length > 1) _push(`<div class="imas-gallery-counter" aria-live="polite" data-v-9349bedd><i class="fa fa-image imas-gallery-counter__icon" aria-hidden="true" data-v-9349bedd></i><span class="imas-gallery-counter__text" data-v-9349bedd>${ssrInterpolate(activeIndex.value + 1)} / ${ssrInterpolate(images.value.length)}</span></div>`);
				else _push(`<!---->`);
				if (images.value.length > 1) _push(`<!--[--><a class="carousel-control left imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", previousLabel.value)} data-v-9349bedd><i class="fa fa-angle-left" aria-hidden="true" data-v-9349bedd></i></a><a class="carousel-control right imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", nextLabel.value)} data-v-9349bedd><i class="fa fa-angle-right" aria-hidden="true" data-v-9349bedd></i></a><!--]-->`);
				else _push(`<!---->`);
				_push(`</div>`);
				if (images.value.length > 1) {
					...
					ssrRenderList(images.value, (image, index) => {
						_push(`<li class="${ssrRenderClass([{ active: index === activeIndex.value }, "list-inline-item imas-gallery-thumbs__item"])}" data-v-9349bedd><a href="#" class="${ssrRenderClass({ selected: index === activeIndex.value })}"${ssrRenderAttr("aria-label", `Image ${index + 1}`)}${ssrRenderAttr("aria-current", index === activeIndex.value ? "true" : void 0)} data-v-9349bedd><span class="imas-gallery-thumb__frame" data-v-9349bedd><img${ssrRenderAttr("src", image.url)} class="imas-gallery-thumb__img"${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-9349bedd></span></a></li>`);
					});
					_push(`<!--]--></ul></div>`);
				} else _push(`<!---->`);
				_push(`</div>`);
...
var PropertyShowGallery_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["__scopeId", "data-v-9349bedd"]]);
//#endregion
...
var _sfc_main = {
	...
	setup(__props) {
		...
		const propertyVideos = computed(() => {
			const videos = [props.property.youtube_video_url, ...Array.isArray(props.property.videos) ? props.property.videos : []];
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (metaDescription.value) _push(`<meta head-key="description" name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (metaKeywords.value) _push(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (canonicalUrl.value) _push(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", canonicalUrl.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (ogTitle.value) _push(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", ogTitle.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", ogDescription.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", ogImage.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="og:type" property="og:type" content="website" data-v-3a8eaead${_scopeId}>`);
						if (ogUrl.value) _push(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", ogUrl.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", twitterCard.value)} data-v-3a8eaead${_scopeId}>`);
						if (ogTitle.value) _push(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", ogTitle.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", ogDescription.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", ogImage.value)} data-v-3a8eaead${_scopeId}>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(_sfc_main$6, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="inner-pages blog imas-property-show-page imas-blog-v2 imas-property-listings" data-v-3a8eaead${_scopeId}>`);
						...
						if (__props.property.project_code) _push(`<div class="mt-0" data-v-3a8eaead${_scopeId}><span class="listing-address" data-v-3a8eaead${_scopeId}>${ssrInterpolate(trans("property_show.project_id"))}: ${ssrInterpolate(__props.property.project_code)}</span></div>`);
						else _push(`<!---->`);
						_push(`<h3 data-v-3a8eaead${_scopeId}>${ssrInterpolate(displayTitle.value)}</h3>`);
						if (addressLine.value) {
							_push(`<div class="mt-0" data-v-3a8eaead${_scopeId}>`);
							if (hasMapCoordinates.value) _push(`<a href="#listing-location" class="listing-address" data-v-3a8eaead${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-3a8eaead${_scopeId}></i><span data-v-3a8eaead${_scopeId}>${ssrInterpolate(addressLine.value)}</span></a>`);
							else _push(`<span class="listing-address" data-v-3a8eaead${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-3a8eaead${_scopeId}></i><span data-v-3a8eaead${_scopeId}>${ssrInterpolate(addressLine.value)}</span></span>`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (propertyTypeLabel.value) _push(`<div class="imas-property-type-badge mt-2" data-v-3a8eaead${_scopeId}>${ssrInterpolate(propertyTypeLabel.value)}</div>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="single detail-wrapper ms-lg-auto" data-v-3a8eaead${_scopeId}><div class="detail-wrapper-body" data-v-3a8eaead${_scopeId}><div class="listing-title-bar text-start text-lg-end" data-v-3a8eaead${_scopeId}><h4 class="imas-price-heading" data-v-3a8eaead${_scopeId}>`);
						if (priceAmount.value) _push(`<!--[--><span class="imas-price-heading__prefix" data-v-3a8eaead${_scopeId}>${ssrInterpolate(pricePrefix.value)}</span><span class="imas-price-heading__amount text-gold" data-v-3a8eaead${_scopeId}>${ssrInterpolate(priceAmount.value)}</span><!--]-->`);
						else _push(`<span class="imas-price-heading__amount text-gold" data-v-3a8eaead${_scopeId}>—</span>`);
						_push(`</h4></div></div></div></div></section><div data-imas-reveal data-v-3a8eaead${_scopeId}>`);
						...
						_push(`</div>`);
						if (overviewHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-3a8eaead${_scopeId}><h5 class="imas-section-title mb-4" data-v-3a8eaead${_scopeId}>${ssrInterpolate(trans("property_show.description"))}</h5><div class="imas-rich-content text-md" data-v-3a8eaead${_scopeId}>${overviewHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						if (__props.property.unit_types?.length) {
							_push(`<div data-imas-reveal data-v-3a8eaead${_scopeId}>`);
						...
						if (whyToBuyHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-3a8eaead${_scopeId}><h5 class="imas-section-title mb-4" data-v-3a8eaead${_scopeId}>${ssrInterpolate(trans("property_show.why_to_buy"))}</h5><div class="imas-rich-content text-md" data-v-3a8eaead${_scopeId}>${whyToBuyHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`</div></div>`);
						if (contentHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-3a8eaead${_scopeId}><h5 class="imas-section-title mb-4" data-v-3a8eaead${_scopeId}>${ssrInterpolate(trans("property_show.details"))}</h5><div class="imas-rich-content text-md" data-v-3a8eaead${_scopeId}>${contentHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						...
						if (hasMapCoordinates.value) {
							_push(`<div id="listing-location" data-imas-reveal data-v-3a8eaead${_scopeId}>`);
						...
						_push(`</div><aside class="col-lg-4 col-md-12 car imas-blog-v2-sidebar imas-property-show__sidebar-col" data-v-3a8eaead${_scopeId}><div class="imas-property-show__contact-sticky" data-imas-reveal="aside" data-v-3a8eaead${_scopeId}>`);
...
var show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-3a8eaead"]]);
//#endregion
