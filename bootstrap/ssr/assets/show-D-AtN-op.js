...
import { o as localizedRoute, t as _sfc_main$7 } from "./App-7O-qCwwD.js";
import { t as useScrollReveal } from "./useScrollReveal-D1MywBbX.js";
import { t as _sfc_main$8 } from "./InnerPageHeadingHero-Cb2JTq3_.js";
...
import { t as PopularPropertiesSection_default } from "./PopularPropertiesSection-COtRt_8m.js";
import { t as PropertyShowContactSidebar_default } from "./PropertyShowContactSidebar-B-O-kLpU.js";
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.attributes.length > 0) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: "imas-property-attributes mb-30" }, _attrs))} data-v-c4f43782><div class="imas-property-attributes__grid" data-v-c4f43782><!--[-->`);
				ssrRenderList(__props.attributes, (attribute) => {
					_push(`<section class="${ssrRenderClass([`imas-property-attributes__card--${attribute.layout}`, "imas-property-attributes__card imas-property-show-panel"])}" data-v-c4f43782><h5 class="imas-section-title imas-property-attributes__title mb-4" data-v-c4f43782>`);
					if (attribute.icon_url) _push(`<img class="imas-property-attributes__icon"${ssrRenderAttr("src", attribute.icon_url)} alt="" aria-hidden="true" width="36" height="36" loading="lazy" data-v-c4f43782>`);
					else _push(`<!---->`);
					_push(`<span data-v-c4f43782>${ssrInterpolate(attribute.name)}</span></h5><div class="imas-property-attributes__value" data-v-c4f43782>`);
					if (attribute.type === "textarea") _push(`<p class="imas-property-attributes__text" data-v-c4f43782>${ssrInterpolate(attribute.value)}</p>`);
					else if (attribute.type === "text") _push(`<span data-v-c4f43782>${ssrInterpolate(attribute.value)}</span>`);
					else if (attribute.type === "number") _push(`<span data-v-c4f43782>${ssrInterpolate(formatNumber(attribute.value))}</span>`);
					else if (attribute.type === "price") _push(`<span class="text-gold" data-v-c4f43782>${ssrInterpolate(formatPrice(attribute.value))}</span>`);
					else if (attribute.type === "boolean") _push(`<span class="${ssrRenderClass([{ "imas-property-attributes__flag--on": attribute.value }, "imas-property-attributes__flag"])}" data-v-c4f43782><i class="${ssrRenderClass([attribute.value ? "fa-check" : "fa-times", "fa"])}" aria-hidden="true" data-v-c4f43782></i><span data-v-c4f43782>${ssrInterpolate(attribute.value ? trans("property_show.yes") : trans("property_show.no"))}</span></span>`);
					else if (attribute.type === "radio" || attribute.type === "select") {
						_push(`<span class="imas-property-attributes__option" data-v-c4f43782>`);
						if (attribute.value.icon) _push(`<i class="${ssrRenderClass([attribute.value.icon, "imas-property-attributes__option-icon"])}" aria-hidden="true" data-v-c4f43782></i>`);
						else _push(`<!---->`);
						_push(`<span data-v-c4f43782>${ssrInterpolate(attribute.value.label)}</span></span>`);
					} else if (attribute.type === "checkbox" || attribute.type === "multiselect") {
						_push(`<ul class="imas-property-attributes__chips" data-v-c4f43782><!--[-->`);
						ssrRenderList(attribute.value, (option) => {
							_push(`<li class="imas-property-attributes__chip" data-v-c4f43782>`);
							if (option.icon) _push(`<i class="${ssrRenderClass([option.icon, "imas-property-attributes__option-icon"])}" aria-hidden="true" data-v-c4f43782></i>`);
							else _push(`<!---->`);
							_push(`<span data-v-c4f43782>${ssrInterpolate(option.label)}</span></li>`);
						});
						_push(`<!--]--></ul>`);
					} else if (attribute.type === "image") _push(`<img class="imas-property-attributes__image"${ssrRenderAttr("src", attribute.value.url)}${ssrRenderAttr("alt", attribute.value.alt)} loading="lazy" data-v-c4f43782>`);
					else if (attribute.type === "gallery") {
						_push(`<div class="imas-property-attributes__gallery" data-v-c4f43782><!--[-->`);
						ssrRenderList(attribute.value, (image, index) => {
							_push(`<img class="imas-property-attributes__image"${ssrRenderAttr("src", image.url)}${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-c4f43782>`);
						});
						_push(`<!--]--></div>`);
					} else if (attribute.type === "file") _push(`<a class="imas-property-attributes__file"${ssrRenderAttr("href", attribute.value.url)} target="_blank" rel="noopener"${ssrRenderAttr("download", attribute.value.name)} data-v-c4f43782><i class="fa fa-download" aria-hidden="true" data-v-c4f43782></i><span data-v-c4f43782>${ssrInterpolate(attribute.value.name)}</span></a>`);
					else if (attribute.type === "date") _push(`<span data-v-c4f43782>${ssrInterpolate(formatDate(attribute.value))}</span>`);
					else if (attribute.type === "datetime") _push(`<span data-v-c4f43782>${ssrInterpolate(formatDateTime(attribute.value))}</span>`);
					else _push(`<!---->`);
					_push(`</div></section>`);
				});
				_push(`<!--]--></div></div>`);
...
var PropertyShowAttributes_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-c4f43782"]]);
//#endregion
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (metaDescription.value) _push(`<meta head-key="description" name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (metaKeywords.value) _push(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (canonicalUrl.value) _push(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", canonicalUrl.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (ogTitle.value) _push(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", ogTitle.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", ogDescription.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", ogImage.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="og:type" property="og:type" content="website" data-v-941ed0fa${_scopeId}>`);
						if (ogUrl.value) _push(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", ogUrl.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", twitterCard.value)} data-v-941ed0fa${_scopeId}>`);
						if (ogTitle.value) _push(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", ogTitle.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", ogDescription.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", ogImage.value)} data-v-941ed0fa${_scopeId}>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(_sfc_main$7, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="inner-pages blog imas-property-show-page imas-blog-v2 imas-property-listings" data-v-941ed0fa${_scopeId}>`);
						...
						_push(`<section class="single-proper blog details imas-property-show" data-v-941ed0fa${_scopeId}><div class="container" data-v-941ed0fa${_scopeId}><div class="row imas-property-show__content-row" data-v-941ed0fa${_scopeId}><div class="col-lg-8 col-md-12 blog-pots" data-v-941ed0fa${_scopeId}><div class="row" data-v-941ed0fa${_scopeId}><div class="col-md-12" data-v-941ed0fa${_scopeId}><section data-imas-reveal class="headings-2 pt-0" data-v-941ed0fa${_scopeId}><div class="pro-wrapper imas-property-title-row" data-v-941ed0fa${_scopeId}><div class="detail-wrapper-body" data-v-941ed0fa${_scopeId}><div class="listing-title-bar text-start" data-v-941ed0fa${_scopeId}>`);
						if (__props.property.project_code) _push(`<div class="mt-0" data-v-941ed0fa${_scopeId}><span class="listing-address" data-v-941ed0fa${_scopeId}>${ssrInterpolate(trans("property_show.project_id"))}: ${ssrInterpolate(__props.property.project_code)}</span></div>`);
						else _push(`<!---->`);
						_push(`<h3 data-v-941ed0fa${_scopeId}>${ssrInterpolate(displayTitle.value)}</h3>`);
						if (addressLine.value) {
							_push(`<div class="mt-0" data-v-941ed0fa${_scopeId}>`);
							if (hasMapCoordinates.value) _push(`<a href="#listing-location" class="listing-address" data-v-941ed0fa${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-941ed0fa${_scopeId}></i><span data-v-941ed0fa${_scopeId}>${ssrInterpolate(addressLine.value)}</span></a>`);
							else _push(`<span class="listing-address" data-v-941ed0fa${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-941ed0fa${_scopeId}></i><span data-v-941ed0fa${_scopeId}>${ssrInterpolate(addressLine.value)}</span></span>`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (propertyTypeLabel.value) _push(`<div class="imas-property-type-badge mt-2" data-v-941ed0fa${_scopeId}>${ssrInterpolate(propertyTypeLabel.value)}</div>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="single detail-wrapper ms-lg-auto" data-v-941ed0fa${_scopeId}><div class="detail-wrapper-body" data-v-941ed0fa${_scopeId}><div class="listing-title-bar text-start text-lg-end" data-v-941ed0fa${_scopeId}><h4 class="imas-price-heading" data-v-941ed0fa${_scopeId}>`);
						if (priceAmount.value) _push(`<!--[--><span class="imas-price-heading__prefix" data-v-941ed0fa${_scopeId}>${ssrInterpolate(pricePrefix.value)}</span><span class="imas-price-heading__amount text-gold" data-v-941ed0fa${_scopeId}>${ssrInterpolate(priceAmount.value)}</span><!--]-->`);
						else _push(`<span class="imas-price-heading__amount text-gold" data-v-941ed0fa${_scopeId}>—</span>`);
						_push(`</h4></div></div></div></div></section><div data-imas-reveal data-v-941ed0fa${_scopeId}>`);
						...
						_push(`</div>`);
						if (overviewHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-941ed0fa${_scopeId}><h5 class="imas-section-title mb-4" data-v-941ed0fa${_scopeId}>${ssrInterpolate(trans("property_show.description"))}</h5><div class="imas-rich-content text-md" data-v-941ed0fa${_scopeId}>${overviewHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						if (__props.property.unit_types?.length) {
							_push(`<div data-imas-reveal data-v-941ed0fa${_scopeId}>`);
						...
						if (whyToBuyHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-941ed0fa${_scopeId}><h5 class="imas-section-title mb-4" data-v-941ed0fa${_scopeId}>${ssrInterpolate(trans("property_show.why_to_buy"))}</h5><div class="imas-rich-content text-md" data-v-941ed0fa${_scopeId}>${whyToBuyHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`</div></div>`);
						if (contentHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-941ed0fa${_scopeId}><h5 class="imas-section-title mb-4" data-v-941ed0fa${_scopeId}>${ssrInterpolate(trans("property_show.details"))}</h5><div class="imas-rich-content text-md" data-v-941ed0fa${_scopeId}>${contentHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						...
						if (hasMapCoordinates.value) {
							_push(`<div id="listing-location" data-imas-reveal data-v-941ed0fa${_scopeId}>`);
						...
						_push(`</div><aside class="col-lg-4 col-md-12 car imas-blog-v2-sidebar imas-property-show__sidebar-col" data-v-941ed0fa${_scopeId}><div class="imas-property-show__contact-sticky" data-imas-reveal="aside" data-v-941ed0fa${_scopeId}>`);
...
var show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-941ed0fa"]]);
//#endregion
