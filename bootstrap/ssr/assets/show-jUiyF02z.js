...
import { o as localizedRoute, t as _sfc_main$6 } from "./App-CcYXakTU.js";
import { t as useScrollReveal } from "./useScrollReveal-CGa_fZhn.js";
...
import { t as PopularPropertiesSection_default } from "./PopularPropertiesSection-Dzv7cCPL.js";
import { t as PropertyShowContactSidebar_default } from "./PropertyShowContactSidebar-BRuXec4s.js";
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (images.value.length > 0) {
				...
				}, _attrs))} data-v-5d94f2b4><h5 class="imas-section-title mb-4" data-v-5d94f2b4>${ssrInterpolate(__props.title)}</h5><div class="imas-gallery-main" data-v-5d94f2b4><div class="carousel-inner imas-gallery-main__inner" data-v-5d94f2b4><!--[-->`);
				ssrRenderList(images.value, (image, index) => {
					_push(`<div class="${ssrRenderClass([{ active: index === activeIndex.value }, "item carousel-item imas-gallery-slide"])}"${ssrRenderAttr("data-slide-number", index)} data-v-5d94f2b4><div class="imas-gallery-main__frame" data-v-5d94f2b4><img${ssrRenderAttr("src", image.url)} class="imas-gallery-main__img"${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-5d94f2b4></div></div>`);
				});
				_push(`<!--]--></div>`);
				if (images.value.length > 1) _push(`<div class="imas-gallery-counter" aria-live="polite" data-v-5d94f2b4><i class="fa fa-image imas-gallery-counter__icon" aria-hidden="true" data-v-5d94f2b4></i><span class="imas-gallery-counter__text" data-v-5d94f2b4>${ssrInterpolate(activeIndex.value + 1)} / ${ssrInterpolate(images.value.length)}</span></div>`);
				else _push(`<!---->`);
				if (images.value.length > 1) _push(`<!--[--><a class="carousel-control left imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", previousLabel.value)} data-v-5d94f2b4><i class="fa fa-angle-left" aria-hidden="true" data-v-5d94f2b4></i></a><a class="carousel-control right imas-gallery-control" href="#" role="button"${ssrRenderAttr("aria-label", nextLabel.value)} data-v-5d94f2b4><i class="fa fa-angle-right" aria-hidden="true" data-v-5d94f2b4></i></a><!--]-->`);
				else _push(`<!---->`);
				_push(`</div>`);
				if (images.value.length > 1) {
					_push(`<div class="imas-gallery-thumbs-outer" role="region" tabindex="0"${ssrRenderAttr("aria-label", thumbsRegionLabel.value)} data-v-5d94f2b4><ul class="carousel-indicators smail-listing list-inline imas-gallery-thumbs" data-v-5d94f2b4><!--[-->`);
					ssrRenderList(images.value, (image, index) => {
						_push(`<li class="${ssrRenderClass([{ active: index === activeIndex.value }, "list-inline-item imas-gallery-thumbs__item"])}" data-v-5d94f2b4><a href="#" class="${ssrRenderClass({ selected: index === activeIndex.value })}"${ssrRenderAttr("aria-label", `Image ${index + 1}`)}${ssrRenderAttr("aria-current", index === activeIndex.value ? "true" : void 0)} data-v-5d94f2b4><span class="imas-gallery-thumb__frame" data-v-5d94f2b4><img${ssrRenderAttr("src", image.url)} class="imas-gallery-thumb__img"${ssrRenderAttr("alt", image.alt)} loading="lazy" data-v-5d94f2b4></span></a></li>`);
					});
					_push(`<!--]--></ul></div>`);
				} else _push(`<!---->`);
				_push(`</div>`);
...
var PropertyShowGallery_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["__scopeId", "data-v-5d94f2b4"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.unitTypes.length > 0) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: "imas-unit-types-table mb-30" }, _attrs))} data-v-c991c5b6><h5 class="imas-section-title mb-4" data-v-c991c5b6>${ssrInterpolate(__props.title)}</h5>`);
				if (__props.projectId || __props.projectLocation) {
					_push(`<dl class="imas-unit-types-table__meta mb-4" data-v-c991c5b6>`);
					if (__props.projectId) _push(`<div class="imas-unit-types-table__meta-item" data-v-c991c5b6><dt class="imas-unit-types-table__meta-label" data-v-c991c5b6>${ssrInterpolate(__props.projectIdLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-c991c5b6>${ssrInterpolate(__props.projectId)}</dd></div>`);
					else _push(`<!---->`);
					if (__props.projectLocation) _push(`<div class="imas-unit-types-table__meta-item" data-v-c991c5b6><dt class="imas-unit-types-table__meta-label" data-v-c991c5b6>${ssrInterpolate(__props.projectLocationLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-c991c5b6>${ssrInterpolate(__props.projectLocation)}</dd></div>`);
					else _push(`<!---->`);
					if (__props.propertyType) _push(`<div class="imas-unit-types-table__meta-item" data-v-c991c5b6><dt class="imas-unit-types-table__meta-label" data-v-c991c5b6>${ssrInterpolate(__props.propertyTypeLabel)}</dt><dd class="imas-unit-types-table__meta-value" data-v-c991c5b6>${ssrInterpolate(__props.propertyType)}</dd></div>`);
					else _push(`<!---->`);
					_push(`</dl>`);
				} else _push(`<!---->`);
				_push(`<div class="table-responsive" data-v-c991c5b6><table class="table imas-unit-types-table__grid mb-0" data-v-c991c5b6><thead data-v-c991c5b6><tr data-v-c991c5b6><th scope="col" data-v-c991c5b6>${ssrInterpolate(__props.colRooms)}</th><th scope="col" data-v-c991c5b6>${ssrInterpolate(__props.colArea)}</th><th scope="col" data-v-c991c5b6>${ssrInterpolate(__props.colPrice)}</th></tr></thead><tbody data-v-c991c5b6><!--[-->`);
				ssrRenderList(__props.unitTypes, (row) => {
					_push(`<tr data-v-c991c5b6><td data-v-c991c5b6>${ssrInterpolate(row.name || "—")}</td><td data-v-c991c5b6>${ssrInterpolate(formatArea(row))}</td><td data-v-c991c5b6>${ssrInterpolate(formatPrice(row.price))}</td></tr>`);
				});
...
var PropertyShowUnitTypesTable_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["__scopeId", "data-v-c991c5b6"]]);
//#endregion
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), { title: documentTitle.value }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (metaDescription.value) _push(`<meta head-key="description" name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (metaKeywords.value) _push(`<meta head-key="keywords" name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (canonicalUrl.value) _push(`<link head-key="canonical" rel="canonical"${ssrRenderAttr("href", canonicalUrl.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (ogTitle.value) _push(`<meta head-key="og:title" property="og:title"${ssrRenderAttr("content", ogTitle.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="og:description" property="og:description"${ssrRenderAttr("content", ogDescription.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="og:image" property="og:image"${ssrRenderAttr("content", ogImage.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="og:type" property="og:type" content="website" data-v-59656ee9${_scopeId}>`);
						if (ogUrl.value) _push(`<meta head-key="og:url" property="og:url"${ssrRenderAttr("content", ogUrl.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						_push(`<meta head-key="twitter:card" name="twitter:card"${ssrRenderAttr("content", twitterCard.value)} data-v-59656ee9${_scopeId}>`);
						if (ogTitle.value) _push(`<meta head-key="twitter:title" name="twitter:title"${ssrRenderAttr("content", ogTitle.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (ogDescription.value) _push(`<meta head-key="twitter:description" name="twitter:description"${ssrRenderAttr("content", ogDescription.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
						if (ogImage.value) _push(`<meta head-key="twitter:image" name="twitter:image"${ssrRenderAttr("content", ogImage.value)} data-v-59656ee9${_scopeId}>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(_sfc_main$6, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="inner-pages blog imas-property-show-page imas-blog-v2 imas-property-listings" data-v-59656ee9${_scopeId}>`);
						...
						_push(`<section class="single-proper blog details imas-property-show" data-v-59656ee9${_scopeId}><div class="container" data-v-59656ee9${_scopeId}><div class="row imas-property-show__content-row" data-v-59656ee9${_scopeId}><div class="col-lg-8 col-md-12 blog-pots" data-v-59656ee9${_scopeId}><div class="row" data-v-59656ee9${_scopeId}><div class="col-md-12" data-v-59656ee9${_scopeId}><section data-imas-reveal class="headings-2 pt-0" data-v-59656ee9${_scopeId}><div class="pro-wrapper imas-property-title-row" data-v-59656ee9${_scopeId}><div class="detail-wrapper-body" data-v-59656ee9${_scopeId}><div class="listing-title-bar text-start" data-v-59656ee9${_scopeId}>`);
						if (__props.property.project_code) _push(`<div class="mt-0" data-v-59656ee9${_scopeId}><span class="listing-address" data-v-59656ee9${_scopeId}>${ssrInterpolate(trans("property_show.project_id"))}: ${ssrInterpolate(__props.property.project_code)}</span></div>`);
						else _push(`<!---->`);
						_push(`<h3 data-v-59656ee9${_scopeId}>${ssrInterpolate(displayTitle.value)}</h3>`);
						if (addressLine.value) {
							_push(`<div class="mt-0" data-v-59656ee9${_scopeId}>`);
							if (hasMapCoordinates.value) _push(`<a href="#listing-location" class="listing-address" data-v-59656ee9${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-59656ee9${_scopeId}></i><span data-v-59656ee9${_scopeId}>${ssrInterpolate(addressLine.value)}</span></a>`);
							else _push(`<span class="listing-address" data-v-59656ee9${_scopeId}><i class="fa fa-map-marker imas-address-marker" aria-hidden="true" data-v-59656ee9${_scopeId}></i><span data-v-59656ee9${_scopeId}>${ssrInterpolate(addressLine.value)}</span></span>`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (propertyTypeLabel.value) _push(`<div class="imas-property-type-badge mt-2" data-v-59656ee9${_scopeId}>${ssrInterpolate(propertyTypeLabel.value)}</div>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="single detail-wrapper ms-lg-auto" data-v-59656ee9${_scopeId}><div class="detail-wrapper-body" data-v-59656ee9${_scopeId}><div class="listing-title-bar text-start text-lg-end" data-v-59656ee9${_scopeId}><h4 class="imas-price-heading" data-v-59656ee9${_scopeId}>`);
						if (priceAmount.value) _push(`<!--[--><span class="imas-price-heading__prefix" data-v-59656ee9${_scopeId}>${ssrInterpolate(pricePrefix.value)}</span><span class="imas-price-heading__amount text-gold" data-v-59656ee9${_scopeId}>${ssrInterpolate(priceAmount.value)}</span><!--]-->`);
						else _push(`<span class="imas-price-heading__amount text-gold" data-v-59656ee9${_scopeId}>—</span>`);
						_push(`</h4></div></div></div></div></section><div data-imas-reveal data-v-59656ee9${_scopeId}>`);
						...
						_push(`</div>`);
						if (overviewHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-59656ee9${_scopeId}><h5 class="imas-section-title mb-4" data-v-59656ee9${_scopeId}>${ssrInterpolate(trans("property_show.description"))}</h5><div class="imas-rich-content text-md" data-v-59656ee9${_scopeId}>${overviewHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						if (__props.property.unit_types?.length) {
							_push(`<div data-imas-reveal data-v-59656ee9${_scopeId}>`);
						...
						if (whyToBuyHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-59656ee9${_scopeId}><h5 class="imas-section-title mb-4" data-v-59656ee9${_scopeId}>${ssrInterpolate(trans("property_show.why_to_buy"))}</h5><div class="imas-rich-content text-md" data-v-59656ee9${_scopeId}>${whyToBuyHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						if (facilitiesHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-59656ee9${_scopeId}><h5 class="imas-section-title mb-4" data-v-59656ee9${_scopeId}>${ssrInterpolate(trans("property_show.facilities"))}</h5><div class="imas-rich-content text-md" data-v-59656ee9${_scopeId}>${facilitiesHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`</div></div>`);
						if (contentHtml.value) _push(`<div data-imas-reveal class="blog-info details mb-30 text-start imas-property-show-panel" data-v-59656ee9${_scopeId}><h5 class="imas-section-title mb-4" data-v-59656ee9${_scopeId}>${ssrInterpolate(trans("property_show.details"))}</h5><div class="imas-rich-content text-md" data-v-59656ee9${_scopeId}>${contentHtml.value ?? ""}</div></div>`);
						else _push(`<!---->`);
						...
						if (hasMapCoordinates.value) {
							_push(`<div id="listing-location" data-imas-reveal data-v-59656ee9${_scopeId}>`);
						...
						_push(`</div><aside class="col-lg-4 col-md-12 car imas-blog-v2-sidebar imas-property-show__sidebar-col" data-v-59656ee9${_scopeId}><div class="imas-property-show__contact-sticky" data-imas-reveal="aside" data-v-59656ee9${_scopeId}>`);
...
var show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-59656ee9"]]);
//#endregion
