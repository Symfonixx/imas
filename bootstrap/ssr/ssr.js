    ...
    const showUrl = computed(() => {
      ...
      try {
        if (typeof route === "function" && ((_b = (_a = route()).has) == null ? void 0 : _b.call(_a, "property.show"))) {
          const slug2 = props.property.project_code || props.property.slug;
          if (slug2) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (propertyTypeLabel.value || __props.property.is_featured) {
        ...
        if (__props.property.is_featured) {
          _push(`<i class="fa fa-star imas-featured-star"${ssrRenderAttr("aria-label", trans("properties.featured"))} data-v-e98a51f0></i>`);
        } else {
          _push(`<!---->`);
        }
        if (propertyTypeLabel.value) {
          _push(`<span data-v-e98a51f0>${ssrInterpolate(propertyTypeLabel.value)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (__props.property.is_sold_out) {
        _push(`<div class="homes-tag button alt imas-sold-out-badge imas-badge--danger" data-v-e98a51f0>${ssrInterpolate(trans("properties.sold_out"))}</div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (!isSoldOut.value) {
        ...
        if (__props.property.youtube_video_url) {
          _push(`<button type="button" class="btn imas-card-video-btn"${ssrRenderAttr("aria-label", playVideoLabel.value)} data-v-e98a51f0><i class="fas fa-video" aria-hidden="true" data-v-e98a51f0></i></button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button type="button" class="${ssrRenderClass([{ "is-favorited": localFavorited.value }, "btn imas-favorite-btn"])}"${ssrRenderAttr("aria-label", favoriteAriaLabel.value)}${ssrRenderAttr("aria-pressed", localFavorited.value)} data-v-e98a51f0><i class="${ssrRenderClass([
          localFavorited.value ? "fa-heart" : "fa-heart-o",
          "fa favorite-icon"
        ])}" aria-hidden="true" data-v-e98a51f0></i></button></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (overviewText.value) {
        _push(`<p class="imas-property-overview imas-card__excerpt text-card-excerpt mb-3" data-v-e98a51f0>${ssrInterpolate(overviewText.value)}</p>`);
      } else {
        _push(`<!---->`);
      }
...
const PropertyCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e98a51f0"]]);
...
function resolveInertiaPage(name) {
  ...
  if (modules.length > 1) {
    return resolvePageComponent(
      ...
      /* @__PURE__ */ Object.assign({ "../../Modules/Base/resources/assets/js/Pages/AboutUs.vue": () => import("./assets/AboutUs-C9ZsDRRt.js"), "../../Modules/Base/resources/assets/js/Pages/Index.vue": () => import("./assets/Index-B_HTvwRr.js"), "../../Modules/Cms/resources/assets/js/Pages/Index.vue": () => import("./assets/Index-DwBtiyqh.js"), "../../Modules/Cms/resources/assets/js/Pages/PageShow.vue": () => import("./assets/PageShow-i8iQ2EZu.js"), "../../Modules/Cms/resources/assets/js/Pages/Show.vue": () => import("./assets/Show-CkCoAfI5.js"), "../../Modules/Corporate/resources/assets/js/Pages/index.vue": () => import("./assets/index-CpT6CBO6.js"), "../../Modules/Property/resources/assets/js/Pages/FavoriteProperties.vue": () => import("./assets/FavoriteProperties-CNJqManm.js"), "../../Modules/Property/resources/assets/js/Pages/TurkishCitizenship.vue": () => import("./assets/TurkishCitizenship-BD8uXcrE.js"), "../../Modules/Property/resources/assets/js/Pages/index.vue": () => import("./assets/index-4bgsGFvY.js"), "../../Modules/Property/resources/assets/js/Pages/show.vue": () => import("./assets/show-9F9NWi4-.js"), "../../Modules/Support/resources/assets/js/Pages/ContactUs.vue": () => import("./assets/ContactUs-CKWQS-K7.js"), "../../Modules/User/resources/assets/js/Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-BMIPjcmr.js"), "../../Modules/User/resources/assets/js/Pages/Auth/Login.vue": () => import("./assets/Login-BO7z1gg5.js"), "../../Modules/User/resources/assets/js/Pages/Auth/Register.vue": () => import("./assets/Register-CEHAd7e3.js"), "../../Modules/User/resources/assets/js/Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-DARxTlwl.js") })
    );
  }
  return resolvePageComponent(
    `./Pages/${name}.vue`,
